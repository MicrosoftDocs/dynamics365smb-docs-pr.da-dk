...
# <a name="business-central-and-onedrive-for-business-integration" />Business Central og OneDrive for Business Integration
...
## <a name="get-started-with-onedrive-features" />Kom i gang med OneDrive-funktioner
...
### <a name="open-and-share-in-onedrive" />Åbne og dele i OneDrive
...
### <a name="save-excel-workbooks-and-report-files-in-onedrive" />Gemme Excel-projektmapper og -rapportfiler i OneDrive
