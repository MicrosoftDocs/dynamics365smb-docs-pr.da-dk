...
ms.author: edupont
---
# <a name="add-extended-text" />Tilføje udvidet tekst
...
## <a name="to-define-extended-text-for-an-description" />Sådan defineres udvidet tekst for en beskrivelse
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />Sådan tilføjes en udvidet varetekst på en salgsordrelinje
