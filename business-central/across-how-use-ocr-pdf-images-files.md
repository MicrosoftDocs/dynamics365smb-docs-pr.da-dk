...
ms.author: edupont
---
# <a name="use-ocr-to-turn-pdf-and-image-files-into-electronic-documents" />Bruge OCR til at gøre PDF- og billedfiler til elektroniske dokumenter
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-from-the-incoming-documents-page" />Sådan sendes en PDF- eller billedfil til OCR-tjenesten fra siden Indgående bilag
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-by-email" />Sådan sendes en PDF- eller billedfil til OCR-tjenesten via mail
...
## <a name="to-receive-the-resulting-electronic-document-from-the-ocr-service" />Sådan modtager du det resulterende elektroniske dokument fra OCR-tjenesten
...
## <a name="to-create-a-purchase-invoice-from-an-electronic-document-received-from-the-ocr-service" />Sådan oprettes en købsfaktura fra et elektronisk dokument, der er modtaget fra OCR-tjenesten
...
### <a name="to-map-text-on-an-incoming-document-to-a-specific-vendor-account" />Sådan knyttes tekst på et indgående bilag til en bestemt kreditorkonto
...
## <a name="to-handle-errors-when-receiving-electronic-documents" />Sådan håndteres fejl ved modtagelse af elektroniske dokumenter
...
## <a name="to-train-the-ocr-service-to-avoid-errors" />Sådan lærer du OCR-tjenesten at undgå fejl
