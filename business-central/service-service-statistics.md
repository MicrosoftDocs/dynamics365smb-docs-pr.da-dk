...
# <a name="viewing-service-statistics" />Visning af servicestatistik
...
## <a name="viewing-statistics-for-service-orders" />Visning af statistik for serviceordrer
...
### <a name="view-totals-for-a-service-order" />Vis totaler for en serviceordre
...
### <a name="view-shipping-information" />Vis leveringsoplysninger
...
### <a name="view-order-details" />Vis ordredetaljer
...
### <a name="analyze-service-order-lines" />Analysér serviceordrelinjer
...
### <a name="view-customer-information" />Vis kundeoplysninger
...
## <a name="viewing-service-item-statistics" />Visning af serviceartikelstatistik
...
## <a name="use-trendscapes" />Bruge Trendscapes
...
## <a name="viewing-gains-and-losses-on-contracts" />Visning af gevinster og tab på kontrakter
...
## <a name="viewing-statistics-for-posted-service-documents" />Visning af statistik for bogførte servicedokumenter
...
### <a name="posted-service-shipment-statistics" />Statistik for bogførte serviceleverancer
...
### <a name="posted-service-invoice-statistics" />Statistik for bogførte servicefakturaer
...
### <a name="posted-service-credit-memo-statistics" />Statistik for bogførte servicekreditnotaer
