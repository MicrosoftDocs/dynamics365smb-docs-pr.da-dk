...
### <a name="microsoft-entra-id-setup-for-group-members"></a>Microsoft Entra ID-opsætning af gruppemedlemmer
...
4. I feltet **OAuth 2.0 Myndighedsslutpunkt** skal du angive `https://login.microsoftonline.com/common/oauth2`.
5. I feltet URL-adresse **OAuth til** ressource 2.0 skal du indtaste `https://api.businesscentral.dynamics.com/`.
6. I feltet URL-adresse **OAuth til omdirigering 2.0** skal du indtaste `https://businesscentral.dynamics.com/OAuthLanding.htm`.
...
## <a name="issue-with-enabling-multifactor-authentication-mfa"></a>Problem med aktivering af Multifactor Authentication (MFA)
