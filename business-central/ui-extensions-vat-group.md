...
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>Udvidelsen til momsgruppe styring for Storbritannien
...
## <a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a>Danner en momsgruppe
...
## <a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a>Opsætning af momsgruppe

Følgende liste viser den anbefalede rækkefølge for trinene til oprettelse af en momsgruppe:

1. Opret opsætningen [Azure Active Directory for gruppemedlemmerne](#azure-active-directory-setup-for-group-members).
...
### <a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory-opsætning af momsgruppemedlemmer
...
Når administratoren af momsgruppens medlem opretter app-registreringen i Azure Active Directory, skal du angive følgende oplysninger.
...
### <a name="group-api-setup"></a><a name="group-api-setup"></a><a name="group-api-setup"></a>Opsætning af momsgruppemedlem
...
## <a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a>Opsætning af momsgruppemedlemmer
...
### <a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a>Moms-grupperepræsentant bruger Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a>Moms-grupperepræsentant bruger Business Central On-premises
...
3. I feltet **Klient-hemmelighed** skal du angive klient-hemmeligheden fra programregistreringen i Azure Active Directory.
...
## <a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a>Oprette repræsentanten for momsgruppen
...
## <a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a>Bruge funktionerne til momsgruppestyring
...
### <a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a>Gennemse indsendelse af gruppemedlem
...
### <a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a>Oprette en gruppemomsretur
