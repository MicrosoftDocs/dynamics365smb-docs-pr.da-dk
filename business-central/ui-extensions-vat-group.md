...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />Udvidelsen til momsgruppe styring for Storbritannien
...
## <a name="forming-a-vat-group" />Danner en momsgruppe
...
## <a name="set-up-a-vat-group" />Opsætning af momsgruppe
...
### <a name="azure-active-directory-setup-for-group-members" />Azure Active Directory-opsætning af momsgruppemedlemmer
...
### <a name="group-api-setup" />Opsætning af momsgruppemedlem
...
## <a name="set-up-vat-group-members" />Opsætning af momsgruppemedlemmer
...
### <a name="vat-group-representative-uses-business-central-online" />Moms-grupperepræsentant bruger Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />Moms-grupperepræsentant bruger Business Central On-premises
...
## <a name="set-up-the-vat-group-representative" />Oprette repræsentanten for momsgruppen
...
## <a name="use-the-vat-group-management-features" />Bruge funktionerne til momsgruppestyring
...
### <a name="review-vat-member-submissions" />Gennemse indsendelse af gruppemedlem
...
### <a name="create-a-group-vat-return" />Oprette en gruppemomsretur
