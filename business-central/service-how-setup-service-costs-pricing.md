...
# <a name="set-up-pricing-and-additional-costs-for-services" />Konfigurere prissætning og ekstra omkostninger for services
...
## <a name="to-set-up-a-service-price-group" />Sådan oprettes serviceprisgrupper
...
## <a name="to-set-up-a-service-price-adjustment-group" />Sådan oprettes serviceprisreguleringsgrupper
...
## <a name="to-set-up-additional-costs-for-services" />Sådan konfigureres ekstra omkostninger for tjenester
...
### <a name="to-set-up-service-costs" />Sådan defineres serviceomkostninger
...
### <a name="to-specify-a-default-cost-for-service-orders" />Sådan angives en standardomkostning for serviceordrer
