...
ms.author: edupont
---
# <a name="walkthrough-managing-projects-with-jobs" />Gennemgang: Administration af projekter med sager
...
### <a name="copying-a-job" />Kopiering af en sag
...
### <a name="making-payment-by-installment" />Betaling af afdrag
...
## <a name="preparing-sample-data" />Klargøre eksempeldata

 Forbered denne gennemgang ved at tilføje Tina som en ny ressource.  

### <a name="to-prepare-the-sample-data" />Sådan klargøres eksempeldataene
...
### <a name="to-create-a-job-journal-batch" />Sådan oprettes et sagskladdenavn
...
### <a name="to-set-up-a-job" />Sådan oprettes en sag
...
### <a name="to-customize-pricing" />Tilpasse priser
...
### <a name="to-add-job-tasks" />Sådan tilføjes sagsopgaver
...
### <a name="to-create-planning-lines" />Sådan oprettes planlægningslinjer
...
## <a name="calculating-remaining-usage" />Beregne resterede forbrug
...
### <a name="to-calculate-remaining-usage" />Sådan beregnes resterede forbrug
...
## <a name="creating-and-posting-a-job-sales-invoice" />Oprette og bogføre en sagssalgsfaktura
...
### <a name="to-create-a-job-sales-invoice" />Sådan oprettes en sagssalgsfaktura
...
### <a name="to-post-a-new-sales-invoice" />Sådan bogføres en ny salgsfaktura
...
### <a name="to-view-the-posted-invoice" />Sådan vises den bogførte faktura
...
### <a name="to-open-the-statistics-page" />Sådan åbner du siden Statistik
...
### <a name="to-manage-fixed-pricing-in-jobs" />Sådan håndteres faste priser i sager
...
### <a name="to-enter-hours-in-the-job-journal" />Sådan angives timer i sagskladden
...
## <a name="copying-jobs" />Kopiere sager
...
### <a name="to-copy-a-job" />Sådan kopieres en sag
...
## <a name="making-payments-by-installments" />Foretage betaling af afdrag
...
### <a name="to-set-up-a-new-account" />Sådan oprettes et nyt konto
...
### <a name="to-make-a-payment-by-installment" />Sådan foretages betaling af afdrag
...
### <a name="to-create-an-invoice" />Sådan oprettes en faktura
...
## <a name="next-steps" />Efterfølgende trin
