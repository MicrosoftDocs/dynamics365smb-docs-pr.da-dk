...
---
# <a name="walkthrough-managing-projects"></a>Gennemgang: Administration af projekter med sager
...
### <a name="setting-up-a-project"></a>Oprettelse af en sag
...
### <a name="to-create-a-project-journal-batch"></a>Sådan oprettes et sagskladdenavn
...
## <a name="setting-up-a-project-1"></a>Oprettelse af en sag
...
### <a name="to-set-up-a-project"></a>Sådan oprettes en sag
...
### <a name="to-add-project-tasks"></a>Sådan tilføjes sagsopgaver
...
### <a name="to-enter-hours-in-a-project-journal"></a>Sådan angives timer i sagskladden
...
## <a name="copying-projects"></a>Kopiere sager
...
### <a name="to-copy-a-project"></a>Sådan kopieres en sag
