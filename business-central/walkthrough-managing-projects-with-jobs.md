...
ms.author: edupont
---
# <a name="walkthrough-managing-projects-with-jobs"></a><a name="walkthrough-managing-projects-with-jobs"></a>Gennemgang: Administration af projekter med sager
...
### <a name="setting-up-a-job"></a><a name="setting-up-a-job"></a>Oprettelse af en sag
...
### <a name="handling-fixed-prices"></a><a name="handling-fixed-prices"></a>Håndtere faste priser
...
### <a name="copying-a-job"></a><a name="copying-a-job"></a>Kopiering af en sag
...
### <a name="making-payment-by-installment"></a><a name="making-payment-by-installment"></a>Betaling af afdrag
...
## <a name="preparing-sample-data"></a><a name="preparing-sample-data"></a>Klargøre eksempeldata

 Forbered denne gennemgang ved at tilføje Tina som en ny ressource.  

### <a name="to-prepare-the-sample-data"></a><a name="to-prepare-the-sample-data"></a>Sådan klargøres eksempeldataene
...
### <a name="to-create-a-job-journal-batch"></a><a name="to-create-a-job-journal-batch"></a>Sådan oprettes et sagskladdenavn
...
## <a name="setting-up-a-job-1"></a><a name="setting-up-a-job-1"></a>Oprettelse af en sag
...
### <a name="to-set-up-a-job"></a><a name="to-set-up-a-job"></a>Sådan oprettes en sag
...
### <a name="to-customize-pricing"></a><a name="to-customize-pricing"></a>Tilpasse priser
...
### <a name="to-add-job-tasks"></a><a name="to-add-job-tasks"></a>Sådan tilføjes sagsopgaver
...
### <a name="to-create-planning-lines"></a><a name="to-create-planning-lines"></a>Sådan oprettes planlægningslinjer
...
## <a name="calculating-remaining-usage"></a><a name="calculating-remaining-usage"></a>Beregne resterede forbrug
...
### <a name="to-calculate-remaining-usage"></a><a name="to-calculate-remaining-usage"></a>Sådan beregnes resterede forbrug
...
## <a name="creating-and-posting-a-job-sales-invoice"></a><a name="creating-and-posting-a-job-sales-invoice"></a>Oprette og bogføre en sagssalgsfaktura
...
### <a name="to-create-a-job-sales-invoice"></a><a name="to-create-a-job-sales-invoice"></a>Sådan oprettes en sagssalgsfaktura
...
### <a name="to-post-a-new-sales-invoice"></a><a name="to-post-a-new-sales-invoice"></a>Sådan bogføres en ny salgsfaktura
...
### <a name="to-view-the-posted-invoice"></a><a name="to-view-the-posted-invoice"></a>Sådan vises den bogførte faktura
...
### <a name="to-open-the-statistics-page"></a><a name="to-open-the-statistics-page"></a>Sådan åbner du siden Statistik
...
## <a name="handling-fixed-prices-1"></a><a name="handling-fixed-prices-1"></a>Håndtere faste priser
...
### <a name="to-manage-fixed-pricing-in-jobs"></a><a name="to-manage-fixed-pricing-in-jobs"></a>Sådan håndteres faste priser i sager
...
### <a name="to-enter-hours-in-the-job-journal"></a><a name="to-enter-hours-in-the-job-journal"></a>Sådan angives timer i sagskladden
...
## <a name="copying-jobs"></a><a name="copying-jobs"></a>Kopiere sager
...
### <a name="to-copy-a-job"></a><a name="to-copy-a-job"></a>Sådan kopieres en sag
...
## <a name="making-payments-by-installments"></a><a name="making-payments-by-installments"></a>Foretage betaling af afdrag
...
### <a name="to-set-up-a-new-account"></a><a name="to-set-up-a-new-account"></a>Sådan oprettes et nyt konto
...
### <a name="to-make-a-payment-by-installment"></a><a name="to-make-a-payment-by-installment"></a>Sådan foretages betaling af afdrag
...
### <a name="to-create-an-invoice"></a><a name="to-create-an-invoice"></a>Sådan oprettes en faktura
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/paths/create-jobs/)
