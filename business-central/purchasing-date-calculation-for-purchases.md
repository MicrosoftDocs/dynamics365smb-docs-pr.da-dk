...
ms.author: bholtorf
---
# <a name="calculate-dates-for-purchases" />Beregning af forfaldsdato for køb
...
## <a name="calculating-with-a-requested-receipt-date" />Beregning med en ønsket modtagelsesdato
...
## <a name="calculating-without-a-requested-receipt-date" />Beregne uden en ønsket modtagelsesdato
...
## <a name="default-values-for-lead-time-calculation" />Standardværdier for beregning af leveringstid
...
## <a name="see-related-microsoft-trainingtrainingmodulesestimate-receipt-dates-dynamics-365-business-central" />Se relateret [Microsoft-træning](/training/modules/estimate-receipt-dates-dynamics-365-business-central/)
