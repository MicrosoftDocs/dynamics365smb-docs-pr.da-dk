...
ms.author: bholtorf
---
# <a name="block-items-from-sales-or-purchasing" />Spærre varer mod salg eller køb
...
## <a name="to-block-an-item-from-being-entered-on-sales-lines" />Sådan spærrer du for, at en vare kan angives på salgslinjer

1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Varer**, og vælg derefter det relaterede link.  
2. Vælg den vare, du vil spærre, og marker derefter afkrydsningsfeltet **Spærret salg**.  

## <a name="to-block-an-item-from-being-entered-on-purchase-lines" />Sådan spærrer du for, at en vare kan angives på købslinjer

1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Varer**, og vælg derefter det relaterede link.  
2. Vælg den vare, du vil spærre, og marker derefter afkrydsningsfeltet **Spærret køb**.  

## <a name="to-block-an-item-from-being-posted" />Sådan spærrer du for, at en vare kan bogføres
