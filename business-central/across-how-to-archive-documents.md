...
## <a name="to-set-up-automatic-document-archiving" />Sådan konfigurerer du automatisk dokumentarkivering
...
## <a name="to-manually-archive-a-sales-order" />Sådan arkiveres en salgsordre manuelt
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive" />Sådan gendannes en ikke-bogført salgsordre fra arkivet
...
## <a name="to-delete-archived-sales-orders" />Sådan sletter du arkiverede salgsordrer
