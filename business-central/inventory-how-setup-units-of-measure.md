...
ms.author: edupont
---
# <a name="set-up-units-of-measure" />Oprette måleenheder
...
## <a name="to-set-up-units-of-measure" />Sådan oprettes måleenheder
...
## <a name="to-set-up-multiple-item-units-of-measure" />Sådan konfigurerer du flere vareenheder
...
## <a name="to-set-up-unit-of-measure-translations" />Sådan oprettes enhedsoversættelser
...
## <a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions" />Sådan angives en standardenhedskode for salgs- og købstransaktioner
