...
ms.author: edupont
---
# <a name="setting-up-relationship-management" />Opsætning af Relationsstyring
...
## <a name="automatically-recording-interactions" />Automatisk registrere interaktioner
...
## <a name="synchronizing-contacts-with-customers-and-more" />Synkronisere kontakter med debitorer m.m.
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities" />Tildele en nummerserie til kontakter og leads
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created" />Søge efter dublerede kontakter, når der oprettes kontakter
