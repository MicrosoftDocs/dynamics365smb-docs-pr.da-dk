...
# <a name="record-special-sales-prices-and-discounts" />Registrere specialsalgspriser og -rabatter
...
## <a name="to-set-up-a-sales-price-for-a-customer" />Sådan konfigureres salgspriser for en debitor
...
## <a name="using-sales-and-purchase-price-lists" />Bruge salgs-og købsprislister
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update" />Konvertering af eksisterende priser, når du aktiverer opdatering af prissætningsfunktionen
...
### <a name="editing-active-price-lists" />Redigere aktive prislister
...
#### <a name="create-sales-price-lines-based-on-the-unit-price" />Oprette salgsprislinjer ud fra salgspris
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists" />Oprette salgsprislinjer ud fra eksisterende prislister
...
## <a name="to-copy-sales-prices" />Sådan kopieres salgspriser
...
## <a name="to-bulk-update-item-prices" />Sådan masseopdateres varepriser
...
## <a name="sales-invoice-discounts-and-service-charges" />Salgsfakturarabatter og servicegebyrer
...
### <a name="calculating-invoice-discounts-on-sales" />Beregne fakturarabatter på salg

[!INCLUDE [sales-invoice-discounts](includes/sales-invoice-discounts.md)]

## <a name="to-set-up-a-sales-line-discount-for-a-customer" />Sådan konfigureres salgslinjerabatter for en debitor
...
## <a name="to-set-up-an-invoice-discount-for-a-customer" />Sådan oprettes en fakturarabat for en debitor
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-sales-prices-dynamics-365-business-centralindex" />Se relateret [Microsoft-træning](/training/modules/manage-sales-prices-dynamics-365-business-central/index)
