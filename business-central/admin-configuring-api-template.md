...
# <a name="configure-api-templates" />Konfigurere API-skabeloner
...
## <a name="setting-up-the-entity-template" />Opsætning af enhedsskabelonen
...
## <a name="assign-the-template-to-an-api" />Tildele skabelonen til et API
