...
ms.author: solsen
---
# <a name="preview-posting-results" />Vise bogføringsresultater
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice" />Sådan vises finansposter, der stammer fra bogføring af en købsfaktura
