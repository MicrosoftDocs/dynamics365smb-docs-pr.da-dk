...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Beregne ordrebekræftelsesdatoer
...
## <a name="about-order-promising" />Om beregning af leveringstid
...
### <a name="available-to-promise" />Disp.-til-levering
...
### <a name="capable-to-promise" />Første m. afs.dato
...
### <a name="calculations" />Beregninger
...
## <a name="to-set-up-order-promising" />Sådan defineres beregning af leveringstid
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Indgående og Udgående lagerekspeditionstid i beregning af leveringstid
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />Angive standard-indgående og -udgående lagerekspeditionstid for salgs-og købsdokumenter
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />Angive ind- og udgående lagerekspeditionstider på lokationer
...
## <a name="to-make-an-item-critical" />Sådan gør du en vare kritisk
...
## <a name="to-calculate-an-order-promising-date" />Sådan beregnes en ordrebekræftelsesdato
