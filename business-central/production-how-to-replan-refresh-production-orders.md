...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Omplanlægge eller forny produktionsordrer direkte
...
## <a name="to-replan-a-production-order" />Sådan omplanlægges en produktionsordre
...
## <a name="to-refresh-a-production-order" />Sådan fornys en produktionsordre
