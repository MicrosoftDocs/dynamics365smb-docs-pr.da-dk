...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly"></a><a name="replan-or-refresh-production-orders-directly"></a><a name="replan-or-refresh-production-orders-directly"></a>Omplanlægge eller forny produktionsordrer direkte
...
## <a name="to-replan-a-production-order"></a><a name="to-replan-a-production-order"></a><a name="to-replan-a-production-order"></a>Sådan omplanlægges en produktionsordre
...
## <a name="to-refresh-a-production-order"></a><a name="to-refresh-a-production-order"></a><a name="to-refresh-a-production-order"></a>Sådan fornys en produktionsordre
