...
ms.author: edupont
---
# <a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a>Gemme og tilpasse listevisninger
...
## <a name="to-save-a-view"></a><a name="to-save-a-view"></a><a name="to-save-a-view"></a>Sådan gemmes en visning
...
## <a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a>Sådan omdøbes eller fjernes en visning
...
## <a name="managing-many-views"></a><a name="managing-many-views"></a><a name="managing-many-views"></a>Administrere mange visninger
