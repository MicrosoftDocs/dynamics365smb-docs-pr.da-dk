...
## <a name="integrating-through-dataverse" />Integration via Dataverse
...
### <a name="connection-settings-in-the-setup-guide" />Forbindelsesindstillinger i installationsvejledningen
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Standardenhedstilknytning i Sales til synkronisering
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Synkronisere varer og ressourcer med produkter med forskellige enheder.
...
### <a name="mapping-items-and-resources-to-products" />Tilknytning af varer og ressourcer til produkter
...
### <a name="synchronization-jobs-for-a-sales-integration" />Synkroniseringsjob for en salgsintegration
...
### <a name="default-synchronization-job-queue-entries" />Poster for standardsynkroniseringsjobkø
