...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Definere anlægsforsikring
...
## <a name="to-set-up-general-insurance-information" />Sådan angives generelle forsikringsoplysninger
...
## <a name="to-set-up-insurance-types" />Sådan defineres forsikringstyper
...
## <a name="to-set-up-insurance-cards" />Sådan defineres forsikringskort
...
## <a name="to-set-up-insurance-journal-templates" />Sådan defineres forsikringskladdetyper
...
## <a name="to-set-up-insurance-journal-batches" />Sådan defineres forsikringskladdenavne
