...
ms.author: edupont
---
# <a name="create-number-series" />Oprette nummerserie
...
## <a name="gaps-in-number-series" />Huller i nummerserier
...
## <a name="behavior-of-the-no-field-on-documents-and-cards" />Egenskaberne for feltet felt på dokumenter og kort
...
## <a name="to-create-a-new-number-series" />Sådan opretter du en ny nummerserie
...
## <a name="to-create-relationships-between-number-series" />Sådan oprettes relationer mellem nummerserier
...
## <a name="to-set-up-where-a-number-series-is-used" />Sådan definerer du, hvor en nummerserie skal bruges
...
## <a name="see-related-microsoft-trainingtrainingmodulesnumber-series-trail-codes-dynamics-365-business-centralindex" />Se relateret [Microsoft-træning](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
