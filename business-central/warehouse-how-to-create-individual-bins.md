...
ms.author: edupont
---
# <a name="create-bins" />Oprette placeringer
...
## <a name="to-create-a-bin-from-the-location-card" />Sådan oprettes en placering ud fra lokationskortet
...
### <a name="the-dedicated-field" />Feltet Dedikeret
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet" />Sådan oprettes individuelle placeringer i placeringsoprettelseskladden
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet" />Sådan oprettes placeringer automatisk i oprettelseskladden
