...
# <a name="the-image-analyzer-extension" />Billedanalyseudvidelsen
...
## <a name="privacy-notice" />Erklæring om beskyttelse af personlige oplysninger
...
## <a name="switch-on-the-image-analyzer-extension" />Aktiver billedanalyseudvidelsen
...
## <a name="analyze-an-item-image" />Analysere et billede af en vare
...
## <a name="analyze-a-contact-person-picture" />Analyse af billede af en kontaktperson
...
## <a name="use-your-own-computer-vision-api-account" />Brug af din egen konto til Computer Vision API
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period" />Se, hvor mange analyser du har udfyldt i den aktuelle periode
...
## <a name="stop-using-the-image-analyzer-extension" />Afslut brug af billedanalyseudvidelsen
