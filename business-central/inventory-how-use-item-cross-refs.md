...
---
# <a name="use-item-references"></a>Brug varereferencer
...
3. Vælg handlingen **Varereferencer**.
     ...
     Hvis du ikke kan finde handlingen Varereferencer **, skal du vælge at få vist flere indstillinger og derefter finde den** under **Relateret** > **element**.
...
4. I varereferencenummeret **.** skal du vælge den relevante varereference og derefter vælge knappen **OK**.
