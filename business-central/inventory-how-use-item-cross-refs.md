...
ms.author: edupont
---
# <a name="use-item-references" />Anvend varereferencer
...
## <a name="to-start-using-item-references" />Sådan begyndes du at bruge elementreferencer
...
## <a name="to-set-up-an-item-reference" />Sådan oprettes en varereference
...
## <a name="to-enter-a-vendors-item-description-on-a-document" />Sådan angiver du en kreditors varebeskrivelse på et dokument
