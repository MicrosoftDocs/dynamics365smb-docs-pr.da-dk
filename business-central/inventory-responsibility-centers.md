---
title: Sådan arbejder du med ansvarscentre
...
Flere lokationer giver virksomheder mulighed for at administrere deres lagerbeholdning på flere lokationer ved hjælp af én database. I denne sammenhæng er hhv. lokationer og lagervarer de to vigtigste begreber. En lokation defineres som et sted, der varetager den rent fysiske håndtering og placering af varer. Dette begreb er bredt nok til også at omfatte lokationer som fabriks- eller produktionsanlæg og distributionscentre, lagerbygninger, udstillingslokaler og servicevogne. En lagervare defineres som en vare på en bestemt lokation og/eller som en variant. Når en virksomhed med flere lokationer bruger lagervarer, kan der tilføjes oplysninger om genbestilling, adresser og visse økonomiske bogføringsrelaterede oplysninger på lokationsniveau. Dermed kan de genbestille varianter af den samme vare til hver lokation og bestille varer baseret på lokationsspecifikke genbestillingsoplysninger.  
...
5.  **Angiv en ansvarscenterkode i feltet** Ansvarscenter **i oversigtspanelet Levering** .
...
Du kan opsætte brugere, så [!INCLUDE [prod_short](includes/prod_short.md)] kun henter de dokumenter, der er relevante for deres specielle arbejdsområde. Brugere er knyttet til et ansvarscenter og arbejder kun med dokumenter med relation til bestemte moduler i det pågældende center.  
