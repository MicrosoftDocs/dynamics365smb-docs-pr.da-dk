...
# <a name="add-marketing-text-to-items" />Tilføje marketingtekst til varer
...
### <a name="create-first-draft-with-copilot" />Oprette første kladde med Copilot
...
### <a name="review-edit-and-save-text" />Gennemse, rediger og gem tekst
...
### <a name="improve-and-tailor-text-suggestions" />Forbedre og skræddersy tekstforslag
...
## <a name="create-marketing-text-from-scratch" />Oprette marketingtekst fra bunden
