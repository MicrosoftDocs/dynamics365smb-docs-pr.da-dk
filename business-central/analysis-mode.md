...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Analysere listedata ved hjælp af dataanalysetilstand
...
## <a name="prerequisite" />Forudsætninger
...
## <a name="work-with-data-analysis-mode" />Arbejde med dataanalysetilstand
...
## <a name="pivot-mode" />Pivot-tilstand
...
## <a name="limitations" />Begrænsninger
