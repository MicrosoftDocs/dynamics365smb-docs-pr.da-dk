...
---
# <a name="analyze-list-data-using-data-analysis-mode"></a><a name="analyze-list-data-using-data-analysis-mode"></a>Analysere listedata ved hjælp af dataanalysetilstand
...
## <a name="prerequisite"></a><a name="prerequisite"></a>Forudsætninger
...
## <a name="work-with-data-analysis-mode"></a><a name="work-with-data-analysis-mode"></a>Arbejde med dataanalysetilstand
...
### <a name="summary-bar-2"></a><a name="summary-bar-2"></a>Oversigtspanel (2)
...
## <a name="pivot-mode"></a><a name="pivot-mode"></a>Pivot-tilstand
...
## <a name="limitations"></a><a name="limitations"></a>Begrænsninger
