...
ms.author: edupont
---
# <a name="approval-workflow-notifications"></a><a name="approval-workflow-notifications"></a>Godkende workflow-notifikationer
...
## <a name="set-up-notifications"></a><a name="set-up-notifications"></a>Opsætning af notifikationer.
