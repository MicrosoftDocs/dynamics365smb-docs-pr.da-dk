...
ms.author: edupont
---
# <a name="work-with-item-attributes" />Arbejde med vareattributter
...
## <a name="create-item-attributes" />Oprette vareattributter
...
## <a name="create-values-for-item-attributes-of-type-option" />Oprette værdier for vareattributter af typen Indstilling
...
## <a name="assign-item-attributes-to-items" />Tildele vareattributter til varer
...
## <a name="assign-item-attributes-to-item-categories" />Tildele vareattributter til varekategorier
...
## <a name="filter-by-item-attributes" />Filtrere efter vareattributter
