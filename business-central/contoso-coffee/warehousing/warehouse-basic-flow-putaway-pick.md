...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-basic-warehouse-configurations" />Gennemgang af indgående og udgående flow i grundlæggende opsætning af lagersted
...
## <a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations" />Indgående flow: Modtagelse og placering på lager i grundlæggende lageropsætninger
...
## <a name="outbound-flow-picking-and-shipping-in-basic-warehouse-configurations" />Udgående flow: Pluk og forsendelse i grundlæggende lageropsætninger
