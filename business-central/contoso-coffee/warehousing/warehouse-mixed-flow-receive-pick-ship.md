...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations" />Gennemgang af indgående og udgående flow i blandet opsætning af lagersted
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations" />Udgående flow: Pluk og forsendelse i avancerede lageropsætninger
