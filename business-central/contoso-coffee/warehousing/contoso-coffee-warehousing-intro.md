...
# <a name="introduction-to-contoso-coffee-warehousing" />Introduktion til Contoso Coffee-lagersted
...
## <a name="set-up-contoso-coffee-warehousing-data" />Opsætning af Contoso Coffee-lagerstedsdata
