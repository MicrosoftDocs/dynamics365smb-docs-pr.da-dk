---
title: Introduktion til Contoso Coffee til Servicestyring
...
# <a name="introduction-to-contoso-coffee-service-management"></a>Introduktion til Contoso Coffee til Servicestyring
...
Når de relevante apps er installeret, skal du gå til siden [Contoso-demoværktøj](https://businesscentral.dynamics.com/?page=5194) i [!INCLUDE [prod_short](../../includes/prod_short.md)], vælge linjen *Servicemodul*, og brug handlingen **Konfigurer** til at forberede modulerne. Følgende tabeller beskriver indstillingerne:  
...
|**Ressourcenr. 2**  |Den ressource, der skal bruges til breakfix-scenarier.|
