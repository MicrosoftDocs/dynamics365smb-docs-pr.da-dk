...
ms.author: edupont
---
# <a name="create-production-order-headers" />Oprette produktionsordrehoveder
...
## <a name="to-create-a-production-order-header" />Sådan oprettes et produktionsordrehovede
