...
ms.author: edupont
---
# <a name="insure-fixed-assets"></a><a name="insure-fixed-assets"></a>Forsikring af anlægsaktiver
...
## <a name="to-create-or-modify-an-insurance-card"></a><a name="to-create-or-modify-an-insurance-card"></a>Sådan oprettes og redigeres et forsikringskort
...
## <a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal"></a><a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal"></a>Sådan tildeles et anlægsaktiv til en forsikringspolice ved at bogføre forsikringskladden
...
## <a name="to-update-the-insurance-value-of-a-fixed-asset"></a><a name="to-update-the-insurance-value-of-a-fixed-asset"></a>Sådan opdateres forsikringsværdien af et anlægsaktiv
...
## <a name="to-monitor-insurance-coverage"></a><a name="to-monitor-insurance-coverage"></a>Sådan overvåges forsikringsdækning
...
### <a name="overview-of-insurance-policies"></a><a name="overview-of-insurance-policies"></a>Oversigt over forsikringspolicer
...
### <a name="insurance-coverage"></a><a name="insurance-coverage"></a>Forsikringsposter
...
### <a name="overunder-coverage"></a><a name="overunder-coverage"></a>Over/underforsikring
...
### <a name="uninsured-fixed-assets"></a><a name="uninsured-fixed-assets"></a>Ikke-forsikrede anlægsaktiver
...
## <a name="to-view-insurance-coverage-ledger-entries"></a><a name="to-view-insurance-coverage-ledger-entries"></a>Sådan får du vist forsikringsposter
...
## <a name="to-view-the-total-insurance-value-of-fixed-assets"></a><a name="to-view-the-total-insurance-value-of-fixed-assets"></a>Sådan får du vist den samlede forsikringsværdi for anlægsaktiver
...
## <a name="to-correct-insurance-coverage-entries"></a><a name="to-correct-insurance-coverage-entries"></a>Sådan rettes forsikringsposter
