...
I [!INCLUDE[d365fin](includes/d365fin_md.md)] kan du ikke ændre en kostmetode for en vare, efter at du har medtaget varen i en transaktion. Når du f.eks. har købt eller solgt varen. Hvis der er knyttet en forkert kostmetode til varen eller varerne, kan du måske ikke finde problemet, før du foretager en finansiel rapportering.
