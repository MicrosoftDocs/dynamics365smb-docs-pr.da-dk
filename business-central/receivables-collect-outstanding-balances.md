...
Rentenotaen udskrives til afsendelse til en bestemt mail som en vedhæftet PDF-fil.

### Sådan annulleres den udstedte rentenota

Hvis rentenotaer er udstedt ved en fejl, kan du annullere dem, før de sendes ud igen. Du kan gøre dette enten en efter en eller som en batch.
