...
ms.author: edupont
---
# <a name="collect-outstanding-balances" />Indhente udestående beløb
...
### <a name="to-send-the-customer-statement-report" />Sådan sendes rapporten Kontoudtog
...
## <a name="reminders" />Rykkere

[!INCLUDE [receivables-reminders](includes/receivables-reminders.md)]

## <a name="finance-charges" />Finansieringsomkostninger
...
### <a name="to-create-a-finance-charge-memo-manually" />Sådan gør du: Oprette rentenotaer manuelt
...
### <a name="to-update-finance-charge-memo-texts" />Sådan opdateres tekster til rentenotaer
...
### <a name="to-issue-finance-charge-memos" />Sådan udstedes rentenotaer
...
### <a name="to-cancel-an-issued-finance-charge-memo" />Sådan annulleres den udstedte rentenota
...
### <a name="to-view-reminder-and-finance-charge-entries" />Sådan får du vist rykker- og rentenotaposter
...
## <a name="see-related-microsoft-trainingtrainingpathsprocess-financial-periodic-activities-dynamics-365-business-central" />Se relateret [Microsoft-træning](/training/paths/process-financial-periodic-activities-dynamics-365-business-central/)
