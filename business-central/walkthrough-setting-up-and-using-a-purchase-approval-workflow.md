...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Gennemgang: Opsætning og brug af workflow for godkendelse af køb
...
### <a name="set-up-approval-users"></a>Angive indstillinger for godkendelsesbrugere
...
### <a name="set-up-notifications"></a>Opsætning af meddelelser
