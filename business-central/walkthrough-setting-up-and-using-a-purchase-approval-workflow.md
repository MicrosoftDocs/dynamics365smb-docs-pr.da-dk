...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Gennemgang: Opsætning og brug af workflow for godkendelse af køb
...
### <a name="setting-up-approval-users" />Angive indstillinger for godkendelsesbrugere
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Sådan opretter du dig selv og Anna som godkendelsesbrugere
...
### <a name="setting-up-notifications" />Opsætning af meddelelser
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Sådan angiver du, hvordan og hvornår du skal have besked
...
## <a name="creating-the-approval-workflow" />Oprette godkendelsesworkflow
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Sådan oprettes og aktiveres en godkendelsesarbejdsgang for en købsordre
...
## <a name="use-the-approval-workflow" />Bruge godkendelsesworkflow
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Sådan anmoder du om godkendelse af en købsordre, som Anna
...
### <a name="to-approve-the-purchase-order-as-sean" />Sådan godkender du købsordren, som Søren
