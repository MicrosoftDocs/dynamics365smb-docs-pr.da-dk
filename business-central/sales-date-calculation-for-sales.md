...
ms.author: edupont
---
# <a name="delivery-date-calculation-for-sales" />Beregning af leveringsdato for salg
...
## <a name="calculating-a-requested-delivery-date" />Beregning en anmodet leveringsdato
...
## <a name="calculating-the-earliest-possible-delivery-date" />Beregning af den tidligst mulige leveringsdato
