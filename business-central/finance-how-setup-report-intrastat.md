...
---
# <a name="set-up-intrastat-reporting"></a><a name="set-up-intrastat-reporting"></a>Konfigurer Intrastat-rapportering
...
## <a name="enable-the-new-intrastat-experience"></a><a name="enable-the-new-intrastat-experience"></a>Aktivere den nye Intrastat-oplevelse
...
### <a name="intrastat-reporting-setup"></a><a name="intrastat-reporting-setup"></a>Oprette Intrastat-rapportering
...
### <a name="set-up-a-reporting-file"></a><a name="set-up-a-reporting-file"></a>Konfigurere en rapporteringsfil
...
### <a name="set-mandatory-fields-with-the-intrastat-report-checklist"></a><a name="set-mandatory-fields-with-the-intrastat-report-checklist"></a>Angive obligatoriske felter med Intrastat-rapportens kontrolliste
...
## <a name="use-custom-codeunits-in-intrastat-reporting"></a><a name="use-custom-codeunits-in-intrastat-reporting"></a>Bruge tilpassede codeunits i Intrastat-rapporting
...
## <a name="other-intrastat-configurations"></a><a name="other-intrastat-configurations"></a>Andre Intrastat-konfigurationer
...
#### <a name="set-up-transport-methods"></a><a name="set-up-transport-methods"></a>Definere transportmåder
...
#### <a name="set-up-transaction-nature-codes"></a><a name="set-up-transaction-nature-codes"></a>Konfigurere koder for transaktionsarter
...
### <a name="other-related-configurations"></a><a name="other-related-configurations"></a>Andre relaterede konfigurationer
...
#### <a name="item-cards"></a><a name="item-cards"></a>Varekort
...
#### <a name="set-up-fixed-assets-for-intrastat"></a><a name="set-up-fixed-assets-for-intrastat"></a>Definere standardfelter for Intrastat
...
#### <a name="set-up-vendors-for-intrastat"></a><a name="set-up-vendors-for-intrastat"></a>Konfigurere kreditorer til Intrastat
...
#### <a name="set-up-customers-for-intrastat"></a><a name="set-up-customers-for-intrastat"></a>Konfigurere kunder til Intrastat
...
#### <a name="exclude-items-and-fixed-assets-from-intrastat-reporting"></a><a name="exclude-items-and-fixed-assets-from-intrastat-reporting"></a>Udelade varer og anlægsaktiver fra Intrastat-rapportering
...
##### <a name="exclude-an-item-from-intrastat-reporting"></a><a name="exclude-an-item-from-intrastat-reporting"></a>Udelade en vare fra Intrastat-rapportering
...
##### <a name="exclude-a-fixed-asset-from-intrastat-reporting"></a><a name="exclude-a-fixed-asset-from-intrastat-reporting"></a>Udelade et anlægsaktiv i Intrastat-rapportering

1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Anlægsaktiver**, og vælg derefter det relaterede link.
2. Vælg det anlægsaktiv, du vil konfigurere.
3. I oversigtspanelet **Intrastat** skal du markere afkrydsningsfeltet **Udeluk fra Intrastat-rapport**.

#### <a name="set-up-tariff-numbers"></a><a name="set-up-tariff-numbers"></a>Konfigurere tarifnumre
...
## <a name="enter-country-specific-intrastat-settings"></a><a name="enter-country-specific-intrastat-settings"></a>Angiv landespecifik Intrastat-indstillinger
...
### <a name="austria"></a><a name="austria"></a>Østrig
...
### <a name="czech-republic"></a><a name="czech-republic"></a>Tjekkiet
