...
description: 'I denne artikel beskrives, hvordan du opsætter Intrastat-rapporteringsfunktioner og rapporterer handel med virksomheder i andre EU-lande.'
author: altotovi
ms.author: altotovi
...
---
# <a name="set-up-intrastat-reporting"></a><a name="set-up-intrastat-reporting"></a><a name="set-up-intrastat-reporting"></a>Konfigurer Intrastat-rapportering
...
Intrastat-rapportering er baseret på de grundlæggende EU-forordninger, der gælder for alle lande. Der er dog forskel på de enkelte lande. Hvert land har regler for, hvad der nøjagtigt skal rapporteres og hvordan.

> [!NOTE]
> Intrastat-oplysninger gælder ikke for flytning af tjenester mellem lande. I stedet anvendes oplysningerne kun til varer som f. eks. varer og anlægsaktiver. Hvis den lokale regering kræver registrering af tjenesteydelser mellem lande, kan det gøres ved hjælp af funktionen **Serviceerklæring**.
>
> Denne funktion er tilgængelig, som starter i november 2022, som en app, du kan hente fra [AppSource](https://go.microsoft.com/fwlink/?linkid=2081646). Hvis du skal bruge denne funktion, skal du installere den på siden **Udvidelsesstyring**.
...
## <a name="enable-the-new-intrastat-experience"></a><a name="enable-the-new-intrastat-experience"></a><a name="enable-the-new-intrastat-experience"></a>Aktivere den nye Intrastat-oplevelse
...
### <a name="intrastat-reporting-setup"></a><a name="intrastat-reporting-setup"></a><a name="intrastat-reporting-setup"></a>Oprette Intrastat-rapportering
...
3. I oversigtspanelet **Standardtransaktioner** skal du vælge eller angive feltoplysninger efter behov. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] I følgende tabel beskrives nogle af nøglefelterne.
...
4. I oversigtspanelet **Rapportering** skal du vælge eller angive feltoplysninger efter behov. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] I følgende tabel beskrives nogle af nøglefelterne.
...
### <a name="set-mandatory-fields-with-the-intrastat-report-checklist"></a><a name="set-mandatory-fields-with-the-intrastat-report-checklist"></a><a name="set-mandatory-fields-with-the-intrastat-report-checklist"></a>Angive obligatoriske felter med Intrastat-rapportens kontrolliste
...
>
> Vær forsigtig, når du opretter valideringsregler, da de kan være forskellige lande.

## <a name="use-custom-codeunits-in-intrastat-reporting"></a><a name="use-custom-codeunits-in-intrastat-reporting"></a><a name="use-custom-codeunits-in-intrastat-reporting"></a>Bruge tilpassede codeunits i Intrastat-rapporting
...
## <a name="other-intrastat-configurations"></a><a name="other-intrastat-configurations"></a><a name="other-intrastat-configurations"></a>Andre Intrastat-konfigurationer
...
#### <a name="set-up-transport-methods"></a><a name="set-up-transport-methods"></a><a name="set-up-transport-methods"></a>Definere transportmåder
...
#### <a name="set-up-transaction-nature-codes"></a><a name="set-up-transaction-nature-codes"></a><a name="set-up-transaction-nature-codes"></a>Konfigurere koder for transaktionsarter
...
#### <a name="set-up-fixed-assets-for-intrastat"></a><a name="set-up-fixed-assets-for-intrastat"></a><a name="set-up-fixed-assets-for-intrastat"></a>Definere standardfelter for Intrastat
...
#### <a name="set-up-vendors-for-intrastat"></a><a name="set-up-vendors-for-intrastat"></a><a name="set-up-vendors-for-intrastat"></a>Konfigurere kreditorer til Intrastat
...
#### <a name="set-up-customers-for-intrastat"></a><a name="set-up-customers-for-intrastat"></a><a name="set-up-customers-for-intrastat"></a>Konfigurere kunder til Intrastat
...
#### <a name="exclude-items-and-fixed-assets-from-intrastat-reporting"></a><a name="exclude-items-and-fixed-assets-from-intrastat-reporting"></a><a name="exclude-items-and-fixed-assets-from-intrastat-reporting"></a>Udelade varer og anlægsaktiver fra Intrastat-rapportering
...
##### <a name="exclude-an-item-from-intrastat-reporting"></a><a name="exclude-an-item-from-intrastat-reporting"></a><a name="exclude-an-item-from-intrastat-reporting"></a>Udelade en vare fra Intrastat-rapportering
...
##### <a name="exclude-a-fixed-asset-from-intrastat-reporting"></a><a name="exclude-a-fixed-asset-from-intrastat-reporting"></a><a name="exclude-a-fixed-asset-from-intrastat-reporting"></a>Udelade et anlægsaktiv i Intrastat-rapportering

1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Anlægsaktiver**, og vælg derefter det relaterede link.
2. Vælg det anlægsaktiv, du vil konfigurere.
3. I oversigtspanelet **Intrastat** skal du markere afkrydsningsfeltet **Udeluk fra Intrastat-rapport**.

#### <a name="set-up-tariff-numbers"></a><a name="set-up-tariff-numbers"></a><a name="set-up-tariff-numbers"></a>Konfigurere tarifnumre
...
### <a name="czech-republic"></a><a name="czech-republic"></a><a name="czech-republic"></a>Tjekkiet
