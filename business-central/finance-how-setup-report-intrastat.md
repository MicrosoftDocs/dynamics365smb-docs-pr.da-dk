...
---
# <a name="set-up-intrastat-reporting" />Konfigurer Intrastat-rapportering
...
## <a name="enable-the-new-intrastat-experience" />Aktivere den nye Intrastat-oplevelse
...
### <a name="intrastat-reporting-setup" />Oprette Intrastat-rapportering
...
### <a name="set-mandatory-fields-with-the-intrastat-report-checklist" />Angive obligatoriske felter med Intrastat-rapportens kontrolliste
...
## <a name="use-custom-codeunits-in-intrastat-reporting" />Bruge tilpassede codeunits i Intrastat-rapporting
...
## <a name="other-intrastat-configurations" />Andre Intrastat-konfigurationer
...
#### <a name="set-up-transport-methods" />Definere transportmåder
...
#### <a name="set-up-transaction-nature-codes" />Konfigurere koder for transaktionsarter
...
#### <a name="set-up-fixed-assets-for-intrastat" />Definere standardfelter for Intrastat
...
#### <a name="set-up-vendors-for-intrastat" />Konfigurere kreditorer til Intrastat
...
#### <a name="set-up-customers-for-intrastat" />Konfigurere kunder til Intrastat
...
#### <a name="exclude-items-and-fixed-assets-from-intrastat-reporting" />Udelade varer og anlægsaktiver fra Intrastat-rapportering
...
##### <a name="exclude-an-item-from-intrastat-reporting" />Udelade en vare fra Intrastat-rapportering
...
##### <a name="exclude-a-fixed-asset-from-intrastat-reporting" />Udelade et anlægsaktiv i Intrastat-rapportering

1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Anlægsaktiver**, og vælg derefter det relaterede link.
2. Vælg det anlægsaktiv, du vil konfigurere.
3. I oversigtspanelet **Intrastat** skal du markere afkrydsningsfeltet **Udeluk fra Intrastat-rapport**.

#### <a name="set-up-tariff-numbers" />Konfigurere tarifnumre
...
## <a name="enter-country-specific-intrastat-settings" />Angiv landespecifik Intrastat-indstillinger
...
### <a name="czech-republic" />Tjekkiet
