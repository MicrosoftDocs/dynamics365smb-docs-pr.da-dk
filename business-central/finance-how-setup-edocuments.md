...
> [!IMPORTANT]
> E-dokumenters kernemodul er en ramme. Der er som standard ikke noget felt til **Dokumentformat** eller **Tjenesteintegration**. Disse oplysninger er en del af lokaliseringsapps, fordi de begge er specifikke for lokale krav.

> [!NOTE]
> Fra version 23.1 tilføjes et PEPPOL-standarddokumentformat som et globalt format i feltet **Dokumentformat**.
...
2. Vælg **Ny**, og konfigurer derefter felterne i oversigtspanelet **Generelt** på siden **E-dokumenttjeneste** som beskrevet i følgende tabel.
    ...
    | Dokumentformat | <p>Eksportformatet for opsætningen af den elektroniske eksport.</p><p>Der er som standard ingen indstillinger i dette felt i bølge 1.</p> |
...
4. På oversigtspanelet **Importerede parametre** skal du udfylde felterne som beskrevet i følgende tabel.
...
Hvis du har konfigureret formatet **Data Exchange Definition** i lokaliseringen, kan du tilføje en linje for hver dokumenttype, du har brug for. Du skal dog først vælge indstillingen **Dokumenttype** for hver linje, du har brug for. For hver datatype skal du vælge værdien **Import Data Exchange Def. Code** eller **Export Data Exchange Def. Code**, som du vil bruge.

Hvis du ikke bruger formatet **Dataudvekslingsdefinition**, kan du konfigurere formater via linjerne **Eksportér tilknytning** og **Importtilknytning**, hvor du kan finde de tabeller og felter, der skal bruges, og konfigurere transformationsregler, hvis det er relevant.
