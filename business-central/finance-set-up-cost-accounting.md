---
title: Konfigurer omkostningsregnskab
...
# <a name="set-up-cost-accounting"></a>Konfigurer omkostningsregnskab

Før du begynder at arbejde med omkostningsregnskab, skal du udføre opsætningsopgaver.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a>Saldi mellem omkostningstype, bærer og omkostningsobjekt
...
1. Angiv en dimension, der skal være omkostningsstedsdimensionen på siden **Konfiguration af omkostningsregnskab**. Kun værdierne fra denne dimension overføres.
Du kan vælge **Opdater kostpriskonto. Dimensionshandling** til opdatering af dimensioner til omkostningsberegning.
1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig 2.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Diagram over omkostningssteder**, og vælg derefter det relaterede link.  
1. På fanen **Handlinger** i gruppen **Funktioner** skal du vælge **Hent omkostningssteder fra dimensionen** for at overføre dimensionsværdier til diagrammet over omkostningssteder. Funktionen overfører de dimensionsværdier, som du definerede i trin 1.  
...
> [!NOTE]  
>  Hvis du vil sikre, at det foruddefinerede bærested og det foruddefinerede omkostningsobjekt, som du opretter i finansregnskabet, automatisk overføres til omkostningsregnskabet, skal du markere afkrydsningsfeltet **Marker finansposteringer** på siden Opsætning **af** omkostningsregnskab.
