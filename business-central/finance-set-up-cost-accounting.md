...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Konfigurere omkostningsregnskab

Før du begynder at arbejde med omkostningsregnskab, skal du udføre opsætningsopgaver.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Saldi mellem omkostningstype, omkostningssted og omkostningsobjekt
...
## <a name="setting-up-cost-types" />Konfigurere Omkostningstyper
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Sådan overføres finanskontoplanen til diagrammet over omkostningstyper
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Sådan oprettes nye omkostningstyper på siden Omkostningstyper
...
### <a name="to-update-cost-types" />Sådan opdateres omkostningstyper
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Definition af forholdet mellem omkostningstyper og finanskonti.
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Forholdet mellem finanskonti og pristyper
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Pristyper uden relation til finanskontoen
...
## <a name="setting-up-cost-centers" />Konfigurere Omkostningssteder
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Sådan overføres dimensionsværdier i regnskabet til diagrammet over omkostningssteder.
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Sådan oprettes nye omkostningssteder på siden Diagram over omkostningssteder
...
## <a name="setting-up-cost-objects" />Konfigurere Omkostningsemner
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Sådan overføres dimensionsværdier fra regnskabet til diagrammet over omkostningsobjekter.
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Sådan oprettes nye omkostningsemner på siden Diagram over omkostningsemner
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Definition af omkostningssteder og omkostningsobjekter for kontoplanen
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts" />Definere standarddimensionsværdier for finanskonti
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Definition af dimensionsværdier for faste og direkte omkostninger
...
## <a name="see-related-microsoft-trainingtrainingmodulescost-accounting-dynamics-365-business-central" />Se relateret [Microsoft-træning](/training/modules/cost-accounting-dynamics-365-business-central/)
