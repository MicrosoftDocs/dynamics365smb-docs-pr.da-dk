...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Arbejde med rammesalgsordrer eller rammekøbsordrer
...
## <a name="to-create-a-blanket-sales-order" />Sådan oprettes en rammesalgsordre.
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Sådan oprettes en salgsordre med udgangspunkt i en rammesalgsordre
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Sådan vises en rammesalgsordres status
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Sådan vises ikke-bogførte og bogførte rammesalgsordrelinjer
