...
## <a name="to-set-up-a-document-sending-profile" />Sådan konfigurerer du dokumentafsendelsesprofil
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Angive en afsendelsesprofil på et debitorkort
