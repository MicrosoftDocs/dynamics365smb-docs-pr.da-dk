...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a>Designoplysninger: Vareudligning
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a>Lagerforøgelse
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a>Lagerreducering
...
## <a name="fixed-application"></a><a name="fixed-application"></a>Fast udligning
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Eksempel – Fast udligning i købsreturvare
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Eksempel – Fast udligning med gennemsnitlig kostpris
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Eksempel – Fast udligning i salgsreturvare
...
## <a name="transfer-application"></a><a name="transfer-application"></a>Overfør udligning
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Eksempel – Gennemsnitlig kostmetode
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Eksempel – standardkostmetode
...
## <a name="reapplication"></a><a name="reapplication"></a>Genudligning
