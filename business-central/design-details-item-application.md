...
ms.author: edupont
---
# <a name="design-details-item-application" />Designoplysninger: Vareudligning
...
## <a name="inventory-increase" />Lagerforøgelse
...
## <a name="inventory-decrease" />Lagerreducering
...
## <a name="fixed-application" />Fast udligning
...
### <a name="example--fixed-application-in-purchase-return" />Eksempel – Fast udligning i købsreturvare
...
### <a name="example--fixed-application-with-average-cost" />Eksempel – Fast udligning med gennemsnitlig kostpris
...
### <a name="example--fixed-application-in-sales-return" />Eksempel – Fast udligning i salgsreturvare
...
## <a name="transfer-application" />Overfør udligning
...
### <a name="example--average-costing-method" />Eksempel – Gennemsnitlig kostmetode
...
### <a name="example--standard-costing-method" />Eksempel – standardkostmetode
...
## <a name="reapplication" />Genudligning
