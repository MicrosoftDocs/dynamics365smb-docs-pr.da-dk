...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions" />Bruge XML-skemaer til at forberede dataudvekslingsdefinitioner
...
## <a name="to-load-an-xml-schema-file" />Sådan indlæses en XML-skemafil
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema" />Sådan markeres eller fjernes markeringen af noder i et XML-skema
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema" />Sådan oprettes en dataudvekslingsdefinition, der er baseret på et XML-skema
