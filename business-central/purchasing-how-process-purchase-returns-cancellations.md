...
ms.author: edupont
---
# <a name="process-purchase-returns-or-cancellations"></a><a name="process-purchase-returns-or-cancellations"></a>Behandle købsreturvarer eller annulleringer
...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice"></a><a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice"></a>Sådan oprettes en købskreditnota fra en bogført købsfaktura
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice"></a><a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice"></a>Sådan oprettes en købskreditnota ved at kopiere en bogført købsfaktura
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents"></a><a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents"></a>Sådan oprettes en købsreturvareordre baseret på et eller flere bogførte købsdokumenter.
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order"></a><a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order"></a>Sådan oprettes en erstatningskøbsodre fra en købsreturvareordre
...
## <a name="to-create-a-purchase-allowance"></a><a name="to-create-a-purchase-allowance"></a>Sådan oprettes et købsnedslag
...
## <a name="to-combine-return-shipments"></a><a name="to-combine-return-shipments"></a>Sådan samles returvareleverancer
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting"></a><a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting"></a>Fjerne åbne købsreturvareordrer efter bogføring af kombineret returvareleverance
