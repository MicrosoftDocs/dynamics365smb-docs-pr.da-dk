...
# <a name="procurement-quick-start" />Indkøb, Hurtig start
...
## <a name="set-up-vendors" />Oprette kreditorer
...
### <a name="set-up-a-new-vendor" />Opret en ny kreditor
...
## <a name="create-new-purchase-orders" />Opret nye købsordrer
...
### <a name="to-create-a-purchase-order" />Oprette en indkøbsordre
...
## <a name="create-a-purchase-invoice" />Opret en købsfaktura
...
### <a name="how-to-create-and-post-a-purchase-invoice" />Sådan opretter og bogfører du en købsfaktura
