...
---
# <a name="mapping-the-tables-and-fields-to-synchronize"></a><a name="mapping-the-tables-and-fields-to-synchronize"></a><a name="mapping-the-tables-and-fields-to-synchronize"></a>Tilknytning af tabeller og felter til synkronisering
...
## <a name="mapping-integration-tables"></a><a name="mapping-integration-tables"></a><a name="mapping-integration-tables"></a>Tilknytte integrationstabeller
...
### <a name="additional-mappings"></a><a name="additional-mappings"></a><a name="additional-mappings"></a>Yderligere tilknytninger
...
### <a name="strategies-for-auto-resolving-conflicts"></a><a name="strategies-for-auto-resolving-conflicts"></a><a name="strategies-for-auto-resolving-conflicts"></a>Strategier til automatisk løsning af konflikter
...
## <a name="mapping-integration-fields"></a><a name="mapping-integration-fields"></a><a name="mapping-integration-fields"></a>Felter til integrationstilknytning
...
### <a name="handle-differences-in-field-values"></a><a name="handle-differences-in-field-values"></a><a name="handle-differences-in-field-values"></a>Håndtering af forskelle i feltværdier
...
### <a name="handle-missing-option-values"></a><a name="handle-missing-option-values"></a><a name="handle-missing-option-values"></a>Håndtering af manglende indstillingsværdier
...
## <a name="couple-records"></a><a name="couple-records"></a><a name="couple-records"></a>Sammenkædede poster
...
## <a name="filter-records-and-rows"></a><a name="filter-records-and-rows"></a><a name="filter-records-and-rows"></a>Filtrere poster og rækker
...
## <a name="create-new-records"></a><a name="create-new-records"></a><a name="create-new-records"></a>Oprette nye poster
...
### <a name="to-create-new-records-during-synchronization"></a><a name="to-create-new-records-during-synchronization"></a><a name="to-create-new-records-during-synchronization"></a>Sådan oprettes nye records under synkronisering

1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") Vælg ikonet , åbn **Integrationstabeltilknytninger**, og vælg derefter det relaterede link.
2. Fjern markeringen i feltet **Synkroniser kun sammenkædede records** i tabeltilknytningsposten på listen.  

## <a name="use-configuration-templates-on-table-mappings"></a><a name="use-configuration-templates-on-table-mappings"></a><a name="use-configuration-templates-on-table-mappings"></a>Brug konfigurationsskabeloner på tabeltilknytninger
...
### <a name="to-specify-configuration-templates-on-a-table-mapping"></a><a name="to-specify-configuration-templates-on-a-table-mapping"></a><a name="to-specify-configuration-templates-on-a-table-mapping"></a>Sådan angiver du konfigurationsskabeloner i en tabeltilknytning
