...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a>Spore relationer mellem behov og forsyning
...
## <a name="to-track-linked-items"></a><a name="to-track-linked-items"></a>Sådan spores tilknyttede varer
...
## <a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a>Ikke-sporede planlægningselementer
