...
ms.author: edupont
---
# <a name="update-standard-costs"></a><a name="update-standard-costs"></a>Opdatere standardkostpriser
...
## <a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a>Sådan opdateres standardkostpriser
