---
title: Designoplysninger - gennemsnitlig omkostning
...
---
# <a name="design-details-average-cost"></a>Designoplysninger: gennemsnitlig omkostning
...
## <a name="setting-up-average-cost-calculation"></a>Opsætning af gennemsnitlig beregning af omkostninger
...
Følgende tabel viser vareposter for eksemplet med den gennemsnitlige omkostningsvare, VARE1, før du kører **Juster kostpris - vareposter**.  
...
| VARE1 |  | BLÅ | 02-03-23 |   Nr. |
 ...
 Følgende tabel viser de samme vareposter, når du har kørt **Juster kostpris - vareposter**-batchjobbet. Den gennemsnitlige kostpris pr. dag beregnes og anvendes til lagerreduktionen.  
...
Følgende tabel viser de samme vareposter, når du har kørt **Juster kostpris - vareposter**-batchjobbet. Den gennemsnitlige kostpris pr. måned beregnes og anvendes til lagerreduktionen.  
...
### <a name="example-of-recalculated-average-cost"></a>Eksempel på genberegnet gennemsnitlig kostpris
...
[Forretningsproces for produktomkostninger, og hvordan den er relateret til andre processer med Dynamics 365](/dynamics365/guidance/business-processes/design-to-retire-define-product-costing-overview)  
