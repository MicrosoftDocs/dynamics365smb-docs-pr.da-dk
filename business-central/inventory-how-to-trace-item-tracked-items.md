...
ms.author: edupont
---
# <a name="trace-item-tracked-items" />Spore vare via varesporing
...
## <a name="to-trace-item-tracked-items" />Sådan spores varer via varesporing
...
## <a name="to-find-item-tracked-items-with-find-entries" />Sådan findes varesporede varer med Find poster
