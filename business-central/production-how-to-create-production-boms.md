...
ms.author: bholtorf
---
# <a name="create-production-boms"></a><a name="create-production-boms"></a><a name="create-production-boms"></a>Oprette produktionsstyklister
...
## <a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a>Sådan oprettes en produktionsstykliste
...
## <a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a>Sådan oprettes en ny version af en produktionsstykliste
...
## <a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a>Beregningsformel for mængde på produktionsstyklister
