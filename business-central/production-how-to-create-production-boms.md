...
ms.author: bholtorf
---
# <a name="create-production-boms" />Oprette produktionsstyklister
...
## <a name="to-create-a-production-bom" />Sådan oprettes en produktionsstykliste
...
## <a name="to-create-a-new-version-of-a-production-bom" />Sådan oprettes en ny version af en produktionsstykliste
...
## <a name="quantity-calculation-formula-on-production-boms" />Beregningsformel for mængde på produktionsstyklister
