...
ms.author: bholtorf
---
# <a name="allocation-status-and-repair-status-of-service-items"></a><a name="allocation-status-and-repair-status-of-service-items"></a>Allokeringsstatus og reparationsstatus for serviceartikler
...
## <a name="changing-repair-status"></a><a name="changing-repair-status"></a>Ændre reparationsstatus
...
## <a name="canceling-allocations"></a><a name="canceling-allocations"></a>Annullere allokeringer
...
## <a name="reallocating-an-active-allocation-entry"></a><a name="reallocating-an-active-allocation-entry"></a>Genallokere en aktiv allokeringspost
...
## <a name="reallocating-a-service-item"></a><a name="reallocating-a-service-item"></a>Genallokere en serviceartikel
