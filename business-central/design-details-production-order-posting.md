...
ms.author: edupont
---
# <a name="design-details-production-order-posting" />Designoplysninger: Bogføring af produktionsordre
...
## <a name="posting-structure" />Bogføringsstruktur
...
## <a name="capacity-posting" />Bogføring af kapacitet
...
## <a name="production-order-costing" />Produktionsordrekostmetode
