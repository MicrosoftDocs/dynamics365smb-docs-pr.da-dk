...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a>Konfigurere standardrutelinjer
...
## <a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a>Sådan defineres en standardopgave
...
## <a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a>Sådan tilføjes en standardopgave til en operation
