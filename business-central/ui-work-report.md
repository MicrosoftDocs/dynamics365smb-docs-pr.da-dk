...
---
# <a name="run-and-print-reports-in-business-central"></a>Køre og udskrive rapporter
...
## <a name="use-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Bruge standardværdier - foruddefinerede indstillinger
...
## <a name="specify-the-data-to-include-in-a-report"></a>Angive dataene, der skal medtages i rapporter
...
## <a name="preview-a-report"></a>Visning af en rapport
...
## <a name="save-a-report-to-a-file"></a>Gemme en rapport i en fil
...
## <a name="print-a-report"></a><a name="PrintReport"></a>Udskrive en rapport
...
### <a name="print-reports-in-thai"></a>Udskrive rapporter på thailandsk
...
## <a name="switch-the-report-layout"></a>Skifte rapportlayoutet
