...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central" />Dele forretnings data fra Business central
...
## <a name="copying-a-link" />Kopiering af link
...
### <a name="modify-the-page-link" />Rediger side hyperlinket
...
### <a name="about-filtered-lists" />Om filtrerede lister
...
## <a name="sharing-to-teams" />Dele med Teams
...
## <a name="sharing-through-onedrive" />Deling via OneDrive
...
## <a name="opening-in-excel" />Åbne i Excel
...
## <a name="sharing-rows-or-tables" />Dele rækker eller tabeller
