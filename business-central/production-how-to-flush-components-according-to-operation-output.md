---
title: Rense komponenter i henhold til handlingsoutput
description: 'Denne artikel beskriver, hvordan du tømmer komponenter i henhold til operationsoutput samt andre trækmetoder.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
# <a name="flush-components-according-to-operation-output"></a>Rense komponenter i henhold til handlingsoutput
