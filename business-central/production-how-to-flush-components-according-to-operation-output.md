...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output" />Udtrække komponenter i henhold til operationsafgang
...
## <a name="automatic-consumption-posting-flushing-methods" />Automatisk bogføring af forbrugsmetode (træk)
...
### <a name="automatic-reporting---forward-flush-the-entire-order" />Automatisk rapportering – forlæns træk af hele ordren
...
### <a name="automatic-reporting---forward-flushing-by-operation" />Automatisk rapportering – forlæns træk for én operation ad gangen
...
### <a name="automatic-reporting---back-flushing-by-operation" />Automatisk rapportering – baglæns træk for én operation ad gangen
...
### <a name="automatic-reporting---back-flushing-the-entire-order" />Automatisk rapportering – baglæns træk af hele ordren
...
## <a name="to-flush-components-according-to-operation-output" />Udtrække komponenter i henhold til operationsafgang
...
## <a name="flushing-methods" />Trækmetoder
