...
ms.author: edupont
---
# <a name="bulk-invoicing-for-microsoft-bookings-in-"></a><a name="bulk-invoicing-for-microsoft-bookings-in-"></a>Massefakturering for Microsoft Bookings i [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="connect-to-bookings"></a><a name="connect-to-bookings"></a>Oprette forbindelse til Bookings
...
## <a name="invoice-appointments"></a><a name="invoice-appointments"></a>Fakturaaftaler
