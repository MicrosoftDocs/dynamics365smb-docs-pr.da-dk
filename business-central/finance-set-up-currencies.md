...
ms.author: edupont
---
# <a name="set-up-currencies" />Konfigurere valutaer
...
### <a name="available-currency-functions" />Tilgængelige valutafunktioner
...
## <a name="lcy-and-other-currencies" />RV og andre valutaer

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies" />Afrundingsvalutaer
...
### <a name="unit-amount-rounding" />Pris-afrunding
...
### <a name="amount-rounding" />Afrunding
...
## <a name="general-ledger-accounts" />Finanskonti
...
## <a name="see-related-microsoft-trainingtrainingmodulescurrencies-exchange-rates-dynamics-365-business-central" />Se relateret [Microsoft-træning](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
