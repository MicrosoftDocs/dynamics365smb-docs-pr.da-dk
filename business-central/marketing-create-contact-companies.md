...
ms.author: edupont
---
# <a name="create-contacts" />Oprette kontakter
...
## <a name="to-create-a-contact-manually" />Sådan oprettes en kontakt manuelt
...
## <a name="to-create-a-contact-from-a-customer-vendor-or-bank-account" />Sådan oprettes en kontakt fra en debitor, kreditor eller bankkonto.
...
## <a name="to-create-a-customer-vendor-employee-or-bank-account-from-a-contact" />Sådan oprettes en debitor, kreditor, ansat eller bankkonto på grundlag af en kontakt
...
## <a name="to-link-a-contact-to-an-existing-customer-vendor-employee-or-bank-account" />Sådan sammenkædes en kontakt til en eksisterende debitor, kreditor, ansat eller bankkonto.
...
## <a name="to-remove-a-link-between-a-contact-and-an-existing-customer-vendor-employee-or-bank-account" />Sådan fjernes et link mellem en kontakt og en eksisterende debitor, kreditor, ansat eller bankkonto.
...
## <a name="synchronizing-contacts-with-customers-vendors-employees-and-bank-accounts" />Synkronisering af kontakter med debitorer, kreditorer, medarbejdere og bankkonti
...
## <a name="to-view-which-customer-vendor-employee-or-bank-account-a-contact-is-related-to" />Sådan får du vist, hvilken debitor, kreditor, ansat eller bankkonto en kontaktperson vedrører
