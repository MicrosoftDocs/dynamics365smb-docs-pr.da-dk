...
ms.author: edupont
---
# <a name="export-your-business-data-to-excel" />Eksportere Business-data til Excel
...
## <a name="opening-lists-in-excel" />Åbne lister i Excel
...
### <a name="edit-data-in-excel" />Redigere data i Excel
