...
ms.author: edupont
---
# <a name="create-jobs" />Oprette sager
...
## <a name="to-create-a-job-card" />Sådan oprettes et sagskort
...
## <a name="to-create-tasks-for-a-job" />Sådan oprettes opgaver for en sag
...
## <a name="to-create-planning-lines-for-a-job" />Sådan oprettes planlægningslinjer for en sag
