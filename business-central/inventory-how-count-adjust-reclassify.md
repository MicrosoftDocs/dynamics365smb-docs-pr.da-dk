...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals" />Tælle, justere og ompostere inventar ved hjælp af kladder
...
## <a name="to-count-physical-inventory" />Fysisk lagerbeholdningsoptælling
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations" />Sådan beregnes den forventede lagerbeholdning i grundlæggende lageropsætninger
...
### <a name="to-print-the-report-to-be-used-when-counting" />Sådan udskrives rapporten, der skal bruges til optælling
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations" />Sådan angives og bogføres den faktiske optalte lagerbeholdning i grundlæggende lageropsætninger
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations" />Sådan beregnes den forventede lagerbeholdning i avancerede lageropsætninger
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations" />Sådan angives og bogføres den faktiske optalte lagerbeholdning i avancerede lageropsætninger
...
## <a name="to-do-cycle-counting" />Sådan udføres periodisk optælling
...
### <a name="to-set-up-counting-periods" />Sådan defineres optællingsperioder
...
### <a name="to-assign-a-counting-period-to-an-item" />Sådan tildeles en optællingsperiode til en vare
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations" />Sådan foretages en optælling, der er baseret på optællingsperioder i grundlæggende lageropsætninger
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations" />Sådan foretages en optælling, der er baseret på optællingsperioder i avancerede lageropsætninger
...
## <a name="to-adjust-the-quantity-of-one-item" />Sådan regulerer du lagerbeholdningen for én vare
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations" />Sådan reguleres antallet for flere varer i grundlæggende lageropsætninger
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations" />Sådan reguleres placeringsantal i avancerede lageropsætninger
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries" />Sådan synkroniseres de regulerede lagerposter med de relaterede vareposter
