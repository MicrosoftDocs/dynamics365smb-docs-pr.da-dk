...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals"></a><a name="count-adjust-and-reclassify-inventory-using-journals"></a><a name="count-adjust-and-reclassify-inventory-using-journals"></a>Tælle, justere og ompostere inventar ved hjælp af kladder
...
## <a name="to-count-physical-inventory"></a><a name="to-count-physical-inventory"></a><a name="to-count-physical-inventory"></a>Fysisk lagerbeholdningsoptælling
...
- Hvis lokationen ikke bruger styret læg-på-lager og pluk, skal du bruge siden **Lageropgørelseskladde**. Brug derefter **Varekladder**-siden til at udføre beregningen af **Lagerstedsregulering**-handlingen. <!--We should say what to do on each of these pages.-->

### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a><a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a><a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a>Sådan beregnes den forventede lagerbeholdning i grundlæggende lageropsætninger
...
### <a name="to-print-the-report-to-be-used-when-counting"></a><a name="to-print-the-report-to-be-used-when-counting"></a><a name="to-print-the-report-to-be-used-when-counting"></a>Sådan udskrives rapporten, der skal bruges til optælling
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a>Sådan angives og bogføres den faktiske optalte lagerbeholdning i grundlæggende lageropsætninger
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a><a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a><a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a>Sådan beregnes den forventede lagerbeholdning i avancerede lageropsætninger
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a>Sådan angives og bogføres den faktiske optalte lagerbeholdning i avancerede lageropsætninger
...
## <a name="to-do-cycle-counting"></a><a name="to-do-cycle-counting"></a><a name="to-do-cycle-counting"></a>Sådan udføres periodisk optælling
...
### <a name="to-set-up-counting-periods"></a><a name="to-set-up-counting-periods"></a><a name="to-set-up-counting-periods"></a>Sådan defineres optællingsperioder
...
### <a name="to-assign-a-counting-period-to-an-item"></a><a name="to-assign-a-counting-period-to-an-item"></a><a name="to-assign-a-counting-period-to-an-item"></a>Sådan tildeles en optællingsperiode til en vare
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a>Sådan foretages en optælling, der er baseret på optællingsperioder i grundlæggende lageropsætninger
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a>Sådan foretages en optælling, der er baseret på optællingsperioder i avancerede lageropsætninger
...
## <a name="to-adjust-the-quantity-of-one-item"></a><a name="to-adjust-the-quantity-of-one-item"></a><a name="to-adjust-the-quantity-of-one-item"></a>Sådan regulerer du lagerbeholdningen for én vare
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a><a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a><a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a>Sådan reguleres antallet for flere varer i grundlæggende lageropsætninger
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a><a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a><a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a>Sådan reguleres placeringsantal i avancerede lageropsætninger

Hvis lokationen bruger styret læg-på-lager og pluk, skal du bruge siden **Lagervarekladde** til at bogføre ikke-planlagte positive og negative ændringer i antal. F.eks. for varer, der er bogført som manglende, eller tab, der er opstået uventet.  
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries"></a><a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries"></a><a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries"></a>Sådan synkroniseres de regulerede lagerposter med de relaterede vareposter
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/adjust-inventory/)
