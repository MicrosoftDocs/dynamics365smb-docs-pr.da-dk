...
---
# <a name="monitor-job-progress-and-performance" />Overvåge jobstatus og -udførelse
...
## <a name="create-a-job-wip-method" />Opret et job med igangværende arbejde-metoden
...
## <a name="define-a-wip-method-for-a-job" />Definere en metode for igangværende arbejde for en sag
...
### <a name="define-a-wip-method-for-a-job-task" />Definere en metode for igangværende arbejde for en sagsopgave
...
## <a name="calculate-wip" />Beregn VIA
...
## <a name="calculate-and-post-job-completion-entries" />Beregn og bogfør sagsafslutningsposter
...
## <a name="view-job-ledger-entries" />Vise sagsposter
