...
# <a name="manually-synchronize-table-mappings" />Synkroniser tabeltilknytninger manuelt
...
## <a name="run-a-full-synchronization" />Kør en fuldstændig synkronisering
...
### <a name="to-run-a-full-synchronization" />Sådan kører du en fuldstændig synkronisering
...
## <a name="synchronizing-all-modified-records" />Synkroniser alle ændrede records
...
### <a name="to-synchronize-data-for-all-tables" />Synkroniser data for alle tabeller
...
## <a name="synchronize-individual-table-mappings" />Synkroniser individuelle tabeltilknytninger
...
### <a name="to-synchronize-records-of-an-integration-table-mapping" />Synkroniser records fra en integrationstabeltilknytning
