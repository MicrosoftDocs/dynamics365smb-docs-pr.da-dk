...
# <a name="manually-synchronize-table-mappings"></a><a name="manually-synchronize-table-mappings"></a><a name="manually-synchronize-table-mappings"></a>Synkroniser tabeltilknytninger manuelt
...
## <a name="run-a-full-synchronization"></a><a name="run-a-full-synchronization"></a><a name="run-a-full-synchronization"></a>Kør en fuldstændig synkronisering
...
### <a name="to-run-a-full-synchronization"></a><a name="to-run-a-full-synchronization"></a><a name="to-run-a-full-synchronization"></a>Sådan kører du en fuldstændig synkronisering
...
## <a name="synchronizing-all-modified-records"></a><a name="synchronizing-all-modified-records"></a><a name="synchronizing-all-modified-records"></a>Synkroniser alle ændrede records
...
### <a name="to-synchronize-data-for-all-tables"></a><a name="to-synchronize-data-for-all-tables"></a><a name="to-synchronize-data-for-all-tables"></a>Synkroniser data for alle tabeller
...
## <a name="synchronize-individual-table-mappings"></a><a name="synchronize-individual-table-mappings"></a><a name="synchronize-individual-table-mappings"></a>Synkroniser individuelle tabeltilknytninger
...
### <a name="to-synchronize-records-of-an-integration-table-mapping"></a><a name="to-synchronize-records-of-an-integration-table-mapping"></a><a name="to-synchronize-records-of-an-integration-table-mapping"></a>Synkroniser records fra en integrationstabeltilknytning
