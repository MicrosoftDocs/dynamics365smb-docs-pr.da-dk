...
# Fejlfinding af Microsoft Teams-integration med [!INCLUDE [prod_short](includes/prod_short.md)]
...
## Dette link til logon fungerer ikke
...
## Fejlen "Noget gik galt" vises ved søgning efter kontakter
...
## Fejlmeddelelsen "Kontaktoversigt over kontakt/Kontaktoversigt blev ikke fundet" under søgning efter kontakter
...
## Ingen af mine links udvides til et kort 
...
1. Kontroller først, at [!INCLUDE [prod_short](includes/prod_short.md)]-appen for Teams er installeret.
    ...
    Kontroller ved åbne Teams stationære pc-app eller Teams i browseren. Vælg derefter på venstre side **Apps**, og søg efter **[!INCLUDE [prod_short](includes/prod_short.md)]**. Når du finder **[!INCLUDE [prod_short](includes/prod_short.md)]**-appen, skal du vælge den for at åbne siden App-oplysninger. Hvis knappen **Tilføj** vises, er appen [!INCLUDE [prod_short](includes/prod_short.md)] ikke installeret. Du kan finde flere oplysninger om, hvordan du installerer appen, i [Installation af [!INCLUDE [prod_short](includes/prod_short.md)]-app til Microsoft Teams](across-install-app-for-teams.md).

    > [!NOTE]
    > Gæstebrugere kan ikke straks installere apps. Du kan finde flere oplysninger om gæstebrugere på vores [ofte stillede spørgsmål om samarbejde med gæster](teams-faq.md?tabs=collaborating#language). 

2. Kontroller derefter, at du har logget ind med den korrekte identitet.

    I Teams skal du gå til en vilkårlig chat, højreklikke under meddelelsesboksen på ikonet [!INCLUDE [prod_short](includes/prod_short.md)] og derefter vælge **Indstillinger**. Det vindue, der vises, angiver den brugerkonto, du er logget ind som. Kontroller, at det er den korrekte brugerkonto.
...
## Mine hyperlinks udvides nogle gange ikke til et kort 
...
- Netværksproblemer får Teams til at afbryde uovervågede forsøg på at vise kortet efter 15 sekunder, f.eks.
...
## Vinduet detaljer åbnes, men der vises en fejlmeddelelse, inden detaljer vises
...
## Jeg har problemer med kameraet eller stedet i grupper
...
## Teams viser blandede sprog for mine kort og kort detaljer
...
## Jeg har redigeret et felt i detalje vinduet, men ændringen blev ikke gemt
...
## Der vises et nyt felt i Appstarteren. Hvordan fjerner jeg det?
...
Som administrator, der har Microsoft Entra-administratorrettigheder, kan du skjule flisen ved at benytte følgende fremgangsmåde:

1. Log på [Microsoft Entra-administrationscenter](https://entra.microsoft.com/).
...
## Dublettekst i vinduet Del til Teams
...
## Vinduet Del til Teams kan ikke logges ind 
...
## Mine kort har ikke længere en pop-op-knap
...
## Kan ikke fastgøre et kort til fanen

Der er to grunde til dette problem.
...
## Nogen har tilføjet en fane, men fanen vises ikke for mig
...
## Andre ser forskellige sorterings- eller kolonneformater, end hvad faneudvikleren ser
