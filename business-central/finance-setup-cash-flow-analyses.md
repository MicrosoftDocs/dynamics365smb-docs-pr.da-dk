...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis"></a><a name="setting-up-cash-flow-analysis"></a>Opsætning af pengestrømsanalyse
...
## <a name="the-cash-cycle-and-income--expense-charts"></a><a name="the-cash-cycle-and-income--expense-charts"></a>Diagrammerne Kassebeholdningsproces og Indtægter og udgifter
...
## <a name="set-up-the-cash-flow-chart"></a><a name="set-up-the-cash-flow-chart"></a>Konfigurere diagrammet Pengestrøm
...
## <a name="set-up-cash-flow-forecasts"></a><a name="set-up-cash-flow-forecasts"></a>Konfigurere pengestrømsprognoser
...
#### <a name="receivables"></a><a name="receivables"></a>Tilgodehavender
...
#### <a name="payables"></a><a name="payables"></a>Gæld
...
#### <a name="tax"></a><a name="tax"></a>Skat
...
## <a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="AnchorText"></a>Oprette og bruge din egen prognosewebtjeneste til pengestrømsprognoser
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/forecast-cash-flow-dynamics-365-business-central/index)
