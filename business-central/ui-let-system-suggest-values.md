...
ms.author: bholtorf
---
# Lade [!INCLUDE[prod_short](includes/prod_short.md)] foreslå værdier
...
## Afkrydsningsfeltet **Foreslå modkontobeløb** på siden **Finanskladdenavne**
...
### Sådan udfyldes feltet **Beløb** til afstemning af finanskladdelinjer automatisk
...
## Feltet **Udfyld Dato for modtaget automatisk** på siden **Betalingsregistrering**
...
### Sådan udfyldes feltet **Dato for modtaget** automatisk på siden **Betalingsregistrering**
