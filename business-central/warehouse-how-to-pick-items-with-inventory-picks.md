...
---
# <a name="pick-items-with-inventory-picks" />Plukke varer med Pluk fra lager
...
## <a name="to-create-multiple-inventory-picks-with-a-batch-job" />Sådan oprettes flere pluk fra lager med en kørsel
...
## <a name="to-create-the-pick-in-two-steps" />Sådan oprettes pluk i to trin

### <a name="to-request-an-inventory-pick-by-releasing-the-source-document" />Sådan anmoder du om et lagerpluk ved at frigive kildedokumentet
...
### <a name="to-create-an-inventory-pick-based-on-the-source-document" />Sådan oprettes et pluk på basis af kildedokumentet
...
## <a name="to-record-inventory-picks" />Sådan registreres lagerpluk
...
## <a name="handling-assemble-to-order-items-with-inventory-picks" />Håndtering af montage til ordre-varer med pluk (lager)
