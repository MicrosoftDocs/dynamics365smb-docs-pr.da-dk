...
# <a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a>Konfigurere fejlrapportering
...
## <a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a>Sådan angives det generelle fejlrapporteringsniveau
...
## <a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a>Sådan indsættes fejl- og løsningskoderelationer
