...
ms.author: edupont
---
# <a name="reconcile-payments-that-cannot-be-applied-automatically" />Afstemme betalinger, der ikke kan udlignes automatisk
...
## <a name="to-reconcile-payments-that-cannot-be-applied-automatically" />Sådan afstemmes betalinger, der ikke kan udlignes automatisk
