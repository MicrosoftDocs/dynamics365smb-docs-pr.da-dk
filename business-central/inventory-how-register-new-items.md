...
ms.author: edupont
---
# <a name="register-new-items" />Registrere nye varer
...
## <a name="to-create-a-new-item-card" />Sådan oprettes et nyt varekort
...
### <a name="to-save-the-item-card-as-a-template" />Sådan gemmes varekortet som en skabelon
...
### <a name="items-used-in-production-orders" />Varer, der bruges i produktionsordrer
...
## <a name="to-set-up-multiple-vendors-for-an-item" />Sådan oprettes flere leverandører af en vare
...
## <a name="set-up-item-substitutions" />Konfigurere erstatningsvarer

Du kan definere, at varer skal have erstatningsvarer, f. eks. andre varer, der kan bruges i stedet for den oprindelige vare.

### <a name="to-make-an-item-substitution" />Sådan gør du en vare en erstatning
...
## <a name="deleting-item-cards" />Sletning af varekort
...
## <a name="manage-inventory-in-warehouses" />Administration af lager på lagersteder
