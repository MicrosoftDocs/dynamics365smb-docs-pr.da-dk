...
ms.author: edupont
---
# <a name="set-up-approval-workflows"></a><a name="set-up-approval-workflows"></a><a name="set-up-approval-workflows"></a>Konfigurer godkendelsesworkflow
...
## <a name="example-of-an-approval-workflow"></a><a name="example-of-an-approval-workflow"></a><a name="example-of-an-approval-workflow"></a>Eksempel på et godkendelsesworkflow
