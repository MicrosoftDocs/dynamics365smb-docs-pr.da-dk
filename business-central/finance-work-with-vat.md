...
ms.author: bholtorf
---
# <a name="work-with-vat-on-sales-and-purchases" />Arbejde moms af salg og køb
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents" />Beregne og vise momsbeløb i salg- og købsdokumenter
...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts" />Inklusive eller eksklusive moms i priser og linjebeløb
...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups" />Bruge momsvirksomhedsbogføringsgrupper og debitorprisgrupper
...
## <a name="working-with-vat-date" />Arbejde med momsdato

### <a name="vat-date-in-documents" />Momsdato i dokumenter
...
### <a name="modifying-the-vat-date-in-posted-entries" />Tilpasse momsdato i bogførte poster
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents" />Manuel korrektion af momsbeløb i salgs- og købsdokumenter
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents" />Sådan indstilles systemet for manuel momspostering i salgsdokumenter
...
### <a name="to-adjust-vat-for-a-sales-document" />Sådan reguleres moms for et salgsdokument
...
## <a name="calculating-vat-manually-using-journals" />Manuel momsberegning ved hjælp af kladder
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals" />Sådan indstilles systemet til manuel momspostering i finanskladder
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals" />Sådan indstilles systemet til manuel momspostering i salgs- og købskladder
...
## <a name="posting-import-vat-with-purchase-invoices" />Sådan bogføres importmoms på købsfakturaer
I stedet for at bruge kladder, når du bogfører en faktura med importmoms, kan du bruge en købsfaktura.  

### <a name="to-set-up-purchasing-for-posting-import-vat-invoices" />Konfigurere Indkøb til at bogføre fakturaer med importmoms
...
### <a name="to-create-a-new-invoice-for-the-import-authority-vendor-once-you-have-completed-the-setup" />Sådan oprettes en ny faktura til importmyndigheden (leverandører), når du har foretaget opsætningen
...
## <a name="processing-certificates-of-supply" />Behandling af leveringscertifikater
...
### <a name="to-view-certificate-of-supply-details" />Sådan får du vist leveringscertifikatdetaljer
...
### <a name="to-print-a-certificate-of-supply" />Sådan udskriver du et leveringscertifikat
...
### <a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment" />Sådan opdaterer du status for et leveringscertifikat til en leverance
...
### <a name="to-update-the-status-of-a-group-of-certificates-of-supply" />Sådan opdaterer du status for en gruppe af leveringscertifikater
