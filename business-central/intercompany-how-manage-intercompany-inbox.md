...
## <a name="get-an-overview-of-intercompany-transactions-for-a-period"></a>Få vist en oversigt over IC-transaktioner i en periode
...
## <a name="import-intercompany-transactions-from-a-file"></a>Importere IC-transaktioner fra en fil
...
## <a name="process-incoming-intercompany-transactions"></a>Sådan behandles indgående IC-transaktioner
...
## <a name="recreate-intercompany-inbox-transactions"></a>Gendanne transaktionerne i den koncerninterne indbakke
