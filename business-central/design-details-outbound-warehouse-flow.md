...
---
# <a name="outbound-warehouse-processes"></a><a name="outbound-warehouse-processes"></a>Udgående lagerprocesser
...
### <a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a>1: Frigiv et kildedokument
...
### <a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a>2: Opret lagerpluk
...
### <a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a>3: Bogfør lagerpluk
...
### <a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a>1: Frigiv et kildedokument
...
### <a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a>2: Opret en lagerleverance
...
### <a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a>3: Opret lagerstedspluk
...
### <a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a>4: Registrer et lagerstedspluk
...
### <a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a>5: Bogfør lagerstedsleverance
