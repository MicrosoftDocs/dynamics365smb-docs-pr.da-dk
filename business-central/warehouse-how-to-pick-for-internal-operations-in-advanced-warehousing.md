...
ms.author: bholtorf
---
# Pluk til produktion, montage eller jobs i avancerede lageropsætninger
...
7. Vælg handlingen **Opret pluk**. Siden **Opret pluk** åbnes, hvor du kan tilføje yderligere oplysninger til plukket.  
    ...
    |Indstilling|Beskrivlse|
    |-|-|
    |Maks. Antal af pluklinjer|Opretter plukdokumenter, der ikke har mere end det angivne antal linjer i hvert dokument.|
...
## Sådan plukkes varer til en produktionsordre, Montageordre, sag
