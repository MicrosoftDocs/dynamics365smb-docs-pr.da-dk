...
ms.author: bholtorf
---
# <a name="pick-for-production-assembly-or-jobs-in-advanced-warehouse-configurations" />Pluk til produktion, montage eller jobs i avancerede lageropsætninger
...
## <a name="to-pick-items-for-a-productions-order-assembly-order-job" />Sådan plukkes varer til en produktionsordre, Montageordre, sag
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Træk af komponenter til produktion i en avanceret lageropsætning
