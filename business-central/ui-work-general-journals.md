...
---
# <a name="work-with-general-journals" />Arbejde med finanskladder
...
## <a name="use-journal-templates-and-batches" />Bruge kladdeskabeloner og -batches
...
### <a name="validating-general-journal-batches" />validering af Finanskladdenavne
...
## <a name="understanding-main-accounts-and-balancing-accounts" />Om hovedkonti og modkonti
...
## <a name="work-with-recurring-journals" />Arbejde med gentagelseskladder
...
### <a name="recurring-method-field" />Feltet Gentagelsesmetode
...
### <a name="recurring-frequency-field" />Feltet Gentagelsesinterval
...
### <a name="expiration-date-field" />Feltet Udløbsdato
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts" />Tildeling af tilbagevendende kladdebeløb til flere konti
...
#### <a name="example-allocating-rent-payments-to-different-departments" />Eksempel: Fordeling af huslejebetalinger til forskellige afdelinger
...
### <a name="calculate-the-reversal-date" />Beregne annulleringsdatoen
...
## <a name="work-with-standard-journals" />Arbejde med standardkladder
...
### <a name="to-save-a-standard-journal" />Sådan gemmes en standardkladde
...
### <a name="to-reuse-a-standard-journal" />Sådan genbruges en standardkladde
...
## <a name="to-renumber-document-numbers-in-journals" />Omnummerere bilagsnumre i kladder
...
### <a name="to-renumber-documents-in-journals" />Omnummerere bilag i kladder
...
## <a name="see-related-microsoft-training" />Se relateret [Microsoft-træning](/training/paths/use-journals-dynamics-365-business-central/)
