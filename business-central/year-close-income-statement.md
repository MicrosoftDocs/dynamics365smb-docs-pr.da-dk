...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Nulstille resultatopgørelseskonti
...
## <a name="to-run-the-close-income-statement-batch-job" />Sådan udføres kørslen Nulstil resultatopgørelse
...
## <a name="about-the-close-income-statement-batch-job" />Om kørslen Nulstil resultatopgørelse
