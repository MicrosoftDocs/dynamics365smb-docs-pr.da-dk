...
ms.author: edupont
---
# <a name="batch-post-production-consumption" />Massebogføre produktionsforbrug
...
## <a name="to-post-consumption-for-one-or-more-production-order-lines" />Sådan bogføres forbrug for en eller flere produktionsordrelinjer
