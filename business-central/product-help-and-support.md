...
# <a name="resources-for-help-and-support" />Hjælp og support
...
## <a name="in-product-tips" />Hjælp til produktet
...
## <a name="search-in-the-help-pane" />Søg i ruden hjælp
...
## <a name="help--support-page" />Siden Hjælp og support
...
### <a name="find-answers" />Finde svar
...
#### <a name="product-help" />Produkthjælp
...
#### <a name="capabilities-coming-soon" />Funktioner, der lanceres snart
...
### <a name="do-more-with-your-trial" />Få mere ud af din prøveversion
...
### <a name="give-feedback" />Send feedback
...
### <a name="product-suggestions" />Produktforslag
...
### <a name="report-a-problem" />Rapportér et problem
...
### <a name="support-contacts" />Supportkontrakter
...
## <a name="learn-more-using-the-product-documentation" />Flere oplysninger om brug af produktdokumentationen
...
### <a name="content-on-the-site" />Indhold på webstedet
...
### <a name="finding-other-content" />Søge efter andet indhold
...
### <a name="recommended-content" />Anbefalet indhold

I marts 2021 blev der introduceret en ny sektion i de fleste artikler på Microsoft Learn. Sektionen **Anbefalet indhold** genereres automatisk, afhængigt af hvordan hver artikel bruges sammen med resten af webstedet. Linkene er ikke statiske og ændres med tiden.

### <a name="tell-us-what-you-think" />Fortæl os, hvad du synes
...
### <a name="navigating-to-other-parts-of-the-site" />Navigere til andre dele af webstedet
...
## <a name="apps-and-other-solutions" />Apps og andre løsninger
