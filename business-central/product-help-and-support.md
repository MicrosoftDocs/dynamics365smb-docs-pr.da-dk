...
I afsnittet **Rapportér et problem** vises en mailadresse eller et hyperlink, som du kan bruge til at få kontakt med personen eller teamet hos kundesupport. Hvis du er [!INCLUDE[prodshort](includes/prodshort.md)]-detailforhandleren for en lejer, kan du angive dine foretrukne supportkontaktoplysninger i Administration. Du kan finde flere oplysninger under [Konfigurer supportoplevelsen](/dynamics365/business-central/dev-itpro/technical-support#configuring-the-support-experience) i administrationsindholdet til [!INCLUDE[prodshort](includes/prodshort.md)].  
...
Webstedet docs.microsoft.com er standardplaceringen for læring om funktioner i [!INCLUDE[prodshort](includes/prodshort.md)]. Webstedet indeholder [begrebsmæssige oplysninger om forretningsfunktioner](index.md), [dokumentation til udviklere](/dynamics365/business-central/dev-itpro/developer/devenv-dev-overview), [indlæringsstier og e-læringsmoduler](/learn/browse/?expanded=dynamics&products=dynamics-business-central) på tværs af flere brugerprofiler og meget mere. I dette afsnit kan du få mere at vide om, hvordan du kan navigere i forretningsfunktionalitetens indhold.  
...
Navigationspanelet til venstre, indholdsfortegnelsen, grupperer artikler efter forretningsområde. Du kan f.eks. læse artiklen [Købe varer til et salg](purchasing-how-purchase-products-sale.md), og derefter viser indholdsfortegnelsen, at der også er en artikel, der hedder [Rette eller annullere ubetalte købsfakturaer](purchasing-how-correct-cancel-unpaid-purchase-invoices.md). Begge artikler er i gruppen *Indkøb*, som indeholder artikler med relation til modulet Indkøb i [!INCLUDE [prodshort](includes/prodshort.md)].  
...
Det lokale indhold af funktionaliteten beskriver mulighederne i [!INCLUDE [prodshort](includes/prodshort.md)], der kan hjælpe med at være kompatible på de understøttede markeder, f.eks. selvangivelser og andre rapporter. I nogle tilfælde er forskellen mellem standardversionen og den landespecifikke version usynlig for brugerne. I andre tilfælde skal brugerne oprette rapportering eller elektronisk fakturering på en bestemt måde. Hvis du ikke kan finde en beskrivelse af en bestemt knap eller handling i standardsektionen for indholdet på docs.microsoft.com, kan du forhåbentlig finde den i afsnittet *Lokal funktionalitet*.  
...
- Brug **Søg**-feltet i øverste højre hjørne af webstedet
  ...
  På den måde kan du søge efter et hvilket som helst udtryk. Webstedet vil derefter søge i alt indhold efter det pågældende ord eller udtryk. Søg efter *faktura* igen, og rul gennem listen over hundredvis af artikler i det [!INCLUDE [prodshort](includes/prodshort.md)]-indhold, der bruger det pågældende ord et sted i teksten.  

### <a name="languages"></a>Sprog

Indhold om forretningsfunktionalitet publiceres på forskellige sprog. Når du lander på docs.microsoft.com fra produktet, kan du se indholdet på samme sprog som det, du har angivet i [!INCLUDE [prodshort](includes/prodshort.md)], medmindre dette sprog ikke er tilgængeligt på webstedet docs.microsoft.co.  
