...
# <a name="ship-items-with-a-warehouse-shipment"></a><a name="ship-items-with-a-warehouse-shipment"></a>Levere varer med en lagerleverance
...
## <a name="to-ship-items-using-a-warehouse-shipment-document"></a><a name="to-ship-items-using-a-warehouse-shipment-document"></a>Sådan leveres varer med et lagerleverancedokument
...
## <a name="how-to-use-filters-to-get-source-documents"></a><a name="how-to-use-filters-to-get-source-documents"></a>Sådan bruges filtre til at hente kildedokumenter
...
## <a name="zone-and-bin-codes"></a><a name="zone-and-bin-codes"></a>Zone-og placeringskoder
...
## <a name="handling-assemble-to-order-items-in-warehouse-shipments"></a><a name="handling-assemble-to-order-items-in-warehouse-shipments"></a>Håndtering af montageordrevarer i lagerleverancer
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/ship-invoice-items-dynamics-365-business-central/).
