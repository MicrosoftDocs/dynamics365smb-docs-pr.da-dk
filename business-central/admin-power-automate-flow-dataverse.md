...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes" />Brug et Power Automate-flow til beskeder til Dataverse om ændringer af enheden
...
## <a name="import-the-flow-template" />Importer Flow-skabelonen
...
## <a name="define-the-flow-trigger" />Definer flowudløseren
...
## <a name="define-the-flow-condition" />Definer flowbetingelsen
...
## <a name="notify-business-central-about-a-change" />Giv Business Central besked om en ændring
