...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes"></a><a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes"></a>Brug et Power Automate-flow til beskeder til Dataverse om ændringer af enheden
...
## <a name="import-the-flow-template"></a><a name="import-the-flow-template"></a>Importer Flow-skabelonen
...
## <a name="define-the-flow-trigger"></a><a name="define-the-flow-trigger"></a>Definer flowudløseren
...
## <a name="define-the-flow-condition"></a><a name="define-the-flow-condition"></a>Definer flowbetingelsen
...
## <a name="notify-business-central-about-a-change"></a><a name="notify-business-central-about-a-change"></a>Giv Business Central besked om en ændring
