...
# <a name="control-access-to-business-central-using-security-groups" />Kontrollere adgangen til Business central ved brug af sikkerhedsgrupper
...
## <a name="business-central-online-and-on-premises" />Konfigurere Business Central online og lokalt
...
## <a name="add-a-security-group-in-business-central" />Tilføje en sikkerhedsgruppe i Business Central
...
### <a name="assign-permissions-to-a-security-group" />Tildele tilladelser til en sikkerhedsgruppe
...
## <a name="review-the-permissions-in-a-security-group" />Gennemse tilladelser i en sikkerhedsgruppe
...
## <a name="security-groups-and-user-groups" />Sikkerhedsgrupper og brugergrupper
...
### <a name="optional-convert-user-groups-to-permission-sets" />Eventuelt: Konvertere rettighedssæt til brugergrupper
