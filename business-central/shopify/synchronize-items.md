...
# <a name="synchronize-items-and-inventory" />Synkronisere varer og lager
...
## <a name="define-item-synchronizations" />Definere synkronisering af elementer
...
## <a name="import-items-from-shopify" />Indlæs varer fra Shopify
...
### <a name="effect-of-shopify-product-skus-and-barcodes-on-mapping-and-creating-items-and-variants-in-business-central" />Effekten af SKU og stregkoder i Shopify-produkt, der påvirker tilknytning og oprettelse af varer og varianter i Business Central
...
## <a name="export-items-to-shopify" />Eksporter til Excel Shopify
...
### <a name="fields-mapping-overview" />Oversigt over felttilknytning
...
## <a name="run-item-synchronization" />Kør varesynkronisering

Du kan udføre fuldstændig eller delvis synkronisering af elementer på mange forskellige måder.

### <a name="initial-sync-of-items-from-business-central-to-shopify" />Oprindelig synkronisering af varer fra Business Central til Shopify
...
### <a name="sync-products-from-shopify-to-business-central" />Synkroniser produkter fra Shopify til Business central
...
### <a name="ad-hoc-updates-of-shopify-products" />Ad-Hoc-opdateringer for Shopify-produkter
...
## <a name="sync-item-images" />Synkroniser varebilleder
...
### <a name="sync-product-images-from-the-shopify-shop-page" />Synkronisere produktbilleder fra siden Shopify-butik
...
### <a name="sync-product-images-from-the-shopify-products-page" />Synkronisere produktbilleder fra Shopify-produktvinduet
...
### <a name="image-synchronization-remarks" />Bemærkninger til billedsynkronisering
...
## <a name="sync-prices-with-shopify" />Synkroniser priser med Shopify
...
### <a name="sync-prices-from-the-shopify-products-page" />Synkronisere priser fra siden Shopify-produkter

1. Gå til søgning ![Lightbulb, der åbner funktionen Fortæl mig.](../media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Shopify Produkter**, og vælg det relevante link.
2. Vælg handlingen **Synkroniser priser til Shopify**.

### <a name="price-calculation-remarks" />Bemærkninger til prisberegning
...
## <a name="sync-inventory-to-shopify" />Synkroniser lager med Shopify
...
### <a name="to-enable-inventory-sync" />Sådan aktiveres lagersynkronisering
...
### <a name="sync-inventory-from-the-shopify-shop-page" />Synkronisere lager fra Shopify-butiksvinduet

1. Gå til søgning ![Lightbulb, der åbner funktionen Fortæl mig.](../media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Shopify-butikker**, og vælg det relevante link.
2. Marker den butik, som du vil synkronisere lager med for at åbne **Shopify Butikskort**-siden.
3. Vælg handlingen **Synkroniser lager**.

### <a name="sync-inventory-from-the-shopify-products-page" />Synkronisere lager fra Shopify-produktsiden

1. Gå til søgning ![Lightbulb, der åbner funktionen Fortæl mig.](../media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Shopify Produkter**, og vælg det relevante link.
2. Vælg handlingen **Synkroniser lager**.

### <a name="inventory-remarks" />Lagerokmmentarer
...
* Lagerbeholdning og levering i **Business Central-opfyldelsestjenester** understøttes ikke. Brug normale lokationer i stedet.

#### <a name="example-of-calculation-of-projected-available-balance" />Eksempel på beregning af planlagt disponibel balance
