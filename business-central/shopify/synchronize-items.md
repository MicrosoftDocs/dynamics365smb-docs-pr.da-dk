...
|Lagerbeholdningen vil blive lagerført på| Afhænger af Shopify-butiksplaceringer. Hvis feltet **Standard** er aktiveret for **Business Central Opfyldelsestjenester**, lagerføres lageret og afsendes fra **Business Central Opfyldelsestjenester**, ellers bruges Shopify primære lokation eller flere lokationer.
| Bruges ikke.|
