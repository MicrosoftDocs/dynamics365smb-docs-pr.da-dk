...
# <a name="walkthrough-set-up-and-use-the-shopify-connector" />Gennemgang: Konfigurere og bruge Shopify Connector
...
## <a name="connect-business-central-to-the-shopify-shop" />Forbinde Business central med Shopify-butikken
...
## <a name="walkthrough-start-selling-products-online" />Gennemgang: Start salg af produkter online
...
#### <a name="prepare-data" />Klargøre data
...
#### <a name="run-the-synchronization" />Kør varesynkronisering
