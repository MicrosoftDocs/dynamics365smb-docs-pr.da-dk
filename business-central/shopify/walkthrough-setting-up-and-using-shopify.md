...
3. Angiv i feltet **Produktionskode.**  `DEMO1`
4. Indstil filteret `30000` på **Nej.** .
5. Vælg **OK**, og vent, til den første synkronisering af kunder er fuldført.

Bemærk **Shopify , at både firmaet og kunden blev importeret i Administrator**. Åbn debitorer, og læg mærke til faktaboksen for virksomheden med link til Virksomhed, lokation og tildelte tilladelser. Vælg **[...]**  ** i faktaboksen Firma, og vælg **derefter Send B2B-adgangsmail** for at invitere kunden.
...
7. Vælg handlingen **Marketingtekst**, og brug **Kladde med Copilot**  til at få en kreativ og engagerende tekst. Hvis forslag til marketingtekst ikke er aktiveret, skal du blot indtaste: "**Enkelt, stilfuldt design** passer ind i ethvert ensemble. *Findes i to udgaver.*'. 
...
4. Vælg **[...]**  **i faktaboksen School of Fine Art** og derefter **Rediger betalingsbetingelser**, og vælg *Forfalder på opfyldelse*.
5. Vælg **[...]**  **i faktaboksen Kunder** og derefter **Tilføj kunde**, og tilføj en med e-mail, du brugte til at logge ind på butikken tidligere.
...
11. Udfyld feltet **Indkøbsordrenr** . med `PO-12345`.
12. Vælg **Send ordre**.
...
4. Da vi har konfigureret B2B-virksomhed til at håndtere betalinger uden for Shopify er **Økonomisk status** angivet til *Afventer*. Når du har modtaget betalingen, skal du vælge handlingen **Markér som betalt** . Økonomisk status opdateres i Shopify. 
