...
# <a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a>Gennemgang: Konfigurere og bruge Shopify Connector
...
## <a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a>Forbinde Business central med Shopify-butikken
...
## <a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a>Gennemgang: Start salg af produkter online
...
## <a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a>Gennemgang: Inviter dine kunder til din nye onlinebutik
...
## <a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a>Gennemgang: Finjustering af varestyring

### <a name="scenario-2"></a><a name="scenario-2"></a><a name="scenario-2"></a>Scenarie
...
### <a name="steps-2"></a><a name="steps-2"></a><a name="steps-2"></a>Trin
...
## <a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a>Gennemgang: Indlæs varer fra Shopify

### <a name="scenario-3"></a><a name="scenario-3"></a><a name="scenario-3"></a>Scenarie
...
### <a name="steps-3"></a><a name="steps-3"></a><a name="steps-3"></a>Trin
...
#### <a name="prepare-data"></a><a name="prepare-data"></a><a name="prepare-data"></a>Klargøre data
...
#### <a name="run-the-synchronization"></a><a name="run-the-synchronization"></a><a name="run-the-synchronization"></a>Kør varesynkronisering
