...
### Feltet *Virksomhedsbogføringsgruppe* må ikke være nul eller tom. der skal være en værdi i feltet kunde
...
### Import af data til din Shopify-butik er ikke aktiveret. Gå til butikskortet for at aktivere det
...
### Oauth-fejl invalid_request: API-programmet blev ikke fundet Shopify med api_key
