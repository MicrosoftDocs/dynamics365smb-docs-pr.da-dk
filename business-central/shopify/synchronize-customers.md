...
# <a name="synchronize-customers" />Synkronisere debitorer
...
## <a name="important-settings-when-importing-customers-from-shopify" />Vigtige indstillinger, når du importerer debitorer fra Shopify
...
### <a name="customer-template-per-country" />Debitorskabelon pr. land
...
## <a name="export-customers-to-shopify" />Eksportér debitorer til Shopify
...
### <a name="populate-customer-information-in-shopify" />Udfyld kundeoplysninger i Shopify
...
## <a name="sync-customers" />Synkronisere debitorer
