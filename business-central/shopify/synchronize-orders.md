...
# <a name="synchronize-and-fulfill-sales-orders" />Synkronisere og opfylde salgsordrer
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card" />Angive importen af ordrer på Shopify-butikskortet
...
### <a name="shipment-method-mapping" />Tilknytning af forsendelsesmetode
...
### <a name="location-mapping" />Tilknytning af lokation
...
## <a name="run-the-order-synchronization" />Kør ordresynkronisering
...
## <a name="review-imported-orders" />Gennemgå importerede ordrer
...
## <a name="create-sales-documents-in-business-central" />Opret salgsdokument i Business Central
...
### <a name="to-create-sales-documents" />Oprette salgsdokumenter
...
### <a name="manage-missing-customers" />Administrer manglende kunder
...
### <a name="how-the-connector-chooses-which-customer-to-use" />Hvordan connectoren vælger, hvilken kunde der skal bruges
...
### <a name="different-processing-rules-for-orders" />Forskellige behandlingsregler for ordrer
...
### <a name="impact-of-order-editing" />Indflydelse på redigeringen af ordrer
...
## <a name="synchronize-shipments-to-shopify" />Synkronisere leverancer til Shopify
...
### <a name="shipping-agents-and-tracking-url" />Speditører og sporing af URL-adresse
...
## <a name="returns-and-refunds" />Returneringer og refusioner
