...
# <a name="create-and-set-up-a-shopify-account" />Oprette og konfigurere Shopify-konto
...
## <a name="trial-end-user" />Prøveversion (slutbruger)
...
## <a name="development-store" />Udviklingsbutik
