...
<!-- 7 -->
### Fungerer connectoren med API-sider?
...
-->
### <a name="perms"></a>Hvordan kan jeg ændre eller rydde den konto, jeg bruger for at oprette forbindelse til Business central fra Power BI Desktop?
...
[Opret forbindelse til Power BI fra Business Central i det lokale miljø](across-working-with-business-central-in-powerbi.md)  
