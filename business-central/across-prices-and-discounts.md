...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Konfigurere priser og rabatter
...
## <a name="setting-up-prices-and-discounts" />Konfigurere priser og rabatter
...
## <a name="about-price-lists" />Om prislister
...
## <a name="set-up-prices" />Oprette priser
...
## <a name="work-with-invoice-discounts-and-service-charges" />Arbejde med fakturarabatter og servicegebyrer
...
## <a name="calculating-the-best-price" />Beregne bedste pris
...
## <a name="see-related-microsoft-training" />Se relateret [Microsoft-træning](/training/modules/customer-discounts-dynamics-365-business-central/)
