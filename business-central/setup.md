...
ms.author: edupont
---
# <a name="overview-of-tasks-to-set-up-"></a><a name="overview-of-tasks-to-set-up-"></a><a name="overview-of-tasks-to-set-up-"></a>Oversigt over opgaver til opsætning af [!INCLUDE[prod_short](includes/prod_short.md)]
...
F.eks er din kontoplan på forhånd udfyldt med en række bogføringskonti, der er klar til brug. Du kan også ændre kontoplanen efter dine behov. Få mere at vide i [Finans](finance.md).
...
Nogle funktioner, enten generelle eller for bestemte forretningsprocesser, kan konfigureres manuelt ud over den assisterede opsætning. I følgende tabel kan du se nogle af de funktioner, som du kan konfigurere manuelt.
...
|Foretag massefakturering af aftaler, der er oprettet i Microsoft Bookings.|[Massefakturering for Microsoft Bookings](finance-bookings.md)|
...
For nogle områder kræves, at du skal være administrator i dit [!INCLUDE[prod_short](includes/prod_short.md)]-abonnement. Flere oplysninger i [Administration](admin-setup-and-administration.md).  
...
## <a name="set-up-apps"></a><a name="set-up-apps"></a><a name="set-up-apps"></a>Opsætte apps
