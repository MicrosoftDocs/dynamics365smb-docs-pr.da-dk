...
## <a name="links-to-learn-more" />Links til flere oplysninger
...
## <a name="getting-around-in-business-central" />Navigation i Business Central
Her er en kort video om, hvordan du bevæger dig rundt i [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser" />Sådan vælger du en desktopbrowser
...
## <a name="action-bars" />Handlingslinjer
...
## <a name="see-related-microsoft-trainingtrainingpathswork-pro-data-dynamics--business-central" />Se relateret [Microsoft-træning](/training/paths/work-pro-data-dynamics-365-business-central/)
