...
ms.author: edupont
---
# <a name="work-with-"></a><a name="work-with-"></a>Arbejd med [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="cheatsheet"></a>Tip
...
## <a name="links-to-learn-more"></a><a name="links-to-learn-more"></a>Links til flere oplysninger
...
## <a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a>Navigation i Business Central
Her er en kort video om, hvordan du bevæger dig rundt i [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a>Sådan vælger du en desktopbrowser
...
## <a name="action-bars"></a><a name="action-bars"></a>Handlingslinjer
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/paths/work-pro-data-dynamics-365-business-central/)
