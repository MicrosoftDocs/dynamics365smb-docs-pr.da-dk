...
ms.author: edupont
---
# <a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a>Revisoroplevelser i [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="accountant-role-center"></a><a name="accountant-role-center"></a>Rollecenteret Regnskabsmedarbejder
...
## <a name="company-hub"></a><a name="company-hub"></a>Virksomhedshub
...
## <a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviteaccountant"></a>Inviter din eksterne revisor indenfor i din [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a>Tilføjelse af din revisor til Microsoft 365 i Azure-portalen
...
#### <a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a>Sådan tilføjer du din revisor som gæstebruger
...
#### <a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a>Sådan giver du din revisor adgang til [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a>Import af den nye bruger til [!INCLUDE[prod_short](includes/prod_short.md)]
...
#### <a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a>Sådan føjes revisoren til den rigtige virksomhed
