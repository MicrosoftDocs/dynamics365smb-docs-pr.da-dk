...
ms.author: edupont
---
# <a name="change-which-features-are-displayed"></a><a name="change-which-features-are-displayed"></a><a name="change-which-features-are-displayed"></a>Ændre, hvilke funktioner der vises
...
## <a name="enabling-premium-features-after-upgrading-a-plan"></a><a name="enabling-premium-features-after-upgrading-a-plan"></a><a name="enabling-premium-features-after-upgrading-a-plan"></a>Aktivere Premium-funktioner, når du har opgraderet en plan
...
### <a name="to-update-plan-changes-in-users-groups"></a><a name="to-update-plan-changes-in-users-groups"></a><a name="to-update-plan-changes-in-users-groups"></a>Sådan opdateres planændringer i brugergrupper
...
### <a name="to-select-the-premium-experience"></a><a name="to-select-the-premium-experience"></a><a name="to-select-the-premium-experience"></a>Sådan vælges Premium-oplevelsen
...
## <a name="help-assumes-premium-experience"></a><a name="help-assumes-premium-experience"></a><a name="help-assumes-premium-experience"></a>Hjælpen forudsætter Premium-oplevelse
