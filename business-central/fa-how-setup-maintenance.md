...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Definere anlægsreparation
...
## <a name="to-set-up-general-maintenance-information" />Sådan angives generelle reparationsoplysninger
...
## <a name="to-set-up-maintenance-codes" />Sådan defineres reparationskoder
...
## <a name="to-set-up-maintenance-expense-accounts" />Sådan defineres reparationskonti
