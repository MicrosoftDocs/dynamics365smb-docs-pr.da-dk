...
ms.author: edupont
---
# <a name="set-up-base-calendars" />Konfigurere basiskalendere
...
## <a name="to-set-up-a-base-calendar" />Sådan oprettes en basiskalender
...
## <a name="lead-time-calculation" />Leveringstid
...
## <a name="to-customize-a-calendar" />Sådan tilpasses en kalender
...
## <a name="to-assign-a-base-calendar" />Sådan tildeles en basiskalender
