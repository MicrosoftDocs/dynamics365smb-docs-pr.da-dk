...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-" />Opsig eller slet [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing--from-your-app-launcher" />Fjerne [!INCLUDE[prod_short](includes/prod_short.md)] fra din appstarter
