...
ms.author: edupont
---
# <a name="reverse-output-posting"></a><a name="reverse-output-posting"></a>Tilbageføre bogføring af afgang
...
## <a name="to-reverse-an-output-posting"></a><a name="to-reverse-an-output-posting"></a>Tilbageføre en afgangsbogføring
