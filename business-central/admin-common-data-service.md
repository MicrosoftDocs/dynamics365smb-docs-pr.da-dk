...
# <a name="integrating-with-microsoft-dataverse"></a><a name="integrating-with-microsoft-dataverse"></a>Integration med Microsoft Dataverse
...
## <a name="getting-started-with-"></a><a name="getting-started-with-"></a>Introduktion til [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
## <a name="bi-directional-or-uni-directional-data-synchronization"></a><a name="bi-directional-or-uni-directional-data-synchronization"></a>Tovejs eller etvejs datasynkronisering
...
## <a name="standard-and-custom-entities"></a><a name="standard-and-custom-entities"></a>Standardobjekter og brugerdefinerede objekter
...
## <a name="about-the-business-central-base-integration-solution"></a><a name="about-the-business-central-base-integration-solution"></a>Om Business Central-basisintegrationsløsningen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/use-model-driven-apps-common-data-service/)
