...
ms.author: solsen
---
# <a name="sandbox-environments-in-"></a><a name="sandbox-environments-in-"></a>Sandkassemiljøer i [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="advanced-user-experience"></a><a name="advanced-user-experience"></a>Udvidet brugeroplevelse
...
### <a name="complete-sample-data"></a><a name="complete-sample-data"></a>Komplette eksempeldata
