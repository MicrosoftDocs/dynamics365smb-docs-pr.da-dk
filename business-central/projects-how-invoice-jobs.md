...
ms.author: edupont
---
# <a name="invoice-jobs" />Fakturere sager
...
## <a name="to-create-multiple-job-sales-invoices" />Sådan opretter du flere salgsfakturaer for sager
...
## <a name="to-create-and-post-job-sales-invoice-from-job-planning-lines" />Sådan opretter og bogfører du salgsfakturaer for sager fra sagsplanlægningslinjer
