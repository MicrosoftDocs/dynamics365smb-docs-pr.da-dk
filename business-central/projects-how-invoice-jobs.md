...
---
# <a name="invoice-projects"></a>Fakturere sager
...
## <a name="to-create-multiple-project-sales-invoices"></a>Sådan opretter du flere salgsfakturaer for sager
...
## <a name="to-create-and-post-project-sales-invoice-from-project-planning-lines"></a>Sådan opretter og bogfører du salgsfakturaer for sager fra sagsplanlægningslinjer
