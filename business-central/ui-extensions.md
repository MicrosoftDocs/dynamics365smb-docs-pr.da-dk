...
ms.author: edupont
---
# <a name="customizing-business-central-online-with-apps"></a><a name="customizing-business-central-online-with-apps"></a>Tilpasse Business Central Online med apps
...
## <a name="manage-apps"></a><a name="manage-apps"></a>Administrere apps
...
## <a name="apps-and-data-transfer"></a><a name="apps-and-data-transfer"></a>Apps og dataoverførsel
...
## <a name="connect-your-business"></a><a name="connect-your-business"></a>Opret forbindelse til din virksomhed
...
## <a name="recommended-apps"></a><a name="recommended-apps"></a>Anbefalede apps
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/customize-dynamics-365-business-central/)
