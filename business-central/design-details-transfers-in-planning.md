...
---
# <a name="design-details-transfers-in-planning" />Designoplysninger: Overførsler i planlægning
...
## <a name="why-is-a-transfer-a-special-case" />Hvorfor er overførsel et særligt tilfælde?
...
## <a name="transfers-are-dependent-demand" />Overflytninger er afhængige af efterspørgsel
...
## <a name="planning-sequence" />Planlægningssekvens
...
## <a name="transfer-level-code" />Overflytningsniveaukode
...
## <a name="planning-transfers-without-sku" />Planlægning af overførsler uden lagervare
...
## <a name="changing-quantity-with-reservations" />Ændring af antal med reservationer
...
## <a name="changing-quantity-in-a-transfer-chain" />Ændring af antal i en overførselskæde
...
## <a name="lead-time-calculation" />Beregning af leveringstid
...
## <a name="safety-lead-time" />Gennemløbstid for sikkerhed
...
## <a name="serial-and-lot-numbers-in-transfer-chains" />Serienumre/lotnumre i overførselskæder
