...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status"></a><a name="service-order-status-and-repair-status"></a><a name="service-order-status-and-repair-status"></a>Serviceordrestatus og reparationsstatus
...
## <a name="specifying-service-order-status-for-repair-status"></a><a name="specifying-service-order-status-for-repair-status"></a><a name="specifying-service-order-status-for-repair-status"></a>Angive serviceordrestatus for reparationsstatus
...
### <a name="pending"></a><a name="pending"></a><a name="pending"></a>Igangsat
...
### <a name="in-process"></a><a name="in-process"></a><a name="in-process"></a>I arbejde
...
### <a name="on-hold"></a><a name="on-hold"></a><a name="on-hold"></a>Afvent
...
### <a name="finished"></a><a name="finished"></a><a name="finished"></a>Udført
...
## <a name="assigning-priority-to-service-order-status"></a><a name="assigning-priority-to-service-order-status"></a><a name="assigning-priority-to-service-order-status"></a>Tildele prioritet til serviceordrestatus
