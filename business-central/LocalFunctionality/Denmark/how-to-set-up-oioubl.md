...
ms.author: bholtorf
---
# <a name="set-up-oioubl" />Konfigurere OIOUBL
...
### <a name="about-oioubl-profiles" />Om OIOUBL-profiler
...
## <a name="to-set-up-payment-terms" />Sådan defineres betalingsbetingelser
...
### <a name="to-set-up-customers-for-oioubl" />Sådan konfigureres kunder til OIOUBL
...
## <a name="to-set-up-item-charges" />Sådan konfigureres varegebyrer
