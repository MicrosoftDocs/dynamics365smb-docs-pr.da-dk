...
ms.author: bholtorf
---
# <a name="set-up-oioubl"></a><a name="set-up-oioubl"></a><a name="set-up-oioubl"></a>Konfigurere OIOUBL
...
### <a name="about-oioubl-profiles"></a><a name="about-oioubl-profiles"></a><a name="about-oioubl-profiles"></a>Om OIOUBL-profiler
...
## <a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a>Sådan defineres betalingsbetingelser
...
### <a name="to-set-up-customers-for-oioubl"></a><a name="to-set-up-customers-for-oioubl"></a><a name="to-set-up-customers-for-oioubl"></a>Sådan konfigureres kunder til OIOUBL
...
## <a name="to-set-up-item-charges"></a><a name="to-set-up-item-charges"></a><a name="to-set-up-item-charges"></a>Sådan konfigureres varegebyrer
