...
# <a name="the-payroll-data-definitions-dk-extension" />Udvidelsen Definitioner af løndata (DK)
...
## <a name="to-import-a-payroll-file" />Sådan importereres en lønningslistefil
