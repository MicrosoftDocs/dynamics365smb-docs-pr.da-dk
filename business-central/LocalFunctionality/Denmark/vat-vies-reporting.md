...
ms.author: edupont
---
# <a name="vat-vies-reporting-in-the-danish-version" />Momslisterapportering i den danske version
...
## <a name="set-up-vat-registration-numbers" />Konfigurere Momsregistreringsnumre
...
## <a name="reporting-eu-sales" />Rapportering af salg til EU
