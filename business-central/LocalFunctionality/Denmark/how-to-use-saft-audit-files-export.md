...
# <a name="export-the-saf-t-audit-file-format-in-denmark" />Eksportere SAF-T-overvågnings filformatet i Danmark
...
## <a name="exporting-audit-files" />Eksportere revisionsfiler
