...
ms.author: bholtorf
---
# <a name="create-electronic-documents-by-using-oioubl"></a><a name="create-electronic-documents-by-using-oioubl"></a><a name="create-electronic-documents-by-using-oioubl"></a>Oprette elektroniske dokumenter ved hjælp af OIOUBL
...
## <a name="to-post-a-sales-invoice"></a><a name="to-post-a-sales-invoice"></a><a name="to-post-a-sales-invoice"></a>Sådan bogføres en salgsfaktura
...
## <a name="to-create-an-electronic-sales-invoice"></a><a name="to-create-an-electronic-sales-invoice"></a><a name="to-create-an-electronic-sales-invoice"></a>Sådan oprettes en elektronisk salgsfaktura
