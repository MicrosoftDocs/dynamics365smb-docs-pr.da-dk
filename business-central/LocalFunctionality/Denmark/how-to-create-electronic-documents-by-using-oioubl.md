...
ms.author: bholtorf
---
# <a name="create-electronic-documents-by-using-oioubl" />Oprette elektroniske dokumenter ved hjælp af OIOUBL
...
## <a name="to-post-a-sales-invoice" />Sådan bogføres en salgsfaktura
...
## <a name="to-create-an-electronic-sales-invoice" />Sådan oprettes en elektronisk salgsfaktura
