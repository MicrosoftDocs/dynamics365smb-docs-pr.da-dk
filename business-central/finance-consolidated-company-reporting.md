...
# <a name="consolidating-financial-data-from-multiple-companies" />Konsolidering af finansielle oplysninger fra flere regnskaber
...
## <a name="use-the-consolidated-trial-balance-report" />Bruge rapporten Konsolideret råbalance
...
## <a name="consolidate-data" />Konsolidere data
...
### <a name="to-test-the-data-before-you-consolidate" />Sådan kontrolleres dataene, før du konsoliderer
...
### <a name="run-the-consolidation" />Kør konsolideringen
...
## <a name="eliminate-repeated-transactions" />Fjerne gentagne transaktioner
...
## <a name="export-and-import-consolidated-data-between-databases" />Eksportere og importere konsoliderede data mellem databaser
