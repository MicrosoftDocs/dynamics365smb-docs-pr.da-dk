...
# <a name="consolidating-financial-data-from-multiple-companies"></a><a name="consolidating-financial-data-from-multiple-companies"></a>Konsolidering af finansielle oplysninger fra flere regnskaber
...
## <a name="use-the-consolidated-trial-balance-report"></a><a name="use-the-consolidated-trial-balance-report"></a>Bruge rapporten Konsolideret råbalance
...
## <a name="consolidate-data"></a><a name="consolidate-data"></a>Konsolidere data
...
### <a name="to-test-the-data-before-you-consolidate"></a><a name="to-test-the-data-before-you-consolidate"></a>Sådan kontrolleres dataene, før du konsoliderer
...
### <a name="run-the-consolidation"></a><a name="run-the-consolidation"></a>Kør konsolideringen
...
## <a name="eliminate-repeated-transactions"></a><a name="eliminate-repeated-transactions"></a>Fjerne gentagne transaktioner
...
## <a name="export-and-import-consolidated-data-between-databases"></a><a name="export-and-import-consolidated-data-between-databases"></a>Eksportere og importere konsoliderede data mellem databaser
