...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Designoplysninger: Bogføring af montageordre
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Bogføringssekvens
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Omkostningsregulering
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Udførelse af regulering
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Bogføringsdatoer
