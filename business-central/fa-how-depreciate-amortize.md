...
---
# <a name="depreciate-or-amortize-fixed-assets"></a>Afskrive eller amortisere anlægsaktiver
...
## <a name="to-calculate-allocations-for-a-fixed-asset"></a>Sådan beregnes allokeringer til et anlægsaktiv
