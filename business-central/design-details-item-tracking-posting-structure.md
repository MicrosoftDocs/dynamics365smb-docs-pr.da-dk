...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure"></a><a name="design-details-item-tracking-posting-structure"></a>Designdetaljer: Bogføringsstruktur for varesporing
...
## <a name="one-to-many-relation"></a><a name="one-to-many-relation"></a>En til mange-relation
...
## <a name="codeunits-80-and-90"></a><a name="codeunits-80-and-90"></a>Kodeenheder 80 og 90
...
## <a name="posting-the-item-journal"></a><a name="posting-the-item-journal"></a>Bogføring af varekladden
...
## <a name="code-unit-22"></a><a name="code-unit-22"></a>Kodeenhed 22
