...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Oprette et udlånsprogram
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>Sådan defineres udlånsvarer
