...
ms.author: jswymer
---
# <a name="opening-and-sharing-business-central-files-in-microsoft-onedrive" />Åbning og deling af Business Central-filer i Microsoft OneDrive
...
## <a name="open-in-onedrive" />Åbne i OneDrive
...
## <a name="first-time-sign-in-from-business-central" />Log på første gang fra Business central
...
## <a name="managing-multiple-copies-of-a-file" />Administrere flere kopier af en fil
...
## <a name="about-your-business-central-folder-on-onedrive" />Om din Business Central-mappe på OneDrive
