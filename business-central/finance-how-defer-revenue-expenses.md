...
ms.author: edupont
---
# <a name="defer-revenues-and-expenses" />Periodisere indtægter og udgifter
...
## <a name="to-set-up-a-gl-account-for-deferral" />Sådan konfigureres en finanskonti til periodisering
...
## <a name="to-set-up-a-deferral-template" />Sådan konfigureres en periodiseringsskabelon
...
## <a name="to-assign-a-deferral-template-to-an-item" />Sådan tildeles en periodiseringsskabelon til en vare
...
## <a name="to-change-a-deferral-schedule-from-a-sales-invoice" />Sådan ændres en periodiseringsplan fra en salgsfaktura
...
## <a name="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger" />Sådan får du vist, hvordan udskudte indtægter eller udgifter vil blive bogført i finansregnskabet
...
## <a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report" />Sådan vises bogførte periodiseringer i rapporten Oversigt over salgsperiodisering
...
## <a name="to-specify-a-period-in-which-to-allow-deferral-posting" />Sådan angives en periode, hvor der kan tillades periodiseringsbogføring
...
## <a name="see-related-microsoft-training" />Se relateret [Microsoft-træning](/training/modules/processing-invoices-dynamics-365-business-central/)
