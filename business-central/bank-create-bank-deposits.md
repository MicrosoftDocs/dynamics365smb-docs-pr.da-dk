...
ms.author: bholtorf
---
# <a name="create-bank-deposits"></a><a name="create-bank-deposits"></a>Opret bankindskud
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits"></a><a name="number-series-and-lump-sum-deposits"></a>Nummerserie og indskud på engangsbeløb
...
### <a name="general-journal-templates-for-bank-deposits"></a><a name="general-journal-templates-for-bank-deposits"></a>Finanskladdeskabeloner til bankindskud
...
## <a name="dimensions-on-bank-deposit-lines"></a><a name="dimensions-on-bank-deposit-lines"></a>Dimensioner på Bankindbetalingslinjer
...
## <a name="create-a-bank-deposit"></a><a name="create-a-bank-deposit"></a>Opret et bankindskud
...
## <a name="finding-posted-bank-deposits"></a><a name="finding-posted-bank-deposits"></a>Finde bogførte bankindskud
...
## <a name="reversing-a-posted-bank-deposit"></a><a name="reversing-a-posted-bank-deposit"></a>Tilbageføre en bogført bankindbetaling
