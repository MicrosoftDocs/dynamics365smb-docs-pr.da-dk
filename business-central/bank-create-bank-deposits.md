...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Opret bankindskud
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Nummerserie og indskud på engangsbeløb
...
### <a name="general-journal-templates-for-bank-deposits" />Finanskladdeskabeloner til bankindskud
...
## <a name="dimensions-on-bank-deposit-lines" />Dimensioner på Bankindbetalingslinjer
...
## <a name="create-a-bank-deposit" />Opret et bankindskud
...
## <a name="finding-posted-bank-deposits" />Finde bogførte bankindskud
...
## <a name="reversing-a-posted-bank-deposit" />Tilbageføre en bogført bankindbetaling
