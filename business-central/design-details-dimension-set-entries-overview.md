...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Oversigt over dimensionsgruppeposter
Dette emne beskriver, hvordan dimensionsgruppeposter gemmes og bogføres i [!INCLUDE[prod_short](includes/prod_short.md)].  

## <a name="dimension-sets"></a><a name="dimension-sets"></a>Dimensionsopsætninger
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Dimensionsgruppeposter
...
## <a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a>Codeunit 408 Dimensionsstyring
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a>Forbedring af ydeevne
