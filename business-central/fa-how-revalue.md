...
ms.author: edupont
---
# <a name="revalue-fixed-assets" />Omvurdere anlægsaktiver
...
## <a name="to-post-an-appreciation-from-the-fixed-asset-gl-journal" />Sådan bogføres en opskrivning fra anlægskassekladden
...
## <a name="to-post-a-write-down-from-the-fixed-asset-gl-journal" />Sådan bogføres en nedskrivning fra anlægskassekladden
...
## <a name="to-perform-general-revaluation-of-fixed-assets" />Sådan udføres generel værdiregulering af anlægsaktiver
...
## <a name="to-post-additional-acquisition-costs" />Sådan bogføres ekstra anskaffelser
...
### <a name="example---posting-additional-acquisition-costs" />Eksempe - bogføring af ekstra anskaffelser
...
## <a name="see-related-microsoft-trainingtrainingpathsmanage-advanced-fixed-assets-transactions" />Se relateret [Microsoft-træning](/training/paths/manage-advanced-fixed-assets-transactions/)
