...
# <a name="set-up-resource-allocation"></a><a name="set-up-resource-allocation"></a>Opsætte ressourceallokering
...
## <a name="to-set-up-skills"></a><a name="to-set-up-skills"></a>Sådan oprettes kvalifikationer
...
## <a name="to-assign-skills-to-service-items-and-resources"></a><a name="to-assign-skills-to-service-items-and-resources"></a>Sådan tildeles kvalifikationer til serviceartikler og ressourcer
...
## <a name="to-set-up-zones"></a><a name="to-set-up-zones"></a>Sådan defineres zoner
...
## <a name="to-assign-zones-to-customers-and-resources"></a><a name="to-assign-zones-to-customers-and-resources"></a>Sådan tildeles zoner til kunder og ressourcer
...
## <a name="to-specify-what-to-show-when-a-resource-is-chosen"></a><a name="to-specify-what-to-show-when-a-resource-is-chosen"></a>Sådan angiver du, hvad der skal vises, når en ressource vælges
...
## <a name="to-update-resource-capacity"></a><a name="to-update-resource-capacity"></a>Sådan opdateres ressourcekapacitet
...
## <a name="to-update-skills-for-items-service-items-or-service-item-groups"></a><a name="to-update-skills-for-items-service-items-or-service-item-groups"></a>Sådan opdateres kvalifikationer for artikler, serviceartikler eller serviceartikelgrupper
