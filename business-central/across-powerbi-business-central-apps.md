...
## <a name="fixing-problems" />Løsning af problemer
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display" />Meddelelse: Der er ingen aktiverede rapporter. Vælg Vælg rapport for at få vist en oversigt over de rapporter, du kan få vist.
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid" />"Parametervalideringen mislykkedes, kontrollér, at alle parametre er gyldige"
...
### <a name="cant-sign-in" />Kan ikke logge på
...
### <a name="message-your-data-source-cant-be-refreshed-because-the-credentials-are-invalid-please-update-your-credentials-and-try-again" />Meddelelse: Datakilden kan ikke opdateres, fordi legitimationsoplysningerne er ugyldige. Opdater dine legitimationsoplysninger, og prøv igen
...
### <a name="incorrect-company-name" />Forkert virksomhedsnavn
...
### <a name="the-key-didnt-match-any-rows-in-the-table" />Nøglen svarer ikke til nogen rækker i tabellen
...
### <a name="historical-data-appears-to-be-missing" />Der mangler tilsyneladende historiske data
...
### <a name="i-only-see-data-for-a-single-company" />Jeg kan kun se data for en enkelt virksomhed
