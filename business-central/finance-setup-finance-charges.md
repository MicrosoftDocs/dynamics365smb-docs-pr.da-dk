...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms"></a><a name="set-up-finance-charge-terms"></a>Konfiguration af Rentebetingelser
...
## <a name="finance-charge-terms"></a><a name="finance-charge-terms"></a>Rentebetingelser
...
### <a name="to-set-up-finance-charge-terms"></a><a name="to-set-up-finance-charge-terms"></a>Sådan konfigurerer du rentebetingelser
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/send-memos-dynamics-365-business-central/)
