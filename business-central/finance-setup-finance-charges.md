...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms" />Konfiguration af Rentebetingelser
...
## <a name="finance-charge-terms" />Rentebetingelser
...
### <a name="to-set-up-finance-charge-terms" />Sådan konfigurerer du rentebetingelser
...
## <a name="see-related-microsoft-training" />Se relateret [Microsoft-træning](/training/modules/send-memos-dynamics-365-business-central/)
