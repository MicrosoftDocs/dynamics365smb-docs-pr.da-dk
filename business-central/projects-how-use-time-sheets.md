...
ms.author: edupont
---
# <a name="use-time-sheets" />Bruge timesedler
...
## <a name="to-create-time-sheets" />Sådan opretter du timesedler
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets" />Sådan genbruges timeseddellinjer i andre timesedler
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet" />Sådan kopieres sagsplanlægningslinjer til en timeseddel
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet" />Sådan definerer du arbejdstyper og tilføjer en til en timeseddel
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval" />Sådan udfyldes en timeseddels linjer og sendes til godkendelse
...
## <a name="to-approve-or-reject-a-time-sheet" />Sådan godkendes eller afvises en timeseddel
...
## <a name="to-reopen-a-time-sheet" />Sådan genåbnes en timeseddel
...
## <a name="to-view-and-approve-time-sheets-by-job" />Sådan kan du se og godkende en timeseddel efter sag
...
### <a name="to-approve-or-reject-a-time-sheet-by-job" />Sådan godkendes eller afvises en timeseddel efter sag
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal" />Sådan bogfører du timeseddellinjer i en ressourcekladde
...
## <a name="to-post-time-sheet-lines-in-a-job-journal" />Sådan bogfører du timeseddellinjer i en sagskladde
...
## <a name="to-archive-time-sheets" />Sådan arkiveres timesedler
