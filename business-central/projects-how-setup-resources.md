...
ms.author: edupont
---
# <a name="set-up-resources-for-projects"></a><a name="set-up-resources-for-projects"></a>Konfigurere ressourcer for projekter
...
## <a name="to-set-up-a-resource"></a><a name="to-set-up-a-resource"></a>Sådan defineres en ressource
...
## <a name="to-set-up-a-resource-group"></a><a name="to-set-up-a-resource-group"></a>Sådan oprettes en ressourcegruppe
...
## <a name="to-set-capacity-for-a-resource"></a><a name="to-set-capacity-for-a-resource"></a>Sådan angives kapaciteten for en ressource
...
## <a name="to-set-up-alternate-resource-costs"></a><a name="to-set-up-alternate-resource-costs"></a>Sådan angives ressourcekostpriser
...
## <a name="to-set-up-alternate-resource-prices"></a><a name="to-set-up-alternate-resource-prices"></a>Sådan angives ressourcepriser
