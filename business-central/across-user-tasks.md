...
ms.author: edupont
---
# <a name="define-user-tasks" />Definere brugeropgaver
...
## <a name="managing-user-tasks" />Administrere brugeropgaver
...
### <a name="picking-up-user-tasks" />Hente brugeropgaver
...
### <a name="deleting-user-tasks" />Slette brugeropgaver
