...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a><a name="available-fonts"></a>Tilgængelige skrifttyper
...
## <a name="document-fonts"></a><a name="document-fonts"></a><a name="document-fonts"></a>Dokumentskrifttyper
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Skrifttyper til checks
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Skrifttyper til stregkoder
