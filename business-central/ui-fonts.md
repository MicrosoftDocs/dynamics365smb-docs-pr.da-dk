...
ms.author: edupont
---
# <a name="available-fonts" />Tilgængelige skrifttyper
...
## <a name="document-fonts" />Dokumentskrifttyper
...
## <a name="fonts-for-checks" />Skrifttyper til checks
...
## <a name="fonts-for-barcodes" />Skrifttyper til stregkoder
