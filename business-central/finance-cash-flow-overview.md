...
# <a name="cash-flow-overview" />Oversigt over likviditet
...
## <a name="definition-of-cash-flow" />Definition af likviditet
...
## <a name="work-with-cash-flow" />Arbejde med pengestrøm
...
## <a name="making-a-cash-flow-forecast" />Foretage likviditetsforecast
