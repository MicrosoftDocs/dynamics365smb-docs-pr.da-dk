...
ms.author: edupont
---
# <a name="setup-best-practices-reordering-policies" />Oprette bedste fremgangsmåder: Genbestillingspolitikker
...
## <a name="see-related-microsoft-trainingtrainingpathsreplenish-items-dynamics-365-business-central" />Se relateret [Microsoft-træning](/training/paths/replenish-items-dynamics-365-business-central/)
