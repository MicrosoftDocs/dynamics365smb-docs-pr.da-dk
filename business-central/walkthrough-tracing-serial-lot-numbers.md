...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Gennemgang: Sporing af serie-/lotnumre
...
### <a name="to-create-the-items" />Sådan oprettes varerne
...
### <a name="to-purchase-components" />Købe komponenter
...
### <a name="to-produce-end-items" />Fremstille færdigvarer
...
### <a name="to-sell-the-end-items" />Sælge færdigvarer
...
## <a name="tracing-from-usage-to-origin" />Sporing fra brug til oprindelse
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />Sådan finder du ud af, hvilket lot det fejlbehæftede stel kommer fra, og hvem der leverede det
...
## <a name="tracing-from-origin-to-usage" />Sporing fra oprindelse til brug
...
### <a name="to-find-all-usage-of-the-faulty-lot" />Sådan findes alle anvendelser af det fejlbehæftede lot
...
## <a name="finding-all-records-of-a-seriallot-number" />Find alle poster for et serie-/lotnummer
