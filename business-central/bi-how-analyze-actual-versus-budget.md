...
ms.author: edupont
---
# <a name="analyze-actual-amounts-versus-budgeted-amounts" />Analysere faktiske beløb sammenlignet med budgetterede beløb
...
## <a name="view-a-gl-budget" />Vise et finansbudget
...
## <a name="view-actual-and-budgeted-amounts-for-all-accounts" />Vise aktuelle og budgetterede beløb for alle konti
...
## <a name="to-view-actual-and-budgeted-amounts-for-several-periods" />Sådan får du vist aktuelle og budgetterede beløb for flere perioder
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesbudgets-exchange-rates-dynamics--business-centralindex" />Se relateret træning på [Microsoft Learn](/learn/modules/budgets-exchange-rates-dynamics-365-business-central/index).
