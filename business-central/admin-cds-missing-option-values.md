...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Håndtering af manglende indstillingsværdier
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>Udvide grupperede indstillinger i [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a><a name="update--option-mapping"></a>Opdater [!INCLUDE[prod_short](includes/cds_long_md.md)]-indstillingstilknytning
