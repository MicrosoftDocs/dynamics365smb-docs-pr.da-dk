...
---
# <a name="record-consumption-or-usage-for-projects"></a>Registrere forbrug eller forbrug til sager
...
## <a name="to-record-usage-for-a-project-planning-line-of-type-budget"></a>Sådan registreres forbrug for en sagsplanlægningslinje af typen Budget
...
## <a name="to-create-project-journal-lines-manually"></a>Sådan oprettes sagskladdelinjer manuelt
...
## <a name="to-view-project-usage-estimates-and-post-updates"></a>Sådan vises sagsforbrugsestimater og bogføringsopdateringer
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-project"></a>Opret lagerbeholdnings- lagersteds-plukdokumenter for et job
...
## <a name="to-review-planning-lines-for-a-project-ledger-entry"></a>Sådan gennemgås planlægningslinjerne for en sagspost
