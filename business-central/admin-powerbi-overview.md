...
ms.author: jswymer
---
# <a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-"></a>Oversigt over Power BI-integrationskomponent og -arkitektur for [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a>Hvad er tilgængeligt fra begyndelsen
...
## <a name="general-flow"></a><a name="general-flow"></a>Generelt flow
