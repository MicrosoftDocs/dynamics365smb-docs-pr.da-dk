...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Konfigurere dataudvekslingsdefinitioner
...
## <a name="create-a-data-exchange-definition" />Oprette en dataudvekslingsdefinition
...
## <a name="transformation-rules" />Transformationsregler
...
### <a name="tip-for-developers-example-of-the-custom-option" />Tip til udviklere: eksempel på brugerdefineret indstilling
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />Eksportere en dataudvekslingsdefinition som en XML-fil, som andre kan bruge
...
## <a name="import-an-existing-data-exchange-definition" />Importere en eksisterende dataudvekslingsdefinition
