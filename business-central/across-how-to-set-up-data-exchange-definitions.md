...
### <a name="to-map-columns-in-the-data-file-to-fields-in-prod_short"></a><a name=mapfields></a>Sådan tilknyttes kolonner i datafilen til felter i [!INCLUDE[prod_short](includes/prod_short.md)]
