...
ms.author: edupont
---
# <a name="transfer-bank-funds" />Overføre bankbeløb
...
## <a name="to-post-a-transfer-between-bank-accounts-with-the-same-currency-code" />Sådan bogføres overførsler mellem bankkonti med samme valutakode
...
## <a name="to-post-a-transfer-between-bank-accounts-with-different-currency-codes" />Sådan bogføres overførsler mellem bankkonti med forskellige valutakoder
