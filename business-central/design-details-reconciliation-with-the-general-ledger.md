...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Designoplysninger: Afstemning med Finans
...
## <a name="post-inventory-cost-to-gl-batch-job" />Kørslen Bogfør lagerregulering
...
## <a name="automatic-cost-posting" />Aut. lagerværdibogføring
