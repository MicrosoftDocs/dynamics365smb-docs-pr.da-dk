...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Gennemgang: Salg, montering og levering af pakker
...
### <a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a>Konfigurere montageelementer
...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Sælge tilpassede montageelementer
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Planlægge for montageelementer
...
### <a name="assembling-items"></a><a name="assembling-items"></a>Montageelementer
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Levere montageelementer fra lager og monteret til ordre
...
## <a name="prepare-sample-data"></a><a name="prepare-sample-data"></a>Klargøre eksempeldata
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>Oprette montageelementer
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>Sælge montageelementerne
...
### <a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a>Planlægge for utilgængelige ATS-elementer
...
### <a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a>Montere og levere den første ATO-mængde
...
### <a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a>Montere og registrere den anden ATO-mængde
...
### <a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a>Montere ATS-antallet
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a><a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a>Levere de resterende elementer delvist fra lager og delvist monteret til ordren
