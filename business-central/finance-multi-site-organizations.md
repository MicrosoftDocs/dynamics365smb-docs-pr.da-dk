...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central til internationale organisationer med flere lokationer
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Integration af hovedkvarter og flere lokationer
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Opfylde behovene på indenlandske og internationale lokationer
...
## <a name="consolidate-financial-data" />Konsolidere finansielle data
...
## <a name="share-business-insight-with-integrated-analytics" />Dele forretningsindsigt med integreret analyse
...
## <a name="exchange-data-using-apis-and-xmlports" />Udveksle data ved hjælp af API'er og XML-porte
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Forfremme en effektiv intern forsyningskæde
...
## <a name="respond-quickly-to-new-business-conditions" />Reagere hurtigt på nye forretningsbetingelser
