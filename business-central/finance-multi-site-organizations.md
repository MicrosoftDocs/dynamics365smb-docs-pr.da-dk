...
# <a name="business-central-for-multi-site-and-international-organizations"></a><a name="business-central-for-multi-site-and-international-organizations"></a><a name="business-central-for-multi-site-and-international-organizations"></a>Business Central til internationale organisationer med flere lokationer
...
## <a name="integrating-the-headquarter-company-and-the-sites"></a><a name="integrating-the-headquarter-company-and-the-sites"></a><a name="integrating-the-headquarter-company-and-the-sites"></a>Integration af hovedkvarter og flere lokationer
...
## <a name="meet-the-needs-of-domestic-and-international-sites"></a><a name="meet-the-needs-of-domestic-and-international-sites"></a><a name="meet-the-needs-of-domestic-and-international-sites"></a>Opfylde behovene på indenlandske og internationale lokationer
...
## <a name="consolidate-financial-data"></a><a name="consolidate-financial-data"></a><a name="consolidate-financial-data"></a>Konsolidere finansielle data
...
## <a name="share-business-insight-with-integrated-analytics"></a><a name="share-business-insight-with-integrated-analytics"></a><a name="share-business-insight-with-integrated-analytics"></a>Dele forretningsindsigt med integreret analyse
...
| **Forretningsbehov** | **Sådan understøttes Business Central** | **Flere oplysninger** |
|-------------------------|-------------------------|-------------------------|
| Dele indsigt med websteder uden omfattende IT-support. | Opret KPI'er og Business Intelligence-dashboards i Power BI baseret på dine data. | [Arbejde med Business Central-data i Power BI](across-working-with-business-central-in-powerbi.md) |
...
## <a name="exchange-data-using-apis-and-xmlports"></a><a name="exchange-data-using-apis-and-xmlports"></a><a name="exchange-data-using-apis-and-xmlports"></a>Udveksle data ved hjælp af API'er og XML-porte
...
## <a name="promote-an-efficient-intercompany-supply-chain"></a><a name="promote-an-efficient-intercompany-supply-chain"></a><a name="promote-an-efficient-intercompany-supply-chain"></a>Forfremme en effektiv intern forsyningskæde
...
## <a name="respond-quickly-to-new-business-conditions"></a><a name="respond-quickly-to-new-business-conditions"></a><a name="respond-quickly-to-new-business-conditions"></a>Reagere hurtigt på nye forretningsbetingelser
