...
---
# <a name="receive-items-with-warehouse-receipts" />Modtage varer med en lagermodtagelse
...
## <a name="receive-items-with-a-warehouse-receipt" />Modtage varer med en lagermodtagelse
