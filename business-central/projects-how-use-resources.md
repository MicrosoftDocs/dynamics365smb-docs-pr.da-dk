...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Bruge ressourcer til sager
...
## <a name="to-assign-resources-to-jobs" />Sådan tildeles ressourcer til sager
...
## <a name="to-record-resource-usage-for-a-job" />Sådan registreres ressourceforbrug for en sag
...
## <a name="to-adjust-resource-prices" />Sådan reguleres ressourcepriser
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Sådan hentes forslag til ændring af ressourcepriser ud fra eksisterende alternative priser
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Sådan henter du forslag til ændring af ressourcepriser ud fra standardpriser
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Sådan henter du forslag til ændring af ressourcepriser ud fra standardpriser
