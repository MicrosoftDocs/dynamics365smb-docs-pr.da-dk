...
## <a name="add-new-customers"></a>Tilføj nye debitorer
...
## <a name="delete-customer-cards"></a>Slette debitorkort
...
## <a name="manage-credit-limits"></a>Administrere kreditgrænser
...
## <a name="assign-a-salesperson"></a>Tilknytte en sælger
