...
ms.author: edupont
---
# <a name="register-new-customers"></a><a name="register-new-customers"></a><a name="register-new-customers"></a>Registrere nye debitorer
...
## <a name="adding-new-customers"></a><a name="adding-new-customers"></a><a name="adding-new-customers"></a>Tilføje nye debitorer
...
### <a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a>Sådan oprettes et nyt debitorkort
...
### <a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a>Sådan gemmes debitorkortet som en skabelon
...
## <a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a>Slette debitorkort
...
## <a name="managing-credit-limits"></a><a name="managing-credit-limits"></a><a name="managing-credit-limits"></a>Administrere kreditgrænser
...
### <a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a>Sådan angiver du advarsler om kreditmaksimum
