...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a><a name="set-up-locations"></a>Opsætte lokationer
...
## <a name="location-cards"></a><a name="location-cards"></a><a name="location-cards"></a>Lokationskort
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>Sådan oprettes en lokation
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>Sådan oprettes en overflytningsrute
...
## <a name="bins"></a><a name="bins"></a><a name="bins"></a>Placering
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Standarddimensioner for lokationer
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Eksempel på standarddimensioner for lokationer
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Se relateret træning på [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
