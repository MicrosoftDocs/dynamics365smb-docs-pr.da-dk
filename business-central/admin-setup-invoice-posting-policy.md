...
# <a name="define-an-invoice-posting-policy-for-users" />Definere en fakturabogføringsmetode for brugere
...
## <a name="to-specify-a-posting-policy" />Sådan angives bogføringspolitik
...
## <a name="effect-on-documents" />Indvirkning på dokumenter
