---
title: Optælle og justere lagerbeholdning
...
---
# <a name="count-and-adjust-inventory-using-documents"></a>Tælle og regulere lageropgørelse ved hjælp af dokumenter
...
4.  **Vælg Andet i gruppen** Funktioner **under fanen Handlinger**, **og** vælg **derefter Beregn linjer**.
...
1. På en side med lageropgørelsesordre, der indeholder linjer for de varer, der skal optælles i én registrering, skal du vælge handlingen **Opret** ny registrering **.** 
1.  **Vælg Andet i gruppen** Funktioner **under fanen Handlinger**, **og** vælg **derefter Foretag ny optagelse**.
1. Vælg påkrævede indstillinger og konfigurering af filtre.
1. Vælg knappen **OK**.
1. For hvert sæt varer, der tælles, skal du indlæse dem på en tilhørende varelageropgørelse og gentage trin 1-3 med afkrydsningsfeltet **Kun linjer, der ikke findes i registreringer** valgt.
1. Vælg Ordre under **fanen Relateret**  **,** og vælg derefter handlingen **Optagelser** for at åbne **siden Lageropgørelsesliste** .
1. Åbn den relevant registrering.
1. Udfyld felterne efter behov i oversigtspanelet **Generelt**.
...
1. Vælg handlingen **Udskriv** for at forberede det fysiske dokument, som medarbejdere kan benytte til at skrive det antal, de tæller.
...
Når du er færdig med en lageropgørelse, **opdateres feltet Antal optager (basis)**  på den relaterede lageropgørelsesordre med de optalte (registrerede) værdier, og **afkrydsningsfeltet På registreringslinjer** markeres. Hvis et optalt antal afviger fra det forventede antal, viser felterne **Pos Antal (basis)**  og **Neg Antal (basis)**  differencen.
...
1. Vælg Andet under **fanen Relateret**  **,** og vælg **derefter Vis dubletlinjer**.
...
3. Vælg Ordre under **fanen Relateret**  **,** og vælg **derefter handlingen Optagelser** for at få vist en liste over relaterede registreringer af lageropgørelse.  

## <a name="handle-item-tracking-when-counting-inventory"></a>Håndtering af varesporing ved optælling af varelager
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item"></a>Eksempel - Klargør en varelageroptælling for en vare-sporet vare
...
### <a name="example---record-and-post-counted-lot-number-differences"></a>Eksempel – Registrer og bogfør differencer i optalte lotnumre
...
Du kan udskrive disse dokumenter når som helst, frigive og genåbne dem og tildele fælles værdier som dimensioner i hovedet. Hvis du vil udskrive dokumenterne igen, efter at de er bogført, skal du bruge siderne **Bogført lagermodtagelse** og **Bogført lagerforsendelse**.
...
2. I oversigtspanelet **Nummerering** skal du angive nummerserier for dokumenter i følgende felter:
   ...
   - **Invt. Købsleverance nr.**  
   - **Bogført invt. Købsleverance nr.**  
   - **Invt. Leverancenumre.**  
   - **Bogført invt. Leverancenumre.**  
...
2. I hovedet på knappen **Invt. Vælg lokationen i** feltet **Lokationskode**, og udfyld derefter de resterende felter efter behov.
3. I oversigtspanelet **Linjer** i feltet **Vare** skal du vælge lagervaren. Angiv det antal varer, du vil tilføje, i feltet **Antal**.
4. Sådan udskrives en **lagermodtagelsesrapport fra** vinduet Invt **d. Kvitteringsside**, skal du vælge handlingen **Udskriv** .

Følgende funktioner er tilgængelige på **Invt. Kvittering** side:
...
[Arbejde med serie- og lotnumre](inventory-how-work-item-tracking.md)    
