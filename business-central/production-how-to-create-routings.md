...
ms.author: edupont
---
# <a name="create-routings" />Oprette ruter
...
## <a name="to-create-a-routing" />Sådan oprettes en rute
...
## <a name="to-create-routing-links" />Sådan oprettes rutebindinger
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations" />Sådan tildeles personale, værktøj og kvalitetsmål for ruteoperationer
...
## <a name="to-create-a-new-versions-of-a-routing" />Sådan oprettes en ny version af ruter
