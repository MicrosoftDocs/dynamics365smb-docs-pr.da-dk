...
# <a name="install-the-include-prodshortincludesprodshortmd-app-for-microsoft-teams" />Installér [!INCLUDE [prod_short](includes/prod_short.md)]-appen til Microsoft Teams
...
## <a name="add-the-business-central-app-to-teams" />Tilføj Business Central-appen til Teams
