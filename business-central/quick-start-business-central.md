...
description: Kom i gang med Business Central med tip fra artiklerne hurtig start, som du kan bruge til at udfylde de første kritiske felter.
...
ms.locfileid: "7724783"
---
# <a name="business-central-quick-starts"></a>Hurtig start af Business Central

Disse artikler om hurtig start hjælper dig så hurtigt som muligt, så du kan udføre de grundlæggende funktioner, du har brug for [!INCLUDE[prod_short](includes/prod_short.md)].
...
Det første trin er at angive grundlæggende oplysninger om virksomheden. Dette omfatter oplysninger som adresse, bankkonto, momsnummer osv. Dette forklares i artiklen om [hurtig start i regnskabet](quick-start-company-information.md).
...
Du kan finde flere oplysninger om salg af produkter og tjenester i artiklerne om [hurtig start for salg](quick-start-sell-products-and-services.md).
