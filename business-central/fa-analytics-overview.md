...
> [!NOTE]
> Analyser for anlægsaktiver er lidt anderledes end i andre områder. Du skal analysere data, der allerede findes, f.eks. anskaffelse af aktiver, udfasninger og forsikring, men også data om fremtidige, f.eks. afskrivninger og udfasning af aktiver. For sidstnævnte type analyse har [!INCLUDE[prod_short](includes/prod_short.md)] indbyggede rapporter, der kan beregne disse tal.
