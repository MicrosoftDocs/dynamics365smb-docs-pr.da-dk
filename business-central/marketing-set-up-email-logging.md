...
---
# <a name="track-email-message-exchanges-between-salespeople-and-contacts"></a><a name="track-email-message-exchanges-between-salespeople-and-contacts"></a>Spore udveksling af mails mellem sælgere og kontakter
...
## <a name="to-set-up-email-logging"></a><a name="to-set-up-email-logging"></a>Sådan konfigureres maillogføring

### <a name="set-up-public-folders-and-rules-for-email-logging-in-exchange-online"></a><a name="set-up-public-folders-and-rules-for-email-logging-in-exchange-online"></a>Konfigurere offentlige mapper og regler for maillogføring i Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Derefter opretter du forbindelse mellem [!INCLUDE[prod_short](includes/prod_short.md)] og Exchange Online.

### <a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online"></a><a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online"></a>Konfigurere en delt postkasse og regler for e-maillogføring i Exchange Online
...
### <a name="add-a-user-account-for-members-of-the-shared-mailbox"></a><a name="add-a-user-account-for-members-of-the-shared-mailbox"></a>Tilføje en brugerkonto for medlemmer af den delte postkasse
...
### <a name="allow-other-users-to-see-logged-emails"></a><a name="allow-other-users-to-see-logged-emails"></a>Tillad andre brugere at se logførte e-mails
...
### <a name="create-mail-flow-rules"></a><a name="create-mail-flow-rules"></a>Oprette regler for mail flow
...
## <a name="set-up--to-log-email-messages"></a><a name="set-up--to-log-email-messages"></a>Konfigurere [!INCLUDE[prod_short](includes/prod_short.md)] til logføring af mails
...
## <a name="view-email-message-exchanges-in-the-interaction-log"></a><a name="view-email-message-exchanges-in-the-interaction-log"></a>Vise udveksling af mails i interaktionslogposten
...
## <a name="mailbox-and-folder-limits-in-exchange-online"></a><a name="mailbox-and-folder-limits-in-exchange-online"></a>Postkasse og mappegrænser i Exchange Online
...
## <a name="connect-on-premises-versions-to-microsoft-exchange"></a><a name="connect-on-premises-versions-to-microsoft-exchange"></a>Tilslut lokale versioner til Microsoft Exchange
...
-->
## <a name="connect-to-exchange-online"></a><a name="connect-to-exchange-online"></a>Opret forbindelse til Exchange Online
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-exchange-online"></a><a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-exchange-online"></a>Sådan registrerer du et program i Azure AD for at oprette forbindelse fra Business Central til Exchange Online
...
### <a name="use-another-identity-and-access-management-service"></a><a name="use-another-identity-and-access-management-service"></a>Bruge en anden tjeneste til identitets- og adgangsstyring
...
## <a name="to-start-logging-email"></a><a name="to-start-logging-email"></a>Sådan startes logføring af e-mails
...
## <a name="to-stop-logging-email"></a><a name="to-stop-logging-email"></a>Sådan stoppes logføring af e-mails
...
## <a name="to-change-the-user-account-used-for-email-logging"></a><a name="to-change-the-user-account-used-for-email-logging"></a>Sådan ændres den brugerkonto, der bruges til e-mail-logføring
