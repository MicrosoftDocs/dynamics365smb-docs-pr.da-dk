...
---
# <a name="track-email-message-exchanges-between-salespeople-and-contacts" />Spore udveksling af mails mellem sælgere og kontakter
...
## <a name="to-set-up-email-logging" />Sådan konfigureres maillogføring

### <a name="set-up-public-folders-and-rules-for-email-logging-in-exchange-online" />Konfigurere offentlige mapper og regler for maillogføring i Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Derefter opretter du forbindelse mellem [!INCLUDE[prod_short](includes/prod_short.md)] og Exchange Online.

### <a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online" />Konfigurere en delt postkasse og regler for e-maillogføring i Exchange Online
...
### <a name="add-a-user-account-for-members-of-the-shared-mailbox" />Tilføje en brugerkonto for medlemmer af den delte postkasse
...
### <a name="allow-other-users-to-see-logged-emails" />Tillad andre brugere at se logførte e-mails
...
## <a name="view-email-message-exchanges-in-the-interaction-log" />Vise udveksling af mails i interaktionslogposten
...
## <a name="mailbox-and-folder-limits-in-exchange-online" />Postkasse og mappegrænser i Exchange Online
...
## <a name="connect-on-premises-versions-to-microsoft-exchange" />Tilslut lokale versioner til Microsoft Exchange
...
-->
## <a name="connect-to-exchange-online" />Opret forbindelse til Exchange Online
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-exchange-online" />Sådan registrerer du et program i Azure AD for at oprette forbindelse fra Business Central til Exchange Online
...
### <a name="use-another-identity-and-access-management-service" />Bruge en anden tjeneste til identitets- og adgangsstyring
...
## <a name="to-start-logging-email" />Sådan startes logføring af e-mails
...
## <a name="to-stop-logging-email" />Sådan stoppes logføring af e-mails
