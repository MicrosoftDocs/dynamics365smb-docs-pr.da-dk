...
ms.author: edupont
---
# <a name="manage-job-supplies" />Administrere sagsforsyninger
...
## <a name="to-purchase-items-or-services-for-a-job" />Sådan køber du varer eller tjenesteydelser for en sag
...
## <a name="to-view-the-value-of-purchases-for-a-job" />Sådan får du vist værdien for køb for en sag
...
## <a name="to-post-a-job-related-expense" />Sådan bogføres en sagsrelateret udgift
