...
ms.author: edupont
---
# <a name="manage-job-supplies"></a><a name="manage-job-supplies"></a><a name="manage-job-supplies"></a>Administrere sagsforsyninger
...
## <a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a>Sådan køber du varer eller tjenesteydelser for en sag
...
## <a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a>Sådan får du vist værdien for køb for en sag
...
## <a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a>Sådan bogføres en sagsrelateret udgift
