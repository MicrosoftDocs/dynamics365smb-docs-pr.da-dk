...
# <a name="troubleshooting-accessing-camera-and-location" />Fejlfinding: Adgang til kamera og placering
...
## <a name="device-must-have-camera-and-location-capabilities" />Enhed skal have kamera- og placeringsfunktioner
...
## <a name="access-permissions-not-enabled" />Adgangstilladelser er ikke aktiveret
...
## <a name="web-client-connection-not-secure" />Webklientens forbindelse er ikke sikker
...
## <a name="work-with-virtualization-technologies" />Arbejde med virtualiseringsteknologier
