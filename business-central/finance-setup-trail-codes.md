...
ms.author: edupont
---
# <a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a>Oprette kilde- og årsagskoder til revisionsspor
...
## <a name="define-source-codes"></a><a name="define-source-codes"></a><a name="define-source-codes"></a>Definere kildekoder
...
### <a name="to-define-source-codes"></a><a name="to-define-source-codes"></a><a name="to-define-source-codes"></a>Sådan defineres kildekoder
...
## <a name="change-source-codes"></a><a name="change-source-codes"></a><a name="change-source-codes"></a>Ændre kildekoder

Det kan være en fordel at ændre en kildekode. Lad os sige, at du vil ændre kildekoden *KASSEKLD* til *GNJ*.

### <a name="to-change-source-codes"></a><a name="to-change-source-codes"></a><a name="to-change-source-codes"></a>Sådan ændres kildekoder
...
## <a name="define-reason-codes"></a><a name="define-reason-codes"></a><a name="define-reason-codes"></a>Definere årsagskoder
...
### <a name="to-set-up-reason-codes"></a><a name="to-set-up-reason-codes"></a><a name="to-set-up-reason-codes"></a>Sådan oprettes årsagskoder
...
### <a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a>Sådan knytter du årsagskoder til kladdetyper
...
### <a name="to-use-reason-codes-on-sales-and-purchase-documents"></a><a name="to-use-reason-codes-on-sales-and-purchase-documents"></a><a name="to-use-reason-codes-on-sales-and-purchase-documents"></a>Sådan bruges årsagskoder i salgs- og købsdokumenter
