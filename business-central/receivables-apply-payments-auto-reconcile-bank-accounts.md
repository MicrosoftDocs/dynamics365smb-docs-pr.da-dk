...
---
# <a name="applying-payments-automatically-and-reconciling-bank-accounts"></a>Udligning af betalinger automatisk og afstemning af bankkonti
...
På siden **Regler for betalingsudligning** kan du opsætte prioriterede regler, der styrer, hvordan betalingstekst automatisk matches med indtastningsoplysninger.
...
| Til | Se |
| --- | --- |
| Udlign betalinger for at åbne debitor- eller kreditorposter ved at importere et bankkontoudtog og derefter afstemme bankkontoen, når du udligner alle betalinger. |[Afstemme betalinger ved hjælp af automatisk udligning](receivables-how-reconcile-payments-auto-application.md) |
