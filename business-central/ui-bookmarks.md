...
---
# <a name="bookmark-a-page-or-report-on-your-role-center"></a>Oprette et bogmærke til en side eller rapport i rollecenteret
...
## <a name="bookmark-the-target-page"></a>Bogmærke målsiden
...
## <a name="bookmark-the-target-report"></a>Bogmærke målrapporten
...
## <a name="bookmark-a-page-or-report-from-the-tell-me-window"></a>Oprette et bogmærke til en side eller rapport fra vinduet Fortæl mig det
...
### <a name="can-i-reorganize-my-bookmarks"></a>Kan jeg omorganisere mine bogmærker?
...
### <a name="how-do-i-remove-a-bookmark"></a>Hvordan fjerner jeg et bogmærke?
...
### <a name="where-do-i-find-my-bookmarks"></a>Hvor finder jeg mine bogmærker?
...
### <a name="i-dont-have-a-bookmark-icon-is-something-wrong"></a>Hvorfor har jeg ikke et bogmærke-ikon? Gik noget galt?
...
### <a name="why-cant-i-bookmark-certain-pages-or-reports"></a>Hvorfor kan jeg ikke bogmærke bestemte sider eller rapporter?
...
### <a name="when-clearing-my-personalization-will-my-bookmarks-also-be-cleared"></a>Når jeg rydder min tilpasning, bliver mine bogmærker så også ryddet?
...
### <a name="why-does-the-bookmark-icon-continue-to-indicate-its-still-not-bookmarked"></a>Hvorfor bliver bogmærkeikonet ved med at angive, at det stadig ikke er bogmærket?
...
### <a name="why-does-my-link-to-a-report-display-a-different-report"></a>Hvorfor viser min sammenkæde til en rapport en anden rapport?
...
### <a name="is-bookmarking-available-for-xmlports"></a>Er bogmærker tilgængelige for XML-porte?

Nummer På dette tidspunkt er det ikke muligt at føje handlinger til åbne XMLporte fra brugergrænsefladen.

### <a name="will-my-bookmarks-be-translated-when-i-change-my-language-in-business-central"></a>Vil mine bogmærker blive oversat, når jeg ændrer mit sprog i Business Central?
...
### <a name="why-cant-i-add-text-in-a-page-right-after-opening-it-with-the-bookmark"></a>Hvorfor kan jeg ikke tilføje tekst på en side direkte efter at have åbnet den med bogmærket?
