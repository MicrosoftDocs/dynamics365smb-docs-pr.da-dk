...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports" />Gennemgang: Udarbejd likviditetsforecast ved hjælp af finansrapporter
...
## <a name="setting-up-a-new-financial-report-name" />Opsætning af et nyt finansrapportnavn
...
### <a name="set-up-a-new-financial-report-name" />Opsætning af et nyt finansrapportnavn
...
## <a name="setting-up-row-definition-lines" />Opsætte rækkedefinitionslinjer
...
### <a name="set-up-row-definition-lines" />Opsætte rækkedefinitionslinjer
...
## <a name="setting-up-a-new-column-definition" />Opsætning af et nyt kolonneformat
...
### <a name="set-up-a-new-column-definition" />Opsætning af ny kolonnedefinition
...
## <a name="assigning-the-column-definition-to-the-financial-report-name" />Tildele en kolonnedefinition til en finansrapport

Ken er nu klar til at tildele kolonnedefinition til finansrapportnavnet.  

### <a name="assign-the-column-definition-to-the-financial-report-name" />Tildele en kolonnedefinition til en finansrapport
...
## <a name="view-and-print-the-cash-flow-forecast" />Visning og udskrift af likviditetsforecastet
...
## <a name="see-related-microsoft-trainingtrainingmodulesforecast-cash-flow-dynamics-365-business-central" />Se relateret [Microsoft-træning](/training/modules/forecast-cash-flow-dynamics-365-business-central/)
