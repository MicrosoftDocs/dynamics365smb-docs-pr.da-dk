---
title: Oprette likviditetsbudgetter ved hjælp af finansielle rapporter
...
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Gennemgang: Oprette likviditetsbudgetter ved hjælp af finansielle rapporter
...
### <a name="set-up-a-new-financial-report-name-1"></a>Opsætning af et nyt finansrapportnavn
...
### <a name="set-up-row-definition-lines-1"></a>Opsætte rækkedefinitionslinjer
...
### <a name="set-up-a-new-column-definition-1"></a>Opsætning af ny kolonnedefinition
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Tildele kolonnedefinition til navnet på den finansielle rapport
