...
---
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Gennemgang: Udarbejd likviditetsforecast ved hjælp af finansrapporter
...
## <a name="set-up-a-new-column-definition"></a>Opsætning af et nyt kolonneformat
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Tildele en kolonnedefinition til en finansrapport
