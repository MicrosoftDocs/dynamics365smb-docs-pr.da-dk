...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central"></a><a name="managing-onedrive-integration-with-business-central"></a>Administration af OneDrive-integration med Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central"></a><a name="configure-onedrive-for-integration-with-business-central"></a>Konfigurere OneDrive til integration med Business Central
...
### <a name="managing-privacy"></a><a name="managing-privacy"></a>Administration af beskyttelse af personlige oplysninger
...
### <a name="configure-onedrive-using-onedrive-setup"></a><a name="configure-onedrive-using-onedrive-setup"></a>Konfigurere OneDrive ved hjælp af OneDrive-konfiguration
...
### <a name="switching-to-new-onedrive-integration-after-upgrade"></a><a name="switching-to-new-onedrive-integration-after-upgrade"></a>Skifte til ny OneDrive-integration efter opgradering
...
## <a name="restoring-onedrive-and-"></a><a name="restoring-onedrive-and-"></a>Gendannelse af OneDrive og [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="governance"></a><a name="governance"></a>Styreformer
