...
|Højrepil|Flyt i den samme række til det næste interaktive felt til højre.| Flyt i den samme række til det næste felt til højre. |Dette gælder ikke, når listen kan redigeres.|
|Venstre pil|Flyt i den samme række til det forrige felt til venstre. | Flyt i den samme række til det forrige felt til venstre. |Dette gælder ikke, når listen kan redigeres.|
|Start<br />(Fn +venstre pil)|Flytte til det første felt i en række.|Flytte til det første felt i en række.||
|End<br />(Fn + højre pil)|Flytte til det sidste interaktive felt i rækken.|Flytte til det sidste felt i en række.||
|Page Up<br />(Fn + pil op)|Flyt i den samme kolonne til den øverste synlige række.|Flyt i den samme kolonne til den øverste synlige række.||
|Page Down<br />(Fn + pil ned)|Flyt i den samme kolonne til den nederste synlige række.|Flyt i den samme kolonne til den nederste synlige række.||
...
|Ctrl+Home<br />(Fn + Ctrl + venstre pil)|Marker den første række på listen. Fokus flyttes til det første interaktive felt i rækken|Flytte til feltet i den første række på listen.||
|Ctrl+End<br />(Fn + Ctrl + højre pil)|Marker den sidste række på listen. Fokus flyttes til det første interaktive felt i rækken|Flytte til det første felt i den sidste række på listen.||
