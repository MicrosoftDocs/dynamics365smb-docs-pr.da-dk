...
# <a name="keyboard-shortcuts" />Tastaturgenveje
...
## <a name="keyboard-shortcuts-in-lists" />Tastaturgenveje på lister
...
## <a name="keyboard-shortcuts-in-cards-and-documents" />Tastaturgenveje i kort og dokumenter
...
## <a name="keyboard-shortcuts-in-date-fields" />Tastaturgenveje i datofelter
...
## <a name="access-keys-for-action-bar-and-navigation-menu" />Hurtigtaster til en handlingslinje og navigationsmenuen
