...
ms.author: bholtorf
---
# <a name="configure-service-processes"></a><a name="configure-service-processes"></a><a name="configure-service-processes"></a>Konfigurere serviceprocesser
...
## <a name="to-enter-general-and-mandatory-settings"></a><a name="to-enter-general-and-mandatory-settings"></a><a name="to-enter-general-and-mandatory-settings"></a>Sådan angives generelle og obligatoriske indstillinger
