...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Ændre grundlæggende indstillinger
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Ændre rollen
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Virksomhed
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Angive arbejdsdato
...
## <a name="region"></a><a name="region"></a><a name="region"></a> Område
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Sprog
...
## <a name="time-zone"></a><a name="time-zone"></a>Tidszone
...
## <a name="notifications"></a><a name="notifications"></a>Notifikationer
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Undervisningstip
