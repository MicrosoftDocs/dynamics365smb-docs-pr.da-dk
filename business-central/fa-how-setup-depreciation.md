...
# <a name="set-up-fixed-asset-depreciation" />Opsætte afskrivning af anlægsaktiv
...
## <a name="to-create-a-depreciation-book" />Sådan oprettes en afskrivningsprofil
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset" />Sådan tildeles en afskrivningsprofil til et anlægsaktiv
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job" />Sådan tildeles en afskrivningsprofil til flere anlægsaktiver med en kørsel
...
## <a name="to-set-up-depreciation-posting-types" />Sådan defineres bogføringstyper for afskrivning
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation" />Sådan defineres standardtyper og -kørsler for anlægsafskrivning
