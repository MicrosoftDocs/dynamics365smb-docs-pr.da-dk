...
ms.author: edupont
---
# <a name="design-details-posting-date-on-adjustment-value-entry" />Designoplysninger: Bogføringsdato på post med reguleringsværdi
...
## <a name="how-posting-dates-are-assigned" />Sådan tildeles bogføringsdatoer
...
#### <a name="general-ledger-setup" />Opsætning af Finans
...
## <a name="common-problems-with-the-adjust-cost---item-entries-batch-job" />Almindelige problemer med "Juster kostpris - vareposter"-kørsel

Der er to scenarier, som supportteamet ofte støder på for at garantere deres egne problemløsningsartikler.

### <a name="error-message-posting-date-is-not-within-your-range-of-allowed-posting-dates" />Fejlmeddelelse: "Bogføringsdatoen er ikke inden for intervallet af tilladte bogføringsdatoer..."
...
### <a name="posting-date-on-adjustment-value-entry-versus-posting-date-on-entry-causing-the-adjustment-such-as-revaluation-or-item-charge" />Bogføringsdato på reguleringsværdipost og bogføringsdatoen på post, der forårsager reguleringen, f.eks. værdiregulering eller varegebyr
