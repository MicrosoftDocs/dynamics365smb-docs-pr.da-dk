...
ms.author: bholtorf
---
# <a name="define-retention-policies" />Definere opbevaringspolitikker
...
## <a name="required-setups-and-permissions" />Krævede opsætninger og tilladelser
...
### <a name="to-create-retention-periods" />Sådan oprettes opbevaringsperioder
...
### <a name="set-up-a-retention-policy" />Opsæt opbevaringspolitik
...
## <a name="applying-retention-policies" />Anvende opbevaringspolitikker
...
## <a name="viewing-retention-policy-log-entries" />Se logførte poster for opbevaringspolitikker
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer" />Medtage din udvidelse i en opbevaringspolitik (kræver hjælp fra en udvikler)
