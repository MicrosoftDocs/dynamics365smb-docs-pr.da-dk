...
Du skal hente appen Field Service-integration fra [AppSource](https://go.microsoft.com/fwlink/?linkid=2277917) og installere den [!INCLUDE [prod_short](includes/prod_short.md)].
...
Når du har oprettet forbindelse til Dataverse og Salg, kan du konfigurere integrationen til [!INCLUDE [field-service-short](includes/field-service-short.md)].

* Hent og installer appen Field Service-integration fra [AppSource](https://go.microsoft.com/fwlink/?linkid=2277917). Find derefter appen Field Service-integration på **siden Administration af udvidelser**, og vælg handlingen **Konfigurer** for at køre den assisterede opsætningsvejledning.
* På siden **Assisteret opsætning** i [!INCLUDE [prod_short](includes/prod_short.md)] skal du vælge **Konfigurer integration til Dynamics 365 Field Service** for at køre den assisterede opsætningsvejledning.

I dette afsnit beskrives nøgleindstillingerne i programguiden.
