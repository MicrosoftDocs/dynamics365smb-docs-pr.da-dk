...
# <a name="keyboard-quick-reference---pc-only" />Hurtig reference til tastatur - kun pc'er
...
#### <a name="navigate--select-rows" />Naviger og vælg rækker
...
#### <a name="copy--paste" />Kopiér og sæt ind
...
#### <a name="search-filter--sort" />Søg, filtrer og sortér
...
##### <a name="report-preview" />Visning af et rapporteksempel

|Vælg disse taster|For at gøre følgende|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Start</kbd>/<kbd>End</kbd>|Gå til første/sidste side|

#### <a name="numeric-keypad" />Numerisk tastatur
