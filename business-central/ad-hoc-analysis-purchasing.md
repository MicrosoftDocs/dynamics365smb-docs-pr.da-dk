...
| ---- | ----- | ------------------------------- |------------------- |
| [GRNI-oversigt](#example-goods-received-not-invoiced-grni-overview) | Få en GRNI-oversigt (Goods Received, Not Invoiced) på tværs af leverandører. | [Købslinjer](https://businesscentral.dynamics.com/?page=518) | **Type**, **Amt. Rec. Ikke faktureret (LV)** (filtrer i disse felter), **Kreditornr.**, **Bilagsnr.**, **Nr.** og **Modt. Ikke faktureret (LV)** <br><br> **Bemærk:** Du kan tilpasse siden for at tilføje disse felter. Flere oplysninger i [Tilpasse dit arbejdsområde](ui-personalization-user.md). | 
...
1. Angiv følgende filtre i menuen **Yderligere filtre** (placeret under menuen **Kolonner** til højre):
    - **Type = Vare**
...
1. Hvis du vil udføre analysen for et givet år eller kvartal, skal du anvende et filter i menuen **Analysefiltre**. Menuen er til højre på siden, lige under menuen **Kolonner**.
