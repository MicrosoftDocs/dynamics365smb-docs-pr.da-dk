...
ms.author: edupont
---
# <a name="set-up-contacts" />Opsætning af kontakter
...
## <a name="to-assign-industry-groups-to-a-contact" />Sådan tildeles brancher til en kontakt
...
## <a name="to-assign-mailing-groups-to-a-contact" />Sådan tildeles mailgrupper til en kontakt
...
## <a name="to-define-a-contacts-alternate-address" />Sådan defineres en kontakts alternative adresse
...
## <a name="to-assign-job-responsibilities-to-a-contact" />Sådan tildeles ansvarsområder til en kontaktperson
...
## <a name="to-assign-organizational-levels-to-a-contact" />Sådan tildeles kompetenceniveauer til en person
...
## <a name="to-assign-web-sources-to-a-contact" />Sådan tildeles webkilder til en kontakt
...
## <a name="to-assign-business-relations-to-a-contact" />Sådan tildeles forretningsrelationer til en kontakt
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons" />Kopiere bestemte oplysninger automatisk fra kontaktvirksomheder til kontaktpersoner
...
## <a name="use-predefined-defaults-on-new-contacts" />Bruge foruddefinerede standarder på de nye kontakter
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts" />Synkronisering af kontakter med debitorer, kreditorer og bankkonti
...
## <a name="searching-for-duplicate-contacts" />Søgning efter dublerede kontakter
