...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data"></a><a name="manage-storage-by-deleting-documents-or-compressing-data"></a>Administrere lager ved at slette dokumenter eller komprimere data
...
## <a name="delete-documents"></a><a name="delete-documents"></a>Slette dokumenter.
...
## <a name="compress-data-with-date-compression"></a><a name="compress-data-with-date-compression"></a>Komprimere data med datokomprimering
...
## <a name="posting-compressed-entries"></a><a name="posting-compressed-entries"></a>Bogføre komprimerede poster
...
### <a name="to-run-a-date-compression"></a><a name="to-run-a-date-compression"></a>Kør datokomprimering
