...
ms.author: edupont
---
# <a name="design-details-revaluation" />Designoplysninger: Regulering
...
## <a name="calculating-the-revaluable-quantity" />Beregning af det antal, der kan reguleres
...
## <a name="expected-cost-in-revaluation" />Forventet kostpris i værdiregulering
...
## <a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation" />Bestemmelse af om en lagerreducering påvirkes af værdiregulering
...
## <a name="wip-inventory-revaluation" />VIA - Regulering af lagerværdi
