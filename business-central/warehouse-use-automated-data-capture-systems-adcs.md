...
---
# <a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a>Brug ADCS (Automated Data Capture Systems)
...
## <a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a>Sådan aktiveres webtjenester til ADCS

Hvis du vil bruge Automated Data Capture System, skal du aktivere ADCS-webtjenesten.  

## <a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a>Sådan aktiveres og publiceres ADCS-webtjenesten
...
## <a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a>Sådan opsætter du et lager til brug af ADCS
...
## <a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a>Angive en vare for at bruge ADCS
...
## <a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a>Sådan tilføjes en ADCS-bruger
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a>Sådan angiver du, at en lagermedarbejder er ADCS-bruger
...
## <a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a>Sådan oprettes og tilpasses miniformularer
...
### <a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a>Sådan oprettes en miniformular til ADCS
...
### <a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a>Sådan tilpasses miniformularfunktioner
