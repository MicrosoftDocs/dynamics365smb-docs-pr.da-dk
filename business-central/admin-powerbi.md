...
|Arbejde med [!INCLUDE [prod_short](includes/prod_short.md)]-data i datamarts og dataflows|Fra og med juli 2022 kan du bruge [!INCLUDE [prod_short](includes/prod_short.md)]-connectoren i Power Query Online til dataflows, som du deler på tværs af forskellige rapporter og dashboards.|[Her...](across-powerbi-business-central-apps.md)|
