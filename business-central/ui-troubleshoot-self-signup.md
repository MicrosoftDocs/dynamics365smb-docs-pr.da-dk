...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up" />Fejlfinding af selvbetjeningstilmelding
...
## <a name="what-email-address-can-i-use-with-business-central" />Hvilken mailadresse kan jeg bruge til Business Central?
...
## <a name="regional-availability" />Tilgængelighed i område
