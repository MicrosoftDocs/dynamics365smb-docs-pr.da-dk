...
---
# <a name="marketing-text-suggestions-with-copilot-overview"></a>Oversigt over AI-styret marketingtekst med element (forhåndsversion) med Copilot
...
For at komme i gang skal du bruge et Business Central version 22-miljø, som er aktiveret med Copilot.

- Hvis du allerede er en kunde hos Business Central, skal din Business Central-administrator konfigurere et version 22-miljø til dig.
- Hvis du ikke er Business Central-kunde, men gerne vil prøve det, kan du tilmelde dig og få en gratis prøveversion.

Yderligere oplysninger finder du i [Hent Business Central-forhåndsversion](ai-preview-getstarted.md).  
