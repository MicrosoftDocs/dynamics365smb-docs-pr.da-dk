...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows" />Sådan bruger du godkendelsesworkflows
...
## <a name="request-a-record-approval" />Anmode om godkendelse af en post
...
## <a name="cancel-approval-requests" />Annuller godkendelsesanmodninger
...
## <a name="approve-or-reject-approval-requests" />Godkende eller afvise anmodninger om godkendelse
...
## <a name="delegate-approval-requests" />Uddelegere anmodninger om godkendelse
...
## <a name="manage-overdue-approval-requests" />Administrere forfaldne godkendelsesanmodninger
