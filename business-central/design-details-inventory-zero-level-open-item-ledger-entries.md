...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Designoplysninger: Kendt problem med vareudligning
...
## <a name="symptoms-of-the-issue" />Symptomer på problemet
...
## <a name="basics-of-item-application" />Grundlæggende oplysninger om vareudligning
...
### <a name="quantity-application" />Mængdeudligning
...
### <a name="cost-application" />Kostprisudligning
...
## <a name="illustration-of-a-basic-cost-flow" />Illustration af et grundlæggende omkostningsflow
...
## <a name="reasons-for-the-issue" />Årsager til problemet
...
## <a name="identifying-the-issue" />Identificere problemet
...
## <a name="workaround-for-the-issue" />Løsning til problemet
