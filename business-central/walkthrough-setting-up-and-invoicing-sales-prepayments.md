...
3.  Indtast **30** i feltet **Forudbetaling i %**.  
4.  Vælge **Relaterede** og derefter vælge **Salg**, **Forudbetalingsprocent**
5.  Udfyld de to linjer på siden **Forudbetalingsprocenter - salg** på følgende måde.  
    ...
    > [!IMPORTANT]  
    >  Afhængigt af dit land eller område, skal du også angive en skattegruppekode i oversigtspanelet **Fakturering** for varen 1896-S.  
...
3.  I feltet **Debitornr.** skal du vælge **20000**.  
...
8.  I oversigtspanelet **Forudbetaling** indeholder feltet **Linjebeløb for forudbetaling ekskl. moms** **458.16**. Hvis du opretter en forudbetalingsfaktura for ordren nu, er det dette beløb, der vises på fakturaen.  
...
9.  Skift beløb i feltet **Linjebeløb for forudbetaling ekskl. moms** til **800**, og luk derefter siden.  
...
2.  Gå til linjen for vare **1896-S** i feltet **Antal**, og indtast **2**.  
    ...
    Klik på **Statistik** i handlingen **Ordre**. Feltet **Forudbetaling - Linjebeløb ekskl. moms** indeholder nu **768.04**, og feltet **Forudbetalt beløb faktureret ekskl. moms** indeholder **417.76**. Dette viser, at der er et yderligere forudbetalingsbeløb, der endnu ikke er faktureret.  
...
4.  Markér den første forudbetalingsfaktura, og vælg derefter handlingen **Behandle** og derefter **Sæt udlignings-id** på siden **Udlign debitorposter**.  
