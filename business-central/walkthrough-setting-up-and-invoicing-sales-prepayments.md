...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Gennemgang: Opsætning og fakturering af salgsforudbetalinger
...
## <a name="set-up-prepayments" />Oprette forudbetalinger
...
### <a name="to-set-up-number-series-for-prepayments" />Sådan opsættes nummerserierne for forudbetalinger
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Sådan blokeres forsendelser ved ubetalte forudbetalinger
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Sådan angives standardprocenten for forudbetalinger for debitorer og varer
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Angive en konto for salgsforudbetalinger i den generelle bogføringsopsætning
...
## <a name="create-an-order-that-requires-a-prepayment" />Oprette en ordre, der kræver en forudbetaling
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Sådan oprettes en salgsordre med en forudbetaling
...
## <a name="create-a-prepayment-invoice" />Oprette en forudbetalingsfaktura
...
## <a name="create-an-additional-prepayment-invoice" />Oprette en yderligere forudbetalingsfaktura
...
### <a name="to-create-an-additional-prepayment-invoice" />Sådan oprettes der en forudbetalingsfaktura til
...
## <a name="apply-the-prepayments" />Påføre forudbetalinger
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Sådan påføres en betaling på forudbetalingsfakturaer
...
## <a name="invoice-the-remaining-amount" />Fakturere restbeløbet
...
### <a name="to-invoice-the-remaining-amount" />Sådan faktureres restbeløbet
...
## <a name="see-related-microsoft-training" />Se relateret [Microsoft-træning](/training/modules/prepayment-invoices-dynamics-365-business-central/)
