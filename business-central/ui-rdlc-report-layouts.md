...
ms.author: jswymer
---
# <a name="working-with-rdlc-layouts" />Arbejde med RDLC-layouts
...
## <a name="required-tools" />Krævede værktøjer
...
## <a name="create-and-modify-rdlc-layouts" />Oprette og tilpasse RDLC-layouts
