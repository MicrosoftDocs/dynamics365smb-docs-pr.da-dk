...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Bogføre serviceordrer og kreditnotaer
...
## <a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a>Sådan bogføres serviceordrer
...
## <a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a>Massebogføre serviceordrer
1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, angiv **Serviceordre** og vælg derefter det relaterede link.  
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>Sådan bogføres servicekreditnotaer
...
## <a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a>Sådan bogføres forbrug fra en serviceordre
...
## <a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a>Bogføre leverancer fra serviceordrer
...
## <a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a>Sådan fortrydes bogført forbrug
...
## <a name="to-post-service-lines"></a><a name="to-post-service-lines"></a>Sådan bogføres servicelinjer
