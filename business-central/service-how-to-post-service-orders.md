...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos" />Bogføre serviceordrer og kreditnotaer
...
## <a name="to-post-a-service-order" />Sådan bogføres serviceordrer
...
## <a name="to-batch-post-service-orders" />Massebogføre serviceordrer
1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, angiv **Serviceordre** og vælg derefter det relaterede link.  
...
## <a name="to-post-a-service-credit-memo" />Sådan bogføres servicekreditnotaer
...
## <a name="to-post-consumption-from-a-service-order" />Sådan bogføres forbrug fra en serviceordre
...
## <a name="to-post-shipments-from-service-orders" />Bogføre leverancer fra serviceordrer
...
## <a name="to-undo-posted-consumption" />Sådan fortrydes bogført forbrug
...
## <a name="to-post-service-lines" />Sådan bogføres servicelinjer
