...
ms.author: edupont
---
# <a name="set-up-an-additional-reporting-currency"></a><a name="set-up-an-additional-reporting-currency"></a>Oprette en ekstra rapporteringsvaluta
...
## <a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a><a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a>Visning af rapporter og beløb i den ekstra rapporteringsvaluta
...
## <a name="adjusting-exchange-rates"></a><a name="adjusting-exchange-rates"></a>Regulering af valutakurser
...
## <a name="setting-up-an-additional-reporting-currency"></a><a name="setting-up-an-additional-reporting-currency"></a>Oprette en ekstra rapporteringsvaluta.
...
### <a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments"></a><a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments"></a>Angiv finanskonti til bogføring af valutakursreguleringer
...
### <a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a><a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a>Sådan angives metoden til regulering af valutakurser for alle finanskonti
...
### <a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a><a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a>Sådan angives metoder til regulering af valutakurser for momsposter
...
### <a name="to-activate-the-additional-reporting-currency"></a><a name="to-activate-the-additional-reporting-currency"></a>Sådan aktiveres den ekstra rapporteringsvaluta
1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Opsætning af Finans**, og vælg derefter det relaterede link.  
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/paths/use-multiple-currencies-dynamics-365-business-central/)
