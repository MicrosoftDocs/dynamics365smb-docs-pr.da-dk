...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel" />Få Business Central-tilføjelsesprogram til Excel
...
### <a name="about-the-add-in" />Om tilføjelsesprogrammet
...
### <a name="about-deployment-as-an-admin" />Om implementering som administrator
...
## <a name="preparation-on-premises-only" />Forberedelse (kun lokalt)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment" />Installere tilføjelsesprogrammet ved hjælp af centraliseret installation
...
### <a name="before-you-begin" />Inden du starter
...
### <a name="set-up-centralized-deployment-of-the-add-in" />Konfigurere centraliseret udrulning af Excel-tilføjelsesprogram
...
### <a name="configure-the-business-central-connection" />Konfigurer Business Central-forbindelsen
...
## <a name="prepare-devices-and-network-for-the-excel-add-in" />Forberede enheder og netværk til Excel-tilføjelsesprogrammet
