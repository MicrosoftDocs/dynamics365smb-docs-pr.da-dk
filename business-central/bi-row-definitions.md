...
# <a name="row-definitions-in-financial-reporting"></a>Rækkedefinitioner i Financial Reporting
...
## <a name="built-in-row-definitions"></a>Indbyggede rækkedefinitioner
...
## <a name="use-gl-account-categories-to-change-the-layout-of-your-financial-statements"></a>Brug finanskontokategorier til at ændre layoutet af regnskabet
...
## <a name="best-practices-for-working-with-row-definitions"></a>Bedste fremgangsmåder for arbejde med rækkedefinitioner
...
## <a name="import-or-export-financial-reporting-row-definitions"></a>Importere eller eksportere rækkedefinitioner for Financial Reporting
