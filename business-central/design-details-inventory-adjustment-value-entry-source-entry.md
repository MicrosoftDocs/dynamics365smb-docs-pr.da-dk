...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a><a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a>Bogføringsdatoen for regulerings værdiposten sammenlignet med kildeposten
...
## <a name="revaluation-scenario"></a><a name="revaluation-scenario"></a>Værdireguleringsscenarie
...
### <a name="to-test-the-scenario"></a><a name="to-test-the-scenario"></a>Sådan testes scenariet
...
### <a name="conclusion"></a><a name="conclusion"></a>Konklusion
...
## <a name="item-charge-scenario"></a><a name="item-charge-scenario"></a>Scenarie med varegebyr
...
### <a name="to-test-the-scenario-1"></a><a name="to-test-the-scenario-1"></a>Sådan testes scenariet
