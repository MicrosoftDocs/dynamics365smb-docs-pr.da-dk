...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Bogføringsdatoen for regulerings værdiposten sammenlignet med kildeposten
...
## <a name="revaluation-scenario" />Værdireguleringsscenarie
