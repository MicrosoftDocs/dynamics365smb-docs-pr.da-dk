...
ms.author: edupont
---
# <a name="use-item-charges-to-account-for-additional-trade-costs" />Bruge varegebyrer til at angive ekstra handelsomkostninger
...
## <a name="to-set-up-item-charge-numbers" />Sådan oprettes varegebyrnumre
...
## <a name="to-assign-an-item-charge-directly-to-the-purchase-invoice-for-the-item" />Sådan tildeles et varegebyr direkte til købsfakturaen for varen
...
## <a name="to-assign-an-item-charge-from-a-separate-invoice-to-the-purchase-invoice-for-the-item" />Sådan tildeles et varegebyr fra en separat faktura til købsfakturaen for varen
...
## <a name="handle-item-charges-for-partial-receipts" />Håndtere varegebyrer for delleverancer
...
## <a name="see-related-microsoft-trainingtrainingmodulespost-purchase-item-charges-dynamics--business-central" />Se relateret [Microsoft-træning](/training/modules/post-purchase-item-charges-dynamics-365-business-central/)
