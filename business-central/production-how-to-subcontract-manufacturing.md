...
ms.author: edupont
---
# <a name="subcontract-manufacturing" />Produktion hos underleverandør
...
## <a name="subcontract-work-centers" />Arbejdscentre til underleverance
...
### <a name="subcontract-work-center-fields" />Felter for arbejdscenter til underleverance
...
### <a name="routings-that-use-subcontract-work-centers" />Ruter, der bruger arbejdscentre til underleverancer
...
## <a name="calculate-subcontracting-worksheets-and-create-subcontract-purchase-orders" />Beregne underleverandørkladder og oprette købsordrer på underleverance
...
### <a name="to-calculate-the-subcontracting-worksheet" />Sådan beregnes underleverandørkladden
...
### <a name="to-create-the-subcontract-purchase-order" />Sådan oprettes købsordre på underleverance
1.  Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Underleverandørkladde**, og vælg derefter det relaterede link.  
...
## <a name="posting-subcontract-purchase-orders" />Bogføre købsordrer på underleverancer
...
## <a name="to-post-a-subcontract-purchase-order" />Sådan bogføres en købsordre på en underleverance
