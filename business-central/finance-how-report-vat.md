...
# <a name="report-vat-to-tax-authorities" />Rapportere moms til skattemyndighederne
...
### <a name="submit-an-ec-sales-list-report" />Indsend en Liste over EU-salg-rapport
...
## <a name="to-connect-to-your-tax-authoritys-web-service" />Sådan opretter du forbindelse til din skattemyndigheds webtjeneste
...
### <a name="to-set-up-vat-return-periods" />Sådan defineres momsreturperioder
...
## <a name="to-prepare-and-submit-a-vat-report" />Sådan forbereder og sender du en momsrapport
...
### <a name="vat-return-statuses" />Status for momsangivelse
...
## <a name="viewing-communications-with-your-tax-authority" />Visning af kommunikationen med skattemyndighederne
...
## <a name="submitting-vat-reports-manually" />Sende momsrapporter manuelt
...
## <a name="vat-settlement" />Momsafregning
...
## <a name="configuring-your-own-vat-reports" />Konfigurere dine egne momsrapporter
