...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Rapportere moms til skattemyndighederne
...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>Om rapporten Oversigt over EU-salg
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Indsend en Liste over EU-salg-rapport

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>Om rapporten Momsopgørelse
...
## <a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a>Sådan opretter du forbindelse til din skattemyndigheds webtjeneste
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>Sådan opsættes momsrapporter i [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>Sådan defineres momsreturperioder
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>Sådan forbereder og sender du en momsrapport
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>Status for momsangivelse
...
## <a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a>Visning af kommunikationen med skattemyndighederne
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Sende momsrapporter manuelt
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a>Momsafregning
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Konfigurere dine egne momsrapporter
