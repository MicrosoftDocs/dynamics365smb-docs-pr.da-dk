...
ms.author: jswymer
---
# <a name="working-with-microsoft-excel-layouts"></a><a name="working-with-microsoft-excel-layouts"></a>Arbejde med Microsoft Excel-layouts
...
## <a name="why-use-excel-layouts"></a><a name="why-use-excel-layouts"></a>Hvorfor bruge Excel-layout?
...
## <a name="task-1-create-the-excel-layout-file"></a><a name="task-1-create-the-excel-layout-file"></a>Opgave 1: Opret den nye Excel-layoutfil
...
#### <a name="approach-1-export-the-layout-from-the-report-layouts-page"></a><a name="approach-1-export-the-layout-from-the-report-layouts-page"></a>Metode 1: Eksporter layoutet fra siden **Rapportlayout**
...
#### <a name="approach-2-download-the-layout-from-the-reports-request-page"></a><a name="approach-2-download-the-layout-from-the-reports-request-page"></a>Metode 2: Hent layoutet fra rapportens anmodnings side
...
## <a name="task-2-add-the-excel-layout-to-the-report"></a><a name="task-2-add-the-excel-layout-to-the-report"></a>Opgave 2: Tilføje Excel-layout til rapporten
...
## <a name="understanding-excel-layouts"></a><a name="understanding-excel-layouts"></a>Om Excel-layout
