...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central" />Visning og redigering i Excel fra Business Central
...
## <a name="open-in-excel" />Åbn i Excel
...
## <a name="edit-in-excel" />Rediger i Excel
...
### <a name="first-time-sign-in" />Log på første gang
...
### <a name="work-across-environments-and-companies" />Arbejde på tværs af miljøer og virksomheder
...
### <a name="limits-when-using-excel-for-the-web" />Grænser for brug af Excel på internettet
...
## <a name="see-the-differences-between-the-options" />Se forskellene mellem indstillingerne
<br><br>  
