...
# <a name="business-central-and-microsoft-teams-integration" />Business Central og Microsoft Teams-integration
...
## <a name="features-overview" />Oversigt over funktioner

Appen [!INCLUDE [prod_short](includes/prod_short.md)] for Teams indeholder følgende funktioner.

### <a name="look-up-details-of-customers-vendors-and-other-contacts" />Søge efter detaljer om debitorer, kreditorer og andre kontakter
...
### <a name="share-records-in-conversations" />Dele poster i samtaler
...
### <a name="share-links-from-pages-in-business-central-to-teams" />Dele links fra sider i Business central til Teams
...
### <a name="add-a-business-central-tab-to-teams-channel-or-chat" />Tilføje fanen Business Central til Teams-kanal eller chat
