...
# <a name="business-central-and-microsoft-teams-integration"></a><a name="business-central-and-microsoft-teams-integration"></a>Business Central og Microsoft Teams-integration
...
## <a name="features-overview"></a><a name="features-overview"></a>Oversigt over funktioner

Appen [!INCLUDE [prod_short](includes/prod_short.md)] for Teams indeholder følgende funktioner.

### <a name="look-up-details-of-customers-vendors-and-other-contacts"></a><a name="look-up-details-of-customers-vendors-and-other-contacts"></a>Søge efter detaljer om debitorer, kreditorer og andre kontakter
...
### <a name="share-records-in-conversations"></a><a name="share-records-in-conversations"></a>Dele poster i samtaler
...
### <a name="share-links-from-pages-in-business-central-to-teams"></a><a name="share-links-from-pages-in-business-central-to-teams"></a>Dele links fra sider i Business central til Teams
...
### <a name="add-a-business-central-tab-to-teams-channel-or-chat"></a><a name="add-a-business-central-tab-to-teams-channel-or-chat"></a>Tilføje fanen Business Central til Teams-kanal eller chat
