...
ms.author: edupont
---
# <a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a>Oprette en behovsprognose
...
## <a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a>Salgsforecast og produktionsforecast
...
## <a name="component-forecast"></a><a name="component-forecast"></a><a name="component-forecast"></a>Komponentforecast
...
## <a name="forecasting-periods"></a><a name="forecasting-periods"></a><a name="forecasting-periods"></a>Forecastperioder
...
## <a name="forecast-by-locations"></a><a name="forecast-by-locations"></a><a name="forecast-by-locations"></a>Forecast opdelt efter lokationer
...
### <a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a>Brug forecast på lokationer
...
### <a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a>Brug ikke forecast på lokationer
...
## <a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a>Sådan oprettes en behovsprognose
