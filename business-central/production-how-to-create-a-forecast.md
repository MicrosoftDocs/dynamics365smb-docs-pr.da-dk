...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Oprette en behovsprognose
...
## <a name="sales-forecasts-and-production-forecasts" />Salgsforecast og produktionsforecast
...
## <a name="component-forecast" />Komponentforecast
...
## <a name="forecasting-periods" />Forecastperioder
...
## <a name="forecast-by-locations" />Forecast opdelt efter lokationer
...
### <a name="use-forecast-by-locations" />Brug forecast på lokationer
...
### <a name="do-not-use-forecast-by-locations" />Brug ikke forecast på lokationer
...
## <a name="to-create-a-demand-forecast" />Sådan oprettes en behovsprognose
