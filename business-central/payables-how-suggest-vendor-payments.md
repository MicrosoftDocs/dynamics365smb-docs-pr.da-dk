...
ms.author: edupont
---
# <a name="suggest-vendor-payments" />Lav forslag
...
## <a name="to-use-the-suggest-vendor-payments-function" />Sådan bruges funktionen Lav kreditorbetalingsforslag
...
## <a name="to-insert-the-due-date-as-posting-date-on-payment-journal-lines" />Sådan indsættes forfaldsdatoen som bogføringsdato på betalingskladdelinjer
...
## <a name="see-related-microsoft-trainingtrainingmodulessuggest-vendor-payments-dynamics--business-central" />Se relateret [Microsoft-træning](/training/modules/suggest-vendor-payments-dynamics-365-business-central/)
