...
ms.author: edupont
---
# <a name="post-capacities"></a><a name="post-capacities"></a><a name="post-capacities"></a>Bogføre kapaciteter
...
## <a name="to-post-capacities"></a><a name="to-post-capacities"></a><a name="to-post-capacities"></a>Sådan bogføres kapaciteter
...
## <a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a>Sådan vises arbejdscenterposter
