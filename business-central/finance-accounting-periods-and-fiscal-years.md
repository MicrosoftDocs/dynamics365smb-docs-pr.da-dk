...
ms.author: bholtorf
---
# <a name="work-with-accounting-periods-and-fiscal-years" />Arbejd med regnskabsperioder og regnskabsår
...
## <a name="creating-a-new-fiscal-year" />Oprette et nyt regnskabsår

Du kan oprette flere regnskabsperioder ad gangen ved hjælp af **Opret regnskabsår** som batchjob eller manuelt.

### <a name="how-to-create-accounting-periods-in-bulk" />Sådan oprettes flere regnskabsperioder ad gangen
...
### <a name="how-to-create-accounting-periods-manually" />Sådan oprettes regnskabsperioder manuelt
...
## <a name="closing-a-fiscal-year" />Afslutning af et regnskabsår
...
## <a name="posting-entries-to-a-closed-fiscal-year" />Bogføre poster til et afsluttet regnskabsår
