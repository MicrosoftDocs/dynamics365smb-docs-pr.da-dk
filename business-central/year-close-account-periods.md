...
ms.author: jswymer
---
# <a name="close-accounting-periods"></a><a name="close-accounting-periods"></a>Afslutte regnskabsperioder

Når regnskabsåret er slut, skal du afslutte de perioder, det indeholder.

## <a name="to-close-accounting-periods"></a><a name="to-close-accounting-periods"></a>Sådan afsluttes regnskabsperioder
