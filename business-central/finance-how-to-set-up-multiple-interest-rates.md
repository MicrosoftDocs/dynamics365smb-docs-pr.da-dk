...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a>Konfigurere flere rentesatser for forsinket betaling
...
## <a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a>Sådan angives flere rentesatser
