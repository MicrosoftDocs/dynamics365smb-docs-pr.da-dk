...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Afstemme kreditorbetalinger med udbetalingskladden eller fra kreditorposter
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />Sådan udlignes en betaling med en enkelt eller flere kreditorposter
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Sådan udlignes en kreditnota på en eller flere kreditorposter
...
## <a name="to-apply-posted-vendor-ledger-entries" />Sådan udlignes bogførte kreditorposter
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />Sådan udlignes kreditorposter i forskellig valuta med hinanden
...
## <a name="to-unapply-an-application-of-vendor-entries" />Sådan annulleres en udligning af kreditorposter
