...
2. I vinduet **Kontoplan** skal du konfigurere kontoen og kalde den **Fakturaafrunding** eller noget tilsvarende. [!INCLUDE[d365fin](includes/d365fin_md.md)] bruger kontonavnet som tekst på fakturaer, der afrundes.  
...
Du kan nu knytte fakturaafrundingskontoen til bogføringsgrupper i vinduet **Kreditorbogføringsgrupper**.  <!-- Why only the vendor posting groups? -->
...
2. I vinduet **Valutaer** skal du vælge den udenlandske valuta for at åbne **Valutakort**, og udfyld derefter felterne **Afrundingspræcision**, **Pris-afrundingspræcision**, **Fakturaafrundingspræcision** og **Fakturaafrundingsretning**.
...
2. I vinduet **Opsætning af Finans** på oversigtspanelet **Generelt** skal du udfylde feltet **Fakturaafrundingspræcision** og **Fakturaafrundningsretning**.  
