...
ms.author: edupont
---
# <a name="create-recurring-sales" />Opret tilbagevendende salg
...
## <a name="set-up-recurring-sales-lines" />Konfigurer gentagne salgslinjer
...
## <a name="assign-recurring-sales-lines-to-a-customer" />Tildel gentagne salgslinjer til en debitor
...
## <a name="insert-recurring-sales-lines-on-a-sales-invoice" />Indsæt tilbagevendende salgslinjer i en salgsfaktura
...
## <a name="create-multiple-sales-invoices-based-on-recurring-sales-lines" />Opret flere salgsfakturaer baseret på tilbagevendende salgslinjer
