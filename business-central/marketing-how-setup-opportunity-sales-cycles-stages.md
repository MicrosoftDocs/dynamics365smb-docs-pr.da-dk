...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages" />Konfigurere salgsprocesser og -procesfaser for leads
...
## <a name="to-set-up-opportunity-sales-cycle-codes" />Sådan oprettes salgsproceskoder for leads
...
## <a name="to-define-opportunity-sales-cycle-stages" />Sådan defineres salgsprocesfaser for leads
...
## <a name="to-assign-stage-cycles-to-opportunities" />Sådan tildeles faser i salgsprocesser til leads
...
## <a name="to-set-up-activities-with-tasks" />Sådan defineres aktiviteter til opgaver
...
## <a name="to-assign-tasks-or-activities-of-tasks-to-opportunities" />Sådan tildeles opgaver eller aktiviteter til leads
