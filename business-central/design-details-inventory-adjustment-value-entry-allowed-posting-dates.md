...
## <a name="change-the-user-setup"></a><a name="change-the-user-setup"></a>Ændre Brugeropsætning
...
### <a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a>Oversigt over opsætning af den involverede bogføringsdato
...
#### <a name="user-setup"></a><a name="user-setup"></a>Brugeropsætning
