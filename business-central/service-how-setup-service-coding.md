...
# <a name="set-up-standard-service-codes" />Konfigurere standardservicekoder
...
## <a name="to-set-up-a-standard-service-code" />Sådan oprettes standardservicekoder
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />Tildele en standardservicekode til en serviceartikelgruppe
