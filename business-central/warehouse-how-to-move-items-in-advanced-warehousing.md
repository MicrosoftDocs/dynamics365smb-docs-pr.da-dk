...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick"></a><a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick"></a>Flytte varer i avancerede konfigurationer af lagersteder med styret læg-på-lager
...
## <a name="warehouse-movement-worksheet"></a><a name="warehouse-movement-worksheet"></a>Lagerbevægelseskladde

### <a name="to-move-items-with-the-warehouse-movement-worksheet"></a><a name="to-move-items-with-the-warehouse-movement-worksheet"></a>Sådan flyttes varer med lagerbevægelseskladden
...
### <a name="to-register-the-warehouse-movement"></a><a name="to-register-the-warehouse-movement"></a>Sådan registreres lagerbevægelsen
...
## <a name="internal-pick"></a><a name="internal-pick"></a>Internt pluk

### <a name="to-create-an-internal-pick"></a><a name="to-create-an-internal-pick"></a>Sådan oprettes et internt pluk
...
### <a name="to-register-the-warehouse-pick"></a><a name="to-register-the-warehouse-pick"></a>Sådan registreres lagerplukningen
...
## <a name="internal-put-away"></a><a name="internal-put-away"></a>Intern læg-på-lager

### <a name="to-create-an-internal-put-away"></a><a name="to-create-an-internal-put-away"></a>Sådan oprettes en intern læg-på-lager-aktivitet
...
### <a name="to-register-the-warehouse-put-away"></a><a name="to-register-the-warehouse-put-away"></a>Fortsæt med at registrere læg-på-lager
...
## <a name="to-register-a-movement-that-has-already-happened"></a><a name="to-register-a-movement-that-has-already-happened"></a>Sådan registreres en bevægelse, der allerede er sket
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/manage-internal-warehouse-processes/)
