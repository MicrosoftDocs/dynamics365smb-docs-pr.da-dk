...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick" />Flytte varer i avancerede konfigurationer af lagersteder med styret læg-på-lager
...
## <a name="warehouse-movement-worksheet" />Lagerbevægelseskladde

### <a name="to-move-items-with-the-warehouse-movement-worksheet" />Sådan flyttes varer med lagerbevægelseskladden
...
### <a name="to-register-the-warehouse-movement" />Sådan registreres lagerbevægelsen
...
## <a name="internal-pick" />Internt pluk

### <a name="to-create-an-internal-pick" />Sådan oprettes et internt pluk
...
### <a name="to-register-the-warehouse-pick" />Sådan registreres lagerplukningen
...
## <a name="internal-put-away" />Intern læg-på-lager

### <a name="to-create-an-internal-put-away" />Sådan oprettes en intern læg-på-lager-aktivitet
...
### <a name="to-register-the-warehouse-put-away" />Fortsæt med at registrere læg-på-lager
...
## <a name="to-register-a-movement-that-has-already-happened" />Sådan registreres en bevægelse, der allerede er sket
