...
# <a name="set-up-email" />Konfigurer mail
...
## <a name="adding-email-accounts" />Tilføje e-mailkonti
...
## <a name="using-smtp" />Brug af SMTP
...
## <a name="add-email-accounts" />Tilføj e-mailkonti
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts" />Tildel e-mailscenarier til e-mailkonti
...
## <a name="set-up-view-policies" />Konfigurer visningspolitikker
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute" />Angiv, hvor mange meddelelser en konto kan sende pr. minut
...
## <a name="set-up-reusable-email-texts-and-layouts" />Konfigurere genanvendelige e-mailtekster og -layouts
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Brug en erstatningsafsenderadresse på udgående mailmeddelelser
...
## <a name="set-up-document-sending-profiles" />Konfigurere dokumentafsendelsesprofiler
...
## <a name="optional-set-up-email-logging-in-exchange-online" />Eventuelt: Konfigurer maillogføring i Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />Konfigurere e-mail til Business Central lokalt
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal" />Oprette en appregistrering til Business Central i Azure-portal
