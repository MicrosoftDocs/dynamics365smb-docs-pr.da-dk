...
# <a name="install-and-uninstall-extensions-apps-in-business-central" />Installere og fjerne udvidelser (apps) i Business Central
...
## <a name="set-up-an-app" />Konfigurere en app
...
## <a name="upload-a-per-tenant-extension-pte" />Overfører en udvidelse pr. lejer (PTE)
...
## <a name="uninstall-an-app" />AfInstaller en app
