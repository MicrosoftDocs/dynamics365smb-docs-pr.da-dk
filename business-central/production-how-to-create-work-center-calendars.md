...
ms.author: edupont
---
# <a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a>Konfigurere produktionskalendere
...
## <a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a>Sådan oprettes arbejdsskift
...
## <a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a>Sådan oprettes en produktionskalender
...
## <a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a>Sådan beregnes en arbejdscenterkalender
...
## <a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a>Sådan registreres fraværet på arbejdscentret
