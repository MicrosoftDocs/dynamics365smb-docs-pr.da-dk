...
ms.author: bholtorf
---
# <a name="specify-when-and-how-to-receive-workflow-notifications"></a><a name="specify-when-and-how-to-receive-workflow-notifications"></a>Angive, hvornår og hvordan arbejdsgangsnotifikationer modtages
...
## <a name="steps-in-workflows"></a><a name="steps-in-workflows"></a>Trin i Workflows
...
## <a name="specify-when-and-how-approval-users-receive-notifications"></a><a name="specify-when-and-how-approval-users-receive-notifications"></a>Angive, hvornår og hvordan godkendelsesbrugere modtager notifikationer
...
## <a name="change-when-and-how-you-receive-notifications"></a><a name="change-when-and-how-you-receive-notifications"></a>Rediger, hvornår og hvordan du modtager notifikationer
