...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job" />Gennemgang: Beregning af igangværende arbejder for en sag
...
### <a name="to-calculate-wip" />Sådan beregnes VIA
...
### <a name="to-review-wip-warnings" />Gennemgå VIA -advarsler
...
### <a name="to-recalculate-wip" />Sådan genberegnes VIA
...
## <a name="posting-wip-to-general-ledger" />Bogføre VIA i regnskab

 Nu, hvor Tricia har beregnet VIA for denne sag, kan hun bogføre det i regnskabet.  

### <a name="to-post-wip-to-general-ledger" />Sådan bogføres VIA til finanspost
...
## <a name="reversing-a-wip-posting" />Tilbageføre en VIA-bogføring
...
### <a name="to-reverse-a-wip-posting" />Sådan tilbageføres en VIA-bogføring.
