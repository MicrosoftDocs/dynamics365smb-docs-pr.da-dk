...
ms.author: edupont
---
# <a name="post-transactions-directly-to-the-general-ledger" />Bogføre transaktioner direkte i finansposterne
...
## <a name="to-post-a-transaction-directly-to-a-general-ledger-account" />Sådan bogføres en transaktion direkte på en finanspostkonto
