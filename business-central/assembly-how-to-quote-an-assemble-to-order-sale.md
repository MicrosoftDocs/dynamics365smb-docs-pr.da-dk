...
ms.author: edupont
---
# <a name="quote-an-assemble-to-order-sale" />Oprette tilbud på montage til ordre-salg
...
## <a name="to-create-a-sales-quote-for-an-assemble-to-order-item" />Sådan oprettes et salgstilbud til et montage efter ordre-element
