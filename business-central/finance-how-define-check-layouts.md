...
ms.author: edupont
---
# <a name="select-a-check-layout"></a><a name="select-a-check-layout"></a>Vælge et checklayout
...
## <a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a>Sådan vælges et checklayout
...
## <a name="use-micr-and-security-fonts"></a><a name="use-micr-and-security-fonts"></a>Bruge MICR og sikkerhedsskrifttyper
...
### <a name="delimiter-characters"></a><a name="delimiter-characters"></a>Afgrænsningstegn
...
### <a name="delimiter-characters-1"></a><a name="delimiter-characters-1"></a>Afgrænsningstegn
...
### <a name="secure-font-specifications"></a><a name="secure-font-specifications"></a>Specifikationer for sikre skrifttyper
