...
# <a name="review-amounts-in-general-ledger-accounts"></a>Gennemgå beløb i finanskonti
...
> [!TIP]
> Du kan hurtigt vælge flere poster ved at holde Ctrl eller Skift nede, mens du vælger posterne. *Ctrl* giver dig mulighed for at markere bestemte poster, og *Skift* markerer alle poster mellem den første og den sidste post, du vælger.
