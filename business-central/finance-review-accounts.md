...
# <a name="review-amounts-in-general-ledger-accounts" />Gennemse beløb i finanskonti
...
## <a name="set-up-accounts-for-reviews" />Oprette konti til gennemsyn
...
## <a name="mark-entries-as-reviewed" />Markere poster som gennemset
...
## <a name="review-accounts-that-have-old-entries" />Gennemse konti, der har gamle poster
...
## <a name="filter-entries" />Filtrere poster
...
## <a name="analyze-entries" />Analysér objekter
