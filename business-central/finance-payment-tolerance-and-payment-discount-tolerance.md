...
Du kan opsætte kontantrabattolerancer, så hvis du accepterer en kontantrabat efter kontantrabatdatoen, bogføres den altid på kontantrabatkontoen eller en betalingstolerancekonto.

## <a name="applying-payment-tolerance-to-multiple-documents"></a>Anvendelse af betalingstolerance for flere dokumenter

Et enkelt dokument har den samme betalingstolerance, hvad enten du bruger det individuelt eller sammen med andre dokumenter. Accept af forsinket kontantrabat, når du anvender betalingstolerance på flere dokumenter, finder automatisk sted for hvert dokument, hvor følgende regel gælder:  
...
Tolerancer på dato eller beløb giver dig mulighed for at afslutte en faktura, også selvom den ikke dækker fakturabeløbet fuldt ud. F. eks. fordi forfaldsdatoen for kontantrabatten er overskredet, er varerne fratrukket eller pga. en mindre fejl. Princippet gælder også for refusioner og kreditnotaer.  
...
9. Udfyld **felterne**  **Bogf. af kontantrabattolerance,** Kontantrabat **- respitperiode** og **Bogf. af betalingstolerance i oversigtspanelet Udligning.**    
...
11. Udfyld felterne **Betalingstolerancepct** . og **Maks. kont.tolerancebeløb** på **siden Skift betalingstolerance**, og vælg derefter knappen **OK** .
...
Standardindstillingen for betalingstolerancer er tilladt. Hvis du vil afvise betalingstolerancer for en bestemt debitor eller kreditor, skal du spærre tolerancer på henholdsvis debitor- eller kreditorkortet. Følgende trin beskriver, hvordan du skal gøre det for en debitor. Trinene er de samme for en kreditor.
...
Scenarier med alternativ A eller B repræsenterer:  
...
I forbindelse med scenariet er diagrammerne over betalingsintervaller som følger:  
...
### <a name="payment-range-diagrams-1"></a>Betalingsområdediagrammer

I forbindelse med scenariet er diagrammerne over betalingsintervaller som følger:  

#### <a name="1-payment-date-011503-scenarios-1-3-1"></a>(1) Betalingsdato <=15-01-03 (scenarie 1-3)
