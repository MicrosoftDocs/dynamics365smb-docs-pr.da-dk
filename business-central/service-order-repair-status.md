...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Konfigurere statusser for serviceordrer og reparationer
...
## <a name="to-set-up-service-status-priorities" />Sådan defineres statusprioriteter
...
## <a name="to-set-up-a-repair-status" />Definere reparationsstatus
