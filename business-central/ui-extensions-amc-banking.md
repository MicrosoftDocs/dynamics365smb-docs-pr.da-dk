...
## <a name="use-our-demonstration-account" />Bruge vores demonstrationskonto
...
## <a name="setting-up-the-extension" />Konfigurere udvidelsen
...
### <a name="to-set-up-the-required-permission-sets" />Sådan angives de nødvendige rettighedssæt
...
### <a name="to-connect-the-extension-to-amc-banking" />Hvis du vil knytte udvidelsen til AMC Banking
...
### <a name="to-connect-bank-accounts-to-the-extension" />Knytte bankkonti til udvidelsen
...
## <a name="use-the-extension" />Bruge udvidelsen
...
### <a name="to-export-data-and-submit-it-to-your-bank" />Eksportere data og sende dem til din bank
...
### <a name="to-import-and-apply-the-converted-file" />Sådan importeres og anvendes den konverterede fil
