...
ms.author: bholtorf
---
# <a name="personalize-your-workspace" />Tilpasse dit arbejdsområde
...
## <a name="to-change-the-width-of-a-column" />Sådan ændres kolonnebredden
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner" />Du kan begynde at tilpasse en side via banneret **Tilpasning**
...
## <a name="a-namewhatawhat-you-can-personalize" /><a name="What"></a>Hvad kan du tilpasse
...
## <a name="a-nameactionsapersonalizing-the-action-bar-and-menus" /><a name="Actions"></a>Tilpasse handlingslinje og menuer
...
### <a name="to-remove-hide-and-show-actions-and-action-groups" />Sådan fjernes, skjules og vises handlinger og handlingsgrupper
...
### <a name="to-move-actions-and-action-groups" />Sådan flyttes handlinger og handlingsgrupper
...
## <a name="a-namepartsapersonalizing-parts" /><a name="Parts"></a>Tilpasning af dele
...
## <a name="to-clear-personalization" />Sådan fjernes tilpasning
...
## <a name="other-points-of-interest" />Andre punkter af interesse
