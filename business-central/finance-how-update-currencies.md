...
ms.author: edupont
---
# <a name="update-currency-exchange-rates" />Opdatere valutakurser
...
### <a name="example-of-a-receivable-currency-transaction" />Eksempel på en valutapostering for tilgodehavender
...
### <a name="effect-on-customers-and-vendors" />Indflydelse på debitorer/kreditorer
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries" />Dimensioner for debitor- og kreditorposter
...
### <a name="effect-on-bank-accounts" />Indflydelse på bankkonti
...
#### <a name="dimensions-on-bank-account-entries" />Dimensioner for bankkontoposter

Reguleringsposterne for bankkontoens finanskonto og for gevinst-/tabskontoen tildeles bankkontoens standarddimensioner.

### <a name="effect-on-gl-accounts" />Indflydelse på finanskonti
...
##### <a name="dimensions-on-gl-account-entries" />Dimensioner for finanskontoposter
...
## <a name="to-set-up-a-currency-exchange-rate-service" />Sådan konfigureres en valutakurstjeneste
...
## <a name="to-update-currency-exchange-rates-through-a-service" />Sådan opdateres valutakurser fra en tjeneste
