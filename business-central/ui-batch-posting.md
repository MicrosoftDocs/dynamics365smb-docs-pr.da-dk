...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Bogføre flere dokumenter på én gang
...
## <a name="to-post-multiple-purchase-orders-immediately" />Sådan bogføres flere købsordrer med det samme
...
## <a name="to-batch-post-multiple-purchase-orders" />Sådan massebogføres flere købsordrer
...
## <a name="to-set-up-background-posting-with-job-queues" />Sådan konfigureres baggrundsbogføring med opgavekøer
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Sådan vises status fra et salgs- eller købsdokument
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Sådan oprettes en opgavekøpost for baggrundsbogføring af salgsordrer
...
## <a name="monitor-the-job-queue" />Overvåge opgavekøen
