...
ms.author: edupont
---
# <a name="create-analysis-reports" />Oprette analyserapporter
...
## <a name="setting-up-line-and-column-layouts" />Opsætte linje- og kolonneformater
...
## <a name="set-up-analysis-column-templates" />Oprette analysekolonneskabeloner
...
## <a name="set-up-analysis-line-templates" />Konfigurere analyselinjeskabeloner
...
## <a name="create-a-new-sales-analysis-report" />Oprette en ny salgsanalyserapport
