...
ms.author: edupont
---
# <a name="defining-and-allocating-costs"></a><a name="defining-and-allocating-costs"></a><a name="defining-and-allocating-costs"></a>Definere og allokere omkostninger
...
## <a name="setting-up-allocation-source-and-targets"></a><a name="setting-up-allocation-source-and-targets"></a><a name="setting-up-allocation-source-and-targets"></a>Konfigurere fordelingskilde og mål
...
### <a name="to-set-up-cost-allocations"></a><a name="to-set-up-cost-allocations"></a><a name="to-set-up-cost-allocations"></a>Opsætning af omkostningsfordelinger
...
## <a name="setting-filters-for-dynamic-allocation-bases"></a><a name="setting-filters-for-dynamic-allocation-bases"></a><a name="setting-filters-for-dynamic-allocation-bases"></a>Indstilling af filtre for dynamiske allokeringsbaser
...
### <a name="setting-filters"></a><a name="setting-filters"></a><a name="setting-filters"></a>Indstiller filtre
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab"></a><a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab"></a><a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab"></a>Sådan defineres fordelingskilden PROD-omkostningssted på oversigtspanelet Generelt

1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Omkostningsfordeling**, og vælg derefter det relaterede link.  
2. På siden **Omkostningsfordeling** skal du vælge handlingen **Ny**.  
3. I feltet **ID** skal du trykke på <kbd>Enter</kbd> eller indtaste et id.  
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab"></a><a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab"></a><a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab"></a>Sådan angives fordelingsmålsomkostningsobjekter på oversigtspanelet Linjer
...
## <a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a><a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a><a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a>Scenarie 2: Definition af dynamiske fordelinger baseret på solgte varer
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year"></a><a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year"></a><a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year"></a>Sådan defineres dynamiske fordelinger baseret på varer, der er solgt i det foregående år
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/allocate-costs-dynamics-365-business-central/)
