...
ms.author: edupont
---
# <a name="defining-and-allocating-costs" />Definere og allokere omkostninger
...
## <a name="setting-up-allocation-source-and-targets" />Konfigurere fordelingskilde og mål
...
### <a name="to-set-up-cost-allocations" />Opsætning af omkostningsfordelinger
...
## <a name="setting-filters-for-dynamic-allocation-bases" />Indstilling af filtre for dynamiske allokeringsbaser
...
### <a name="setting-filters" />Indstiller filtre
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab" />Sådan defineres fordelingskilden PROD-omkostningssted på oversigtspanelet Generelt
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab" />Sådan angives fordelingsmålsomkostningsobjekter på oversigtspanelet Linjer
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year" />Sådan defineres dynamiske fordelinger baseret på varer, der er solgt i det foregående år
