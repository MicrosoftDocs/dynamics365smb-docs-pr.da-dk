...
ms.author: bholtorf
---
# <a name="settle-purchase-invoices-promptly" />Afregne købsfakturaer omgående
...
## <a name="to-settle-purchase-invoices-promptly" />Sådan afregnes købsfakturaer omgående
