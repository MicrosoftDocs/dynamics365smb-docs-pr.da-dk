...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a>Fejlfinding i forbindelse med Business central
...
## <a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a>Start forbindelseskontrol
...
## <a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a>Grundlæggende internetforbindelse
...
## <a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a>CDN (Content Delivery Network)-ressourcer indlæser
...
## <a name="user-authentication"></a><a name="user-authentication"></a><a name="user-authentication"></a>Brugergodkendelse
...
## <a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a>Business central-miljøer
...
## <a name="application-service-connectivity"></a><a name="application-service-connectivity"></a><a name="application-service-connectivity"></a>Tilslutning af programtjeneste
...
## <a name="web-server-connectivity"></a><a name="web-server-connectivity"></a><a name="web-server-connectivity"></a>Webserverforbindelse
...
## <a name="service-health-status"></a><a name="service-health-status"></a><a name="service-health-status"></a>Status for tjenestetilstand
