...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central" />Fejlfinding i forbindelse med Business central
...
## <a name="start-the-connectivity-check" />Start forbindelseskontrol
...
## <a name="basic-internet-connectivity" />Grundlæggende internetforbindelse
...
## <a name="cdn-content-delivery-network-resources-loading" />CDN (Content Delivery Network)-ressourcer indlæser
...
## <a name="user-authentication" />Brugergodkendelse
...
## <a name="business-central-environments-discovery" />Business central-miljøer
...
## <a name="application-service-connectivity" />Tilslutning af programtjeneste
...
## <a name="web-server-connectivity" />Webserverforbindelse
...
## <a name="service-health-status" />Status for tjenestetilstand
