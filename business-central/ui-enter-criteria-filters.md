...
|`Bicycle..Car`| Strenger Cykel gennem bil, når den bestilles leksiografisk|  
...
#### <a name="me-or-user-records-assigned-to-you"></a>(%me eller %user) Poster, der er tildelt til dig

Brug `%me` eller `%user` ved filtrering af felter, der indeholder bruger-id'et, f.eks. feltet **Tildelt til bruger-id**, for at få vist alle poster, der er tildelt til dig.

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`%me`<br />eller<br />`%user`|Poster, der er knyttet til din brugerkonto. |  
