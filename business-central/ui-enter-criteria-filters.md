...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering" />Sortering, søgning og filtrering
...
### <a name="fine-tuning-the-search-with-filter-criteria" />Finjustere søgningen med filterkriterier
...
### <a name="filtering-with-option-fields" />Filtrere med indstillingsfelter
...
### <a name="setting-filters-on-lists" />Angive filtre på lister
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports" />Angive filtre i rapporter, kørsler og XMLporte
...
## <a name="entering-filter-criteria" />Angivelse af filterkriterier
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators" /><a name="FilterCriteria"> </a>Filterkriterier og -operatorer
...
#### <a name="-not-equal-to" />(<>) Ikke lig med
...
#### <a name="-greater-than" />(>) Større end

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>1200`|Tal større end 1200|  

#### <a name="-greater-than-or-equal-to" />(>=) Større end eller lig med

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>=1200`|Tal lig med eller større end 1200|  

#### <a name="-less-than" />(<) Mindre end

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`<1200`|Tal mindre end 1200|  

#### <a name="-less-than-or-equal-to" />(<=) Mindre end eller lig med
...
#### <a name="-an-exact-character-match" />('') Tegn, der stemmer nøjagtigt overens
...
#### <a name="-case-insensitive" />(@) Ingen forskel på store og små bogstaver

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`@man*`|Tekst, der starter med **man**, og der skelnes mellem store og små bogstaver.|  

#### <a name="-an-indefinite-number-of-unknown-characters" />(*) Mange ukendte tegn
...
#### <a name="-one-unknown-character" />(?) Ét ukendt tegn

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`Hans?n`|Tekst som f.eks. **Hansen** eller **Hanson**|  

#### <a name="combined-format-expressions" />Kombinerede formatudtryk
...
### <a name="a-namefiltertokens-afilter-tokens" /><a name="FilterTokens"> </a>Filtertokens
...
#### <a name="me-or-userid-records-assigned-to-you" />(%me eller %userid) Poster, der er tildelt til dig
...
#### <a name="mycustomers-customers-in-my-customers" />(%mycustomers) Debitorer i Mine debitorer
...
#### <a name="myitems-items-in-my-items" />(%myitems) Varer i Mine varer
...
#### <a name="myvendors-vendors-in-my-vendors" />(%myvendors) Kreditorer i Mine kreditorer
