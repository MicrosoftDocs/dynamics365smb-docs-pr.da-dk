---
title: 'Sortering af, søgning i og filtrering af lister'
...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a>Sortering, søgning og filtrering
...
## <a name="searching"></a><a name="searching"></a><a name="searching"></a>Søgning
...
> [!TIP]
> Du kan trykke på <kbd>F3</kbd> for at aktivere og deaktivere søgefeltet. Du kan finde flere oplysninger i [Tastaturgenveje](keyboard-shortcuts.md#KeyboardFilter).

> [!NOTE]  
> Søgning matcher ikke værdier i billeder, BLOB-felter, FlowFilter, FlowField og andre felter, der ikke er en del af en tabel.


### <a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a>Finjustere søgningen med filterkriterier
...
### <a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a>Filtrere med indstillingsfelter
...
### <a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a>Angive filtre på lister
...
Hvis du vil have vist filterruden for kolonne på en liste, skal du vælge rullepilen og derefter vælge handlingen **Filter**. Du kan også trykke på <kbd>Skift</kbd>+<kbd>F3</kbd>. Filterruden åbnes med den valgte kolonne vist som filterfelt i sektionen **Filtrer listen efter**.
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a>Angive filtre i rapporter, kørsler og XMLporte
...
## <a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a>Angivelse af filterkriterier
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Filterkriterier og -operatorer
...
#### <a name="-interval"></a><a name="-interval"></a><a name="-interval"></a>(..) Interval
...
#### <a name="124-eitheror"></a><a name="124-eitheror"></a><a name="124-eitheror"></a>(&#124;) Enten/eller

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`1200|1300`|Tal med 1200 eller 1300.|  

#### <a name="-not-equal-to"></a><a name="-not-equal-to"></a><a name="-not-equal-to"></a>(<>) Ikke lig med
...
#### <a name="-greater-than"></a><a name="-greater-than"></a><a name="-greater-than"></a>(>) Større end

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>1200`|Tal større end 1200|  

#### <a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a>(>=) Større end eller lig med

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>=1200`|Tal lig med eller større end 1200|  

#### <a name="-less-than"></a><a name="-less-than"></a><a name="-less-than"></a>(<) Mindre end

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`<1200`|Tal mindre end 1200|  

#### <a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a>(<=) Mindre end eller lig med

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`<=1200`|Tal lig med eller mindre end 1200|  

#### <a name="-and"></a><a name="-and"></a><a name="-and"></a>(&) Og

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>200&<1200`|Tal større end 200 og mindre end 1200|  

#### <a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a>('') Tegn, der stemmer nøjagtigt overens
...
#### <a name="-case-insensitive"></a><a name="-case-insensitive"></a><a name="-case-insensitive"></a>(@) Ingen forskel på store og små bogstaver

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`@man*`|Tekst, der starter med **man**, og der skelnes mellem store og små bogstaver.|  

#### <a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a>(*) Mange ukendte tegn
...
#### <a name="-one-unknown-character"></a><a name="-one-unknown-character"></a><a name="-one-unknown-character"></a>(?) Ét ukendt tegn

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`Hans?n`|Tekst som f.eks. **Hansen** eller **Hanson**|  

#### <a name="combined-format-expressions"></a><a name="combined-format-expressions"></a><a name="combined-format-expressions"></a>Kombinerede formatudtryk
...
### <a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="symbols"></a>Filtrere på værdier, der indeholder symboler
...
### <a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="FilterTokens"> </a>Filtertokens
...
#### <a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a>(%me eller %userid) Poster, der er tildelt til dig
...
#### <a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a>(%mycustomers) Debitorer i Mine debitorer
...
#### <a name="myitems-items-in-my-items"></a><a name="myitems-items-in-my-items"></a><a name="myitems-items-in-my-items"></a>(%myitems) Varer i Mine varer
...
#### <a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a>(%myvendors) Kreditorer i Mine kreditorer
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/search-filter-sort-data-dynamics-365-business-central/)
