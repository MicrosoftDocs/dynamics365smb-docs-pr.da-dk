...
### <a name="to-set-up-service-declaration-manually" />Konfigurere servicedeklaration manuelt
...
### <a name="using-services-in-document-lines" />Bruge servicer i dokumentlinjer
