...
---
# <a name="the-service-declaration-extension"></a><a name="the-service-declaration-extension"></a>Udvidelsen af Servicedeklaration
...
## <a name="enable-the-service-declaration-extension"></a><a name="enable-the-service-declaration-extension"></a>Aktivere udvidelsen af Servicedeklaration
...
## <a name="set-up-the-service-declaration-extension"></a><a name="set-up-the-service-declaration-extension"></a>Konfigurere udvidelsen af Servicedeklaration

Du kan konfigurere udvidelsen manuelt eller ved hjælp af en rapporteringsfil i definitioner af dataudveksling.

### <a name="to-set-up-service-declaration-manually"></a><a name="to-set-up-service-declaration-manually"></a>Konfigurere servicedeklaration manuelt
...
### <a name="items"></a><a name="items"></a>Varer
...
### <a name="resources"></a><a name="resources"></a>Ressourcer
...
### <a name="item-charges"></a><a name="item-charges"></a>Varegebyrer
...
## <a name="create-new-service-declaration"></a><a name="create-new-service-declaration"></a>Opret en ny serviceerklæring
...
## <a name="modify-a-service-declaration"></a><a name="modify-a-service-declaration"></a>Tilpas en serviceerklæring
...
## <a name="overview-the-service-declaration-lines"></a><a name="overview-the-service-declaration-lines"></a>Oversigt over serviceerklæringslinjer
...
## <a name="report-service-declaration-in-a-file"></a><a name="report-service-declaration-in-a-file"></a>Rapporten serviceerklæring i en fil
...
## <a name="other-considerations"></a><a name="other-considerations"></a>Andre overvejelser
...
### <a name="grouping-lines"></a><a name="grouping-lines"></a>Gruppering af linjer
...
### <a name="using-services-in-document-lines"></a><a name="using-services-in-document-lines"></a>Bruge servicer i dokumentlinjer
