...
# <a name="sales-quick-start" />Salg, Hurtig start
...
## <a name="set-up-items-to-sell" />Sådan oprettes varer til salg
...
### <a name="set-up-a-new-item" />Opret en ny vare
...
## <a name="set-up-customers" />Sådan oprettes debitorer
...
### <a name="set-up-a-new-customer" />Opret en ny debitor
...
## <a name="create-a-sales-order" />Oprette en salgsordre
...
### <a name="to-create-a-sales-order" />Sådan oprettes en salgsordre
...
## <a name="create-a-sales-invoice" />Opret en salgsfaktura
...
### <a name="to-create-and-post-a-sales-invoice" />Sådan oprettes og bogføres en salgsfaktura
