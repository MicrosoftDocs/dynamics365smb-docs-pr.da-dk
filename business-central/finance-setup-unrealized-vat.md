---
title: Oprette urealiseret moms
...
# <a name="set-up-unrealized-vat-for-cash-based-accounting"></a>Konfigurere urealiseret moms til kasseregnskab

Hvis du bruger kassebaserede regnskabsmetoder, kan du konfigurere [!INCLUDE[prod_short](includes/prod_short.md)] til at håndtere urealiseret moms.
...
| Procent | Betalinger dækker både moms og fakturabeløb i forhold til den procentmæssige andel af det samlede fakturabeløb. Det betalte momsbeløb overføres fra den urealiserede momskonto til den realiserede momskonto. |
