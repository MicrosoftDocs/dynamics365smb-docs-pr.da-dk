...
# <a name="data-ownership-models" />Modeller for ejerskab af data
...
## <a name="team-ownership" />Teamejerskab
...
## <a name="choosing-a-different-business-unit" />Sådan vælger du en anden afdeling
...
## <a name="person-ownership" />Personejerskab
