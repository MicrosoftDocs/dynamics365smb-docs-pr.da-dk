...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a>Designoplysninger: Reservation, ordresporing og aktionsmeddelelser
...
### <a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a>Modregning i reservationer
...
### <a name="manual-reservation"></a><a name="manual-reservation"></a>Manuel reservation
...
### <a name="automatic-reservations"></a><a name="automatic-reservations"></a>Automatiske reservationer
...
## <a name="order-tracking"></a><a name="order-tracking"></a>Ordresporing
...
### <a name="the-order-network"></a><a name="the-order-network"></a>Ordrenetværket
...
### <a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a>Modregning i ordresporing
...
### <a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a>Eksempel: Ordresporing i Salg, Produktion og Overførsler
...
### <a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a>Løbenumre 8 og 9
...
### <a name="entry-numbers-10"></a><a name="entry-numbers-10"></a>Løbenumre 10
...
### <a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a>Løbenumre 8 og 9
...
### <a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a>Løbenumre 12 og 16
...
### <a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a>Løbenummer 21 og 22
...
## <a name="action-messaging"></a><a name="action-messaging"></a>Aktionsmeddelelser
...
## <a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a>Ordresporing og planlægning
...
### <a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a>Planlægningssystemet kontra ordresporing og aktionsmeddelelser
