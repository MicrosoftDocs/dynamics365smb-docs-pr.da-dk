...
---
# <a name="flows-for-production-assembly-and-jobs" />Flows til produktion, montage og sager
...
## <a name="overview-of-different-configuration-options" />Oversigt over forskellige konfigurationsindstillinger
...
### <a name="inbound-flow-put-away" />Indgående flow (læg-på-lager)
...
### <a name="outbound-flow-pick" />Udgående flow (pluk)
...
## <a name="warehouses-without-dedicated-warehouse-activity" />Lagersteder uden dedikeret lageraktivitet
...
## <a name="basic-warehouse-configuration" />Grundlæggende lageropsætninger
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration" />Flows til og fra produktion i en grundlæggende lageropsætning
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration" />Flows til og fra montage i en grundlæggende lageropsætning
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration" />Flows til projektstyring i en grundlæggende lageropsætning
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations" />Flows til og fra produktion i en avanceret lageropsætning
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations" />Flows til og fra montage i en avanceret lageropsætning
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations" />Flows til projektstyring i en avancerede lageropsætninger
