...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Designoplysninger: Centrale begreber i planlægningssystemet
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a><a name="planning-parameters"></a>Planlægningsparametre
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a><a name="planning-starting-date"></a>Planlægningsstartdato
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Dynamisk ordresporing (udligning)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Dynamisk ordresporing kontra planlægningssystemet
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Rækkefølge og prioritet i planlægningen
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Vareprioritet/laveste-niveau-kode
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Optimere ydeevnen for beregninger med lavt niveau
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Lokationer / prioritet af overførselsniveau
...
### <a name="order-priority"></a><a name="order-priority"></a><a name="order-priority"></a>Prioritering for ordrer
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Behovsprognoser og rammeordrer
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a><a name="planning-assignment"></a>Planlægningsopgave
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a><a name="item-dimensions"></a>Varedimensioner
...
## <a name="item-attributes"></a><a name="item-attributes"></a><a name="item-attributes"></a>Vareattributter
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a><a name="specific-attributes"></a>Specifikke attributter
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Ikke-specifikke attributter
...
## <a name="warnings"></a><a name="warnings"></a><a name="warnings"></a>Advarsler
...
### <a name="emergency"></a><a name="emergency"></a><a name="emergency"></a>Nødsituation
...
### <a name="exception"></a><a name="exception"></a><a name="exception"></a>Undtagelse
...
### <a name="attention"></a><a name="attention"></a><a name="attention"></a>Bemærk
...
## <a name="error-logs"></a><a name="error-logs"></a><a name="error-logs"></a>Fejllogfiler
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a><a name="planning-flexibility"></a>Planlægningsfleksibilitet
...
## <a name="order-planning"></a><a name="order-planning"></a><a name="order-planning"></a>Ordreplanlægning
...
## <a name="finite-loading"></a><a name="finite-loading"></a><a name="finite-loading"></a>Begrænset belastning
