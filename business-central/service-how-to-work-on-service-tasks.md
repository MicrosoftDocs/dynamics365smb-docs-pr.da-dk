...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Arbejde med serviceopgaver
...
## <a name="to-work-on-a-service-task" />Sådan arbejdes med serviceopgaver
...
## <a name="to-register-service-operations" />Sådan registreres servicehandlinger
...
## <a name="to-register-spare-parts" />Registrere reservedele
...
## <a name="to-register-spare-parts-from-a-service-order" />Sådan registreres reservedele fra en serviceordre
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />Som erstattes en serviceartikel eller en serviceartikelkomponent
...
## <a name="to-change-the-response-time-for-a-service-item-line" />Ændre svartiden for en serviceartikellinje
...
## <a name="to-register-faultresolution-codes" />Sådan registreres fejl/løsningskoder
