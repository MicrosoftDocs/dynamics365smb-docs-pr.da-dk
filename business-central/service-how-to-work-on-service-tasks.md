...
ms.author: edupont
---
# <a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a>Arbejde med serviceopgaver
...
## <a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a>Sådan arbejdes med serviceopgaver
...
## <a name="to-register-service-operations"></a><a name="to-register-service-operations"></a>Sådan registreres servicehandlinger
...
## <a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a>Registrere reservedele
...
## <a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a>Sådan registreres reservedele fra en serviceordre
...
## <a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a>Som erstattes en serviceartikel eller en serviceartikelkomponent
...
## <a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a>Ændre svartiden for en serviceartikellinje
...
## <a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a>Sådan registreres fejl/løsningskoder
