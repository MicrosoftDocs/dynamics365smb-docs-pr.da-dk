...
# <a name="work-with-catalog-items"></a><a name="work-with-catalog-items"></a>Arbejde med katalogvarer
...
## <a name="create-a-catalog-item"></a><a name="create-a-catalog-item"></a>Oprette en katalogvare
...
## <a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering"></a><a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering"></a>Angive, hvordan katalogvarenumre konverteres til din egen nummerering
...
## <a name="convert-a-catalog-item-to-a-normal-item"></a><a name="convert-a-catalog-item-to-a-normal-item"></a>Konvertere en katalogvare til en almindelig vare
...
## <a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item"></a><a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item"></a>Sådan sælges en katalogvare og konverteres til en almindelig vare
