...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes" />Arbejde med servicekontrakter og servicekontrakttilbud
...
## <a name="to-create-a-service-contract-or-service-contract-quote" />Sådan oprettes en servicekontrakt eller et servicekontrakttilbud
...
## <a name="to-convert-a-service-contract-quote-to-service-contract" />Sådan konverteres servicekontrakttilbud til servicekontrakter
...
## <a name="to-create-contract-service-credit-memos" />Sådan oprettes kontraktservicekreditnotaer
...
## <a name="updating-and-evaluating-contracts" />Opdatere og evaluere kontrakter
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote" />Sådan føjes en kontraktlinje til en servicekontrakt eller et kontrakttilbud
...
## <a name="to-remove-contract-lines" />Sådan fjernes kontraktlinjer
...
## <a name="service-line-cost-and-value" />Omkostninger og værdi for servicelinje
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />Sådan føjes en kontraktrabat til servicekontrakttilbud
...
## <a name="to-change-the-owner-of-a-service-contract" />Sådan udskiftes indehaveren af en servicekontrakt
...
## <a name="to-update-a-service-contract-price" />Opdateres en servicekontraktpris
...
## <a name="to-post-prepaid-contract-entries" />Sådan bogføres forudbetalte kontraktposter
...
## <a name="changing-the-service-contract-status" />Ændring af status for servicekontrakten
...
## <a name="to-cancel-a-service-contract" />Sådan annulleres en servicekontrakt
...
## <a name="filing-a-service-contract-or-contract-quote" />Arkivere en servicekontrakt eller et kontrakttilbud
