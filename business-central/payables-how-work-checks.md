...
ms.author: edupont
---
# <a name="make-check-payments" />Foretage betalinger med check
...
## <a name="to-pay-a-vendor-invoice-with-a-computer-check" />Sådan betales en kreditorfaktura med en computercheck
...
## <a name="to-cancel-printed-checks-that-are-not-posted" />Sådan annulleres udskrevne checks, der ikke er blevet bogført
...
## <a name="to-void-checks" />Sådan annulleres checks
...
## <a name="to-view-a-summary-of-posted-checks" />Sådan får du vist en oversigt over bogførte checks
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-checks-dynamics-365-business-central" />Se relateret [Microsoft-træning](/training/modules/use-checks-dynamics-365-business-central/)
