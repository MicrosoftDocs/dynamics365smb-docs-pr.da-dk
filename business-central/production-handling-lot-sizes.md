...
# <a name="handling-lot-sizes-in-production"></a><a name="handling-lot-sizes-in-production"></a>Håndtering af lotstørrelser i produktionen
...
## <a name="units-of-measure-in-production-bill-of-materials"></a><a name="units-of-measure-in-production-bill-of-materials"></a>Måleenheder i produktionsstyklister
...
## <a name="lot-size-on-routing-lines"></a><a name="lot-size-on-routing-lines"></a>Lotstørrelse på rutelinjer
...
## <a name="lot-sizes-for-items-and-stockkeeping-units"></a><a name="lot-sizes-for-items-and-stockkeeping-units"></a>Lotstørrelser for varer og lagervarer
...
## <a name="lot-size-on-item-and-stockkeeping-units"></a><a name="lot-size-on-item-and-stockkeeping-units"></a>Lotstørrelser for varer og lagervarerenheder
