...
# <a name="set-up-company-consolidation" />Konfigurere virksomhedskonsolidering
...
## <a name="simple-consolidation-setup" />Simpel konsolideringsopsætning
...
## <a name="advanced-consolidation-setup" />Avanceret konsolideringskonfiguration
...
### <a name="set-up-the-consolidated-company" />Konfigurere det konsoliderede regnskab
...
### <a name="a-namebusunitaadd-business-units" /><a name="busunit"></a>Tilføj virksomhedsenheder
...
### <a name="a-nameglaccaprepare-general-ledger-accounts-for-consolidation" /><a name="glacc"></a>Klargøre finanskonti til konsolidering
...
### <a name="a-nameexchratesaspecify-exchange-rates-for-consolidations" /><a name="exchrates"></a>Angiv kurser for konsolideringer
...
### <a name="a-namedimainclude-or-exclude-dimensions" /><a name="dim"></a>Medtag eller Udelad dimensioner
...
### <a name="a-nameexcludeaexclude-a-company-from-consolidation" /><a name="exclude"></a>Udelukke en virksomhed fra konsolideringen
...
### <a name="a-nameincludeainclude-a-partially-owned-company-in-consolidation" /><a name="include"></a>Inkludere en delvis ejet virksomhed i konsolideringen
