...
### <a name="add-business-units" /><a name="busunit"></a>Tilføj virksomhedsenheder
...
### <a name="prepare-general-ledger-accounts-for-consolidation" /><a name="glacc"></a>Klargøre finanskonti til konsolidering
...
### <a name="specify-exchange-rates-for-consolidations" /><a name="exchrates"></a>Angiv kurser for konsolideringer
...
### <a name="include-or-exclude-dimensions" /><a name="dim"></a>Medtag eller Udelad dimensioner
...
### <a name="exclude-a-company-from-consolidation" /><a name="exclude"></a>Udelukke en virksomhed fra konsolideringen
...
### <a name="include-a-partially-owned-company-in-consolidation" /><a name="include"></a>Inkludere en delvis ejet virksomhed i konsolideringen
