...
# <a name="set-up-company-consolidation"></a>Opsætte virksomhedskonsolidering
...
#### <a name="create-a-business-unit"></a>Opret en afdeling
...
4. I oversigtspanelet **Dataimport** skal du i feltet **Standarddataimport** angive, hvordan du vil dele finansposter med det konsoliderede regnskab:
   ...
   * Hvis du vil dele data mellem virksomheder i forskellige miljøer, skal du vælge **API** og derefter udfylde feltet **Slutpunkt for API**.
        ...
        Hvis du vil hente URL-adressen til slutpunktet i koncernvirksomhedsvirksomheden [!INCLUDE [prod_short](includes/prod_short.md)], skal du åbne siden**Konsolideringsopsætning** og kontrollere feltværdien for API-slutpunktet i det aktuelle miljø. 
...
> [!NOTE]
> Hvis du ikke udfylder feltet **Kons.debetkonto.** og **Consol. Credit Acc.** felter, antager [!INCLUDE [prod_short](includes/prod_short.md)], at de er knyttet til de samme konti i det konsoliderede regnskab.

> [!TIP]
> Der kan være situationer, hvor du ikke ønsker at medtage en konto i en konsolidering. Hvis koncernregnskabet f.eks. kun skal afspejle balancerne fra datterselskaberne. Hvis du vil udelukke en konto fra konsolidering, skal du aktivere til/fra-knappen **Udeluk fra konsolidering** for kontoen.
