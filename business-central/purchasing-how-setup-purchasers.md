...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Oprette indkøbere
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Sådan oprettes indkøbere
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Sådan tildeles indkøbere til leverandører
