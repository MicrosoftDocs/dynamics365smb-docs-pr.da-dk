...
description: 'Få mere at vide om, hvordan du konfigurerer Business Central i det lokale miljø til at integrere med OneDrive til arbejde eller skole (tidligere kendt som OneDrive for Business).'
author: jswymer
ms.topic: conceptual
...
ms.reviewer: jswymer
---
# Konfigurere OneDrive-integration med Business Central i det lokale miljø

[!INCLUDE[azure-ad-to-microsoft-entra-id](~/../shared-content/shared/azure-ad-to-microsoft-entra-id.md)]

Denne artikel beskriver, hvordan du konfigurerer OneDrive til arbejde eller skole (tidligere kendt som OneDrive for Business) integration med Business Central i det lokale miljø. Til forskel for [!INCLUDE[prod_short](includes/prod_short.md)] online er forbindelsen mellem Business Central og OneDrive ikke konfigureret automatisk. Hvis forbindelsen ikke er konfigureret, kan brugere ikke bruge funktionerne til OneDrive.
...
- Hvis appen i **Konfigurer dine Microsoft Entra-konti** er den samme som appen i **Konfiguration af SharePoint-forbindelse**, vil OneDrive-integrationen bruge den samme app som før, bortset fra konfigurationen under opsætningen **Konfigurer dine Microsoft Entra-konti**.
