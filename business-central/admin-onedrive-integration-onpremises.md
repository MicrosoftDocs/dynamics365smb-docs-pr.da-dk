...
## <a name="register-an-app-in-azure-ad-for-onedrive-integration"></a><a name="registerapp"></a>Registrere en app i Azure AD til OneDrive-integration
...
## <a name="set-up-the-connection-in-prod_short-version-19-and-20"></a>Konfigurere forbindelsen i [!INCLUDE[prod_short](includes/prod_short.md)] version 19 og 20
