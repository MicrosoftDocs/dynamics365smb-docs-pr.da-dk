...
ms.author: jswymer
---
# <a name="configuring-onedrive-integration-with-business-central-on-premises" />Konfigurere OneDrive-integration med Business Central On-premises
...
## <a name="register-an-app-in-azure-ad-for-onedrive-integration" /><a name="registerapp"></a>Registrere en app i Azure AD til OneDrive-integration
...
## <a name="get-your-onedrive-url" /><a name="url"></a>Hent din OneDrive-URL-adresse
...
### <a name="run-onedrive-setup" />Køre Opsætning af OneDrive
...
## <a name="set-up-the-connection-in--version-19-and-20" />Konfigurere forbindelsen i [!INCLUDE[prod_short](includes/prod_short.md)] version 19 og 20
...
## <a name="switching-from-legacy-sharepoint-to-new-onedrive-integration" />Skifte fra ældre SharePoint til ny OneDrive-integration
...
### <a name="about-switching-to-the-new-onedrive-integration" /><a name="onedrivesetupmigration"></a>Om at skifte til den nye OneDrive-integration
...
#### <a name="how-the-changes-affect-the-integration" />Sådan påvirker ændringerne integrationen
...
### <a name="run-onedrive-setup-to-switch-to-the-new-onedrive-integration" />Kør OneDrive-opsætningen for at skifte til den nye OneDrive-integration
