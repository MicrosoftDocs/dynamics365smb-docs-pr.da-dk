...
ms.author: bholtorf
---
# <a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick"></a><a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick"></a>Aktivere automatisk nedbrydning med styret læg-på-lager og pluk
...
## <a name="breakbulk-in-picks"></a><a name="breakbulk-in-picks"></a>Nedbryde i pluk
...
## <a name="breakbulk-in-put-aways"></a><a name="breakbulk-in-put-aways"></a>Nedbryde i læg-på-lager
...
## <a name="breakbulk-in-movements"></a><a name="breakbulk-in-movements"></a>Nedbryde i bevægelse
