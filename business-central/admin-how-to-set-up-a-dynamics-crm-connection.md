...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Opret forbindelse til Microsoft Dataverse
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />Sådan bruger du vejledningen Dataverse-forbindelsesopsætning med assisteret opsætning
...
### <a name="to-create-or-maintain-the-connection-manually" />Sådan oprettes eller vedligeholdes forbindelsen manuelt
...
## <a name="customize-the-match-based-coupling" />Tilpas den matchbaserede sammenkædning
...
### <a name="view-the-results-of-the-coupling-job" />Vis resultaterne af sammenkædningssagen
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Opgradere forbindelser fra Business Central Online for at bruge certifikatbaseret godkendelse
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />Opgradere forbindelser fra Business Central Online til brug certifikatbaseret godkendelse
...
## <a name="connecting-on-premises-versions" />Tilslutning af lokale versioner
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />Sådan registrerer du et program i Azure AD for at oprette forbindelse fra Business Central til Dataverse
