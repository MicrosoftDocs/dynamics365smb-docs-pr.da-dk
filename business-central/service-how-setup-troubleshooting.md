...
# <a name="setting-up-troubleshooting-for-service-items" />Opsætning af fejlfinding for serviceartikler
...
## <a name="to-set-up-troubleshooting-guidelines" />Definere retningslinjer for fejlfinding
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />Sådan tildeles retningslinjer for fejlfinding til varer, serviceartikler eller serviceartikelgrupper.
