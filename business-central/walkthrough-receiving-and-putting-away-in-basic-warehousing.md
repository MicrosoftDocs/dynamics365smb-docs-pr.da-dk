...
---
# <a name="walkthrough-receiving-and-putting-away-in-basic-warehouse-configurations" />Gennemgang: Modtagelse og placering på lager i grundlæggende lageropsætninger
...
### <a name="to-set-up-the-location" />Sådan oprettes lokationen
...
## <a name="create-the-purchase-order" />Oprette købsordren

Købsordrer er den mest almindelige type indgående kildedokument.  

### <a name="to-create-the-purchase-order" />Hvis du vil oprette købsordren
...
## <a name="receive-and-put-the-items-away" />Modtage varerne og lægge dem på lager
...
### <a name="to-receive-and-put-the-items-away" />Sådan modtager du varerne og lægger dem på lager
