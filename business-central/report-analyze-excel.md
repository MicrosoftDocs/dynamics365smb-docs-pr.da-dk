...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml"></a><a name="analyzing-report-data-with-excel-and-xml"></a>Analyse af rapportdata med Excel og XML
...
## <a name="more-about-excel-data-only"></a><a name="more-about-excel-data-only"></a>Mere om Excel (kun data)
...
## <a name="for-administrators"></a><a name="for-administrators"></a>Til administratorer
...
## <a name="for-developers-and-advanced-users"></a><a name="for-developers-and-advanced-users"></a>For udviklere og erfarne brugere
