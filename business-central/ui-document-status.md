...
## <a name="release-process"></a><a name="release-process"></a>Frigivelsesproces
...
### <a name="approval-procedures"></a><a name="approval-procedures"></a>Godkendelsesprocedurer
...
## <a name="reopen-a-released-order"></a><a name="reopen-a-released-order"></a>Genåbne en frigivet ordre
