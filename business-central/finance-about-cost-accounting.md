...
ms.author: edupont
---
# <a name="about-cost-accounting" />Om omkostningsregnskab
...
## <a name="workflow-in-cost-accounting" />Arbejdsgang i omkostningsregnskab
...
## <a name="cost-types-cost-centers-and-cost-objects" />Omkostningstyper, omkostningssteder og omkostningsobjekter
...
## <a name="cost-entries-and-cost-journals" />Omkostningsposter og omkostningskladder
...
## <a name="cost-allocations" />Omkostningsfordelinger
...
## <a name="cost-budgets" />Omkostningsbudgetter
...
## <a name="cost-reporting" />Rapportering af omkostninger
