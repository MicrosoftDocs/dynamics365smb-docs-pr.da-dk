...
description: 'Få at vide, hvordan du rapporterer handel med virksomheder i andre EU-lande med Intrastat-systemet.'
author: altotovi
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a>Arbejde med Intrastat-rapportering
...
## <a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a>Udfylde Intrastat-rapporten
...
4. Angiv den måned, der skal rapporteres data for, i feltet **Statistikperiode**. Angiv perioden som et fircifret tal uden mellemrum eller symboler. Afhængigt af dit land skal du angive enten måneden først og derefter året eller omvendt. Skriv f.eks. enten *2206* eller *0622* for juni 2022.
...
## <a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a>Redigere Intrastat-rapporten
...
## <a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a>Validere Intrastat-linjer
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Genberegne vægt eller supplerende måleenhed
...
### <a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a>Rapportering af anlægsaktiver
...
### <a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a>Intrastat-rapportstatusser
