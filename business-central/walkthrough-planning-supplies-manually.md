...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-manually" />Gennemgang: Manuel planlægning af forsyninger
...
## <a name="setting-up-the-sample-data" />Oprette eksempeldata
...
## <a name="use-the-order-planning-page" />Bruge siden Ordreplanlægning
...
### <a name="to-use-the-order-planning-page" />Sådan bruges siden Ordreplanlægning
...
## <a name="planning-a-purchase-order-to-fulfill-component-demand" />Planlægge en købsordre for at opfylde et komponentbehov
 I denne procedure opretter du en købsordre til manglende produktionskomponenter.  

### <a name="to-plan-a-purchase-order-to-fulfill-component-need-in-production" />Sådan planlægges en købsordre for at opfylde et komponentbehov i produktionen
...
## <a name="planning-a-transfer-order-to-fulfill-sales-demand" />Planlægge en overflytningsordre for at opfylde et salgsbehov
...
### <a name="to-plan-a-transfer-order-to-fulfill-sales-demand" />Sådan planlægges en overflytningsordre til opfyldning af et salgsbehov.
...
## <a name="planning-a-multilevel-production-order-to-fulfill-sales-demand" />Planlægge en Produktionsordre med flere niveauer for at opfylde et salgsbehov
...
### <a name="to-plan-multilevel-production-to-fulfill-sales-demand" />Sådan planlægges en produktion med flere niveauer for at opfylde et salgsbehov
...
### <a name="to-plan-a-specific-production-order" />Sådan planlægges en specifik produktionsordre
