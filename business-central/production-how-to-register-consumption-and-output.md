...
ms.author: edupont
---
# <a name="register-consumption-and-output-for-one-released-production-order-line" />Registrere forbrug og afgang for én frigivet produktionsordrelinje
...
## <a name="to-register-consumption-and-output" />Sådan registreres forbrug og afgang
