...
## <a name="to-create-an-item-category" />Sådan oprettes en varekategori
...
## <a name="to-assign-an-item-category-to-an-item" />Sådan tildeles en varekategori til en vare
