...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts" />Registrere interaktioner med kontakter
...
## <a name="setting-up-interaction-templates" />Konfiguration af interaktionsskabeloner
...
## <a name="creating-interactions" />Oprette interaktioner
...
## <a name="viewing-and-managing-recorded-interactions" />Visning og administration af registrerede interaktioner
