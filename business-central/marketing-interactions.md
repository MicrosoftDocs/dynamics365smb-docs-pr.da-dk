...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Registrere interaktioner med kontakter
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Konfiguration af interaktionsskabeloner
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a>Oprette interaktioner
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Visning og administration af registrerede interaktioner
