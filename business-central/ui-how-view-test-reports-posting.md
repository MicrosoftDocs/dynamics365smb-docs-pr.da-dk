...
ms.author: solsen
---
# <a name="view-test-reports-before-posting" />Vise testrapporter inden bogføring
...
## <a name="to-print-a-test-report-before-posting-a-purchase-invoice" />Sådan udskrives en kontrolrapport før bogføringen af en købsfaktura
