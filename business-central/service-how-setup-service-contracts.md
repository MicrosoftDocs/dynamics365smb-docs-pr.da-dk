...
# <a name="set-up-service-contracts"></a><a name="set-up-service-contracts"></a>Opsætte servicekontrakter
...
## <a name="to-set-up-a-service-contract-group"></a><a name="to-set-up-a-service-contract-group"></a>Sådan defineres servicekontraktgrupper
...
## <a name="to-set-up-a-service-contract-account-group"></a><a name="to-set-up-a-service-contract-account-group"></a>Sådan oprettes servicekontraktkontogrupper
...
## <a name="to-set-up-a-contract-template"></a><a name="to-set-up-a-contract-template"></a>Sådan oprettes kontraktskabeloner
...
## <a name="to-set-up-a-customer-template"></a><a name="to-set-up-a-customer-template"></a>Sådan oprettes debitorskabeloner
