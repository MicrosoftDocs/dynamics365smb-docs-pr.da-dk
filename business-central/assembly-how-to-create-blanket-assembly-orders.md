...
ms.author: edupont
---
# <a name="create-blanket-assembly-orders" />Oprette rammemontageordrer
...
## <a name="to-create-a-blanket-assembly-order-for-an-assemble-to-order-item" />Sådan oprettes en rammemontageordre til en montage\-til\-ordre-vare
