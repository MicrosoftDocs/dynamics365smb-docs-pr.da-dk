...
ms.author: edupont
---
# <a name="set-up-general-fixed-assets-information" />Angive generelle oplysninger om anlægsaktiver
...
## <a name="to-set-up-general-default-values-for-fixed-assets" />Sådan defineres generelle standardværdier for anlæg
...
## <a name="to-set-up-fixed-asset-posting-groups" />Sådan oprettes anlægsbogføringsgrupper
...
## <a name="to-set-up-fixed-asset-allocation-keys" />Sådan defineres allokeringsnøgler for anlægsaktiver
...
## <a name="to-set-up-fixed-asset-journal-templates" />Sådan defineres anlægskladdetyper
...
## <a name="to-set-up-fixed-asset-journal-batches" />Sådan defineres anlægskladdenavne
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates" />Sådan defineres anlægsomposteringskladdetyper
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />Sådan defineres anlægsomposteringskladdenavne
...
## <a name="to-set-up-fixed-asset-class-codes" />Sådan angives anlægsartskoder
...
## <a name="to-set-up-fixed-asset-subclass-codes" />Sådan angives anlægsgruppekoder
...
## <a name="to-set-up-fixed-asset-location-codes" />Sådan angives anlægslokationskoder
...
## <a name="to-register-opening-entries" />Sådan registreres åbningsposter
