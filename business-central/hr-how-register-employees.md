...
ms.author: edupont
---
# <a name="register-employees" />Registrere medarbejdere
...
## <a name="adding-new-employees" />Tilføje nye ansatte
...
## <a name="to-set-up-an-employee" />Sådan oprettes en medarbejder
...
## <a name="to-insert-a-picture-of-an-employee" />Sådan indsætte et billede af en medarbejder
...
## <a name="to-register-various-information-about-an-employee" />Sådan registreres forskellige oplysninger om en medarbejder
