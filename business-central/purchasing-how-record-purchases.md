...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders" />Registrere køb med købsfakturaer og ordrer
...
## <a name="record-purchases-with-purchase-invoices" />Registrere køb med købsfakturaer
...
### <a name="create-a-and-post-purchase-invoice" />Oprette og bogføre købsfaktura
...
## <a name="posted-invoices" />Bogførte fakturaer
...
## <a name="purchasing-non-inventory-items" />Køb af varer, der ikke er lagervarer
...
## <a name="when-to-use-purchase-orders" />Hvornår skal købsordrer bruges?
...
## <a name="receive-items-with-a-purchase-order" />Modtage varer med en købsordre
...
## <a name="receive-more-items-than-ordered" />Modtage flere varer end det bestilte antal
...
### <a name="set-up-over-receipts" />Konfigurere overmodtagelser
...
### <a name="assign-the-over-receipt-code-to-an-item" />Overmodtagelseskoden knyttes til varen
...
### <a name="over-receive-an-order" />Modtagelse af flere ordrer
...
## <a name="external-document-number" />Eksterne bilagsnumre

[!INCLUDE [ext-doc-no-purch](includes/ext-doc-no-purch.md)]

## <a name="posting-purchases" />Bogføring af køb
...
## <a name="see-related-microsoft-trainingtrainingmodulesreceive-invoice-dynamics-d365-business-centralindex" />Se relateret [Microsoft-træning](/training/modules/receive-invoice-dynamics-d365-business-central/index).

## <a name="see-related-microsoft-trainingtrainingmodulesprocessing-invoices-dynamics-365-business-centralindex" />Se relateret [Microsoft-træning](/training/modules/processing-invoices-dynamics-365-business-central/index)
