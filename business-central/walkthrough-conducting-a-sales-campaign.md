...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign"></a><a name="walkthrough-conducting-a-sales-campaign"></a>Gennemgang: Gennemførsel af en salgskampagne
...
## <a name="setting-up-a-campaign"></a><a name="setting-up-a-campaign"></a>Oprette en kampagne
...
### <a name="to-set-up-a-campaign"></a><a name="to-set-up-a-campaign"></a>Sådan oprettes en kampagne
...
## <a name="selecting-the-target-audience"></a><a name="selecting-the-target-audience"></a>Vælge målgruppe
...
### <a name="to-create-a-segment-with-the-relevant-contacts"></a><a name="to-create-a-segment-with-the-relevant-contacts"></a>Sådan oprettes en målgruppe med de relevante kontakter
...
### <a name="to-save-your-segmentation-criteria"></a><a name="to-save-your-segmentation-criteria"></a>Sådan gemmes målgruppekriterier
...
## <a name="mining-the-data"></a><a name="mining-the-data"></a>Søge efter data
...
### <a name="to-remove-contacts-from-the-segment"></a><a name="to-remove-contacts-from-the-segment"></a>Sådan fjernes kontakter fra målgruppen
...
### <a name="to-bring-back-the-removed-contacts"></a><a name="to-bring-back-the-removed-contacts"></a>Sådan tilbageføres de fjernede kontaktpersoner
...
## <a name="linking-a-segment-to-a-campaign"></a><a name="linking-a-segment-to-a-campaign"></a>Knytte en målgruppe til en kampagne
...
### <a name="to-link-a-segment-to-the-campaign"></a><a name="to-link-a-segment-to-the-campaign"></a>Sådan knyttes en målgruppe til kampagnen
...
## <a name="sending-letters-and-email-messages-to-contacts"></a><a name="sending-letters-and-email-messages-to-contacts"></a>Sende breve og mails til kontakter
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact"></a><a name="to-use-a-segment-to-send-a-letter-to-a-contact"></a>Bruge en målgruppe til at sende et brev til en kontakt
...
### <a name="to-send-an-email-message-to-a-contact"></a><a name="to-send-an-email-message-to-a-contact"></a>Sende en mail til en kontakt
...
## <a name="registering-campaign-responses"></a><a name="registering-campaign-responses"></a>Registrere kampagnesvar
...
### <a name="to-register-campaign-responses"></a><a name="to-register-campaign-responses"></a>Sådan registreres kampagnesvar.
