...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Gennemgang: Gennemførsel af en salgskampagne
...
## <a name="setting-up-a-campaign" />Oprette en kampagne
...
### <a name="to-set-up-a-campaign" />Sådan oprettes en kampagne
...
## <a name="selecting-the-target-audience" />Vælge målgruppe
...
### <a name="to-create-a-segment-with-the-relevant-contacts" />Sådan oprettes en målgruppe med de relevante kontakter
...
### <a name="to-save-your-segmentation-criteria" />Sådan gemmes målgruppekriterier
...
## <a name="mining-the-data" />Søge efter data
...
### <a name="to-remove-contacts-from-the-segment" />Sådan fjernes kontakter fra målgruppen
...
### <a name="to-bring-back-the-removed-contacts" />Sådan tilbageføres de fjernede kontaktpersoner
...
## <a name="linking-a-segment-to-a-campaign" />Knytte en målgruppe til en kampagne
...
### <a name="to-link-a-segment-to-the-campaign" />Sådan knyttes en målgruppe til kampagnen
...
## <a name="sending-letters-and-email-messages-to-contacts" />Sende breve og mails til kontakter
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact" />Bruge en målgruppe til at sende et brev til en kontakt
...
### <a name="to-send-an-email-message-to-a-contact" />Sende en mail til en kontakt
...
## <a name="registering-campaign-responses" />Registrere kampagnesvar
...
### <a name="to-register-campaign-responses" />Sådan registreres kampagnesvar.
