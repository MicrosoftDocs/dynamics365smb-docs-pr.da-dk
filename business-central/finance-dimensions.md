...
---
# <a name="work-with-dimensions"></a><a name="work-with-dimensions"></a>Arbejde med dimensioner
...
## <a name="analyzing-by-dimensions"></a><a name="analyzing-by-dimensions"></a>Analyse efter dimensioner
...
## <a name="dimension-sets"></a><a name="dimension-sets"></a>Dimensionsgrupper
...
## <a name="setting-up-dimensions"></a><a name="setting-up-dimensions"></a>Oprette dimensioner
...
### <a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts"></a><a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts"></a>Sådan konfigureres standarddimensioner for kunder, leverandører og andre konti
...
### <a name="to-set-up-default-dimension-priorities"></a><a name="to-set-up-default-dimension-priorities"></a>Sådan oprettes prioritering af standarddimensioner
...
### <a name="to-set-up-dimension-combinations"></a><a name="to-set-up-dimension-combinations"></a>Sådan oprettes kombinationer af dimensioner
...
### <a name="to-set-up-global-and-shortcut-dimensions"></a><a name="to-set-up-global-and-shortcut-dimensions"></a>Sådan oprettes globale dimensioner og genvejsdimensioner
...
#### <a name="to-change-global-dimensions"></a><a name="to-change-global-dimensions"></a>Sådan ændres globale dimensioner
...
### <a name="example-of-dimension-setup"></a><a name="example-of-dimension-setup"></a>Eksempel på dimensionsopsætning
...
## <a name="getting-an-overview-of-dimensions-used-multiple-times"></a><a name="getting-an-overview-of-dimensions-used-multiple-times"></a>Få et overblik over dimensioner, der bruges flere gange
...
## <a name="use-dimensions"></a><a name="use-dimensions"></a>Bruge dimensioner
...
### <a name="to-view-global-dimensions-in-ledger-entry-pages"></a><a name="to-view-global-dimensions-in-ledger-entry-pages"></a>Sådan får du vist globale dimensioner på sider med poster
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/dimensions-dynamics-365-business-central/index)
