...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Gennemgang: Automatisk planlægning af forsyninger
...
### <a name="to-create-stockkeeping-units" />Sådan oprettes lagervarer
...
### <a name="to-change-selected-planning-parameters" />Ændre valgte planlægningsparametre
...
## <a name="creating-a-regenerative-supply-plan" />Oprette en total forsyningsplan
...
### <a name="to-create-the-sales-order" />Sådan oprettes salgsordren
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />Sådan oprettes en totalplan for at opfylde behovet på lokationen EAST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />Beregne MRP for at medtage underliggende komponentbehov
...
## <a name="analyzing-the-planning-result" />Analyse af planlægningsresultatet
...
### <a name="to-check-the-planning-parameter" />Kontrollere planlægningsparameteren
...
### <a name="to-view-more-order-tracking-entries" />Få vist flere ordresporingsposter
...
## <a name="carrying-out-action-messages" />Udføre aktionsmeddelelser
 Erik konverterer nu de foreslåede planlægningslinjer til forsyningsordrer ved hjælp af funktionen **Udfør aktionsmeddl.**.  

### <a name="to-automatically-create-the-suggested-supply-orders" />Sådan oprettes de forslåede forsyningsordrer automatisk.
...
## <a name="creating-a-net-change-plan" />Oprette en nettoplan
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />Sådan oprettes det nye salgsbehov og en tilsvarende genplanlægning
...
## <a name="analyzing-the-changed-planning-result" />Analyse af det ændrede planlægningsresultatet
...
### <a name="to-view-an-existing-order" />Sådan får du vist en eksisterende ordre
