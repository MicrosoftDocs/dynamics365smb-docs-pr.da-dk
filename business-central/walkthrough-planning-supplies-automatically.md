...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a>Gennemgang: Automatisk planlægning af forsyninger
...
### <a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a>Sådan oprettes lagervarer
...
### <a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a>Ændre valgte planlægningsparametre
...
## <a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a>Oprette en total forsyningsplan
...
### <a name="to-create-the-sales-order"></a><a name="to-create-the-sales-order"></a><a name="to-create-the-sales-order"></a>Sådan oprettes salgsordren
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a>Sådan oprettes en totalplan for at opfylde behovet på lokationen EAST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a>Beregne MRP for at medtage underliggende komponentbehov
...
## <a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a>Analyse af planlægningsresultatet
...
### <a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a>Få vist ordresporingsposter for vare 1300
...
### <a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a>Kontrollere planlægningsparameteren
...
### <a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a>Få vist flere ordresporingsposter
...
## <a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a>Udføre aktionsmeddelelser
 Erik konverterer nu de foreslåede planlægningslinjer til forsyningsordrer ved hjælp af funktionen **Udfør aktionsmeddl.**.  

### <a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a>Sådan oprettes de forslåede forsyningsordrer automatisk.
...
## <a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a>Oprette en nettoplan
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a>Sådan oprettes det nye salgsbehov og en tilsvarende genplanlægning
...
## <a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a>Analyse af det ændrede planlægningsresultatet
...
### <a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a>Få vist ordresporingsposter for vare 1250
...
### <a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a>Sådan får du vist en eksisterende ordre
