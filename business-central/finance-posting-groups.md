...
ms.author: bholtorf
---
# <a name="set-up-posting-groups" />Konfigurere bogføringsgrupper
...
## <a name="general-posting-groups" />Generelle bogføringsgrupper
...
## <a name="specific-posting-groups" />Specifikke bogføringsgrupper
...
### <a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents" />Tillade erstatnings debitor- eller kreditorbogføringsgrupper på dokumenter
...
## <a name="tax-posting-groups" />Momsbogføringsgrupper
...
## <a name="example-of-linking-posting-groups" />Eksempel på sammenkædning af bogføringsgrupper
...
## <a name="copying-posting-setup-lines" />Kopiere bogføringsopsætningslinjer
...
## <a name="set-up-posting-groups-on-the-go" />Konfigurere bogføringsgrupper på farten
...
## <a name="troubleshooting-posting-group-errors" />Fejlfinding i forbindelse med bogføringsgruppefejl
...
## <a name="see-related-microsoft-trainingtrainingmodulesposting-groups-dynamics--business-central" />Se relateret [Microsoft-træning](/training/modules/posting-groups-dynamics-365-business-central/)
