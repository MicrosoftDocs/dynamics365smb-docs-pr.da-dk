...
ms.author: bholtorf
---
# <a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a>Konfigurere bogføringsgrupper
...
## <a name="general-posting-groups"></a><a name="general-posting-groups"></a>Generelle bogføringsgrupper
...
## <a name="specific-posting-groups"></a><a name="specific-posting-groups"></a>Specifikke bogføringsgrupper
...
### <a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents"></a><a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents"></a>Tillade erstatnings debitor- eller kreditorbogføringsgrupper på dokumenter
...
## <a name="tax-posting-groups"></a><a name="tax-posting-groups"></a>Momsbogføringsgrupper
...
## <a name="example-of-linking-posting-groups"></a><a name="example-of-linking-posting-groups"></a>Eksempel på sammenkædning af bogføringsgrupper
...
## <a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a>Kopiere bogføringsopsætningslinjer
...
## <a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a>Konfigurere bogføringsgrupper på farten
...
## <a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a>Fejlfinding i forbindelse med bogføringsgruppefejl
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/posting-groups-dynamics-365-business-central/)
