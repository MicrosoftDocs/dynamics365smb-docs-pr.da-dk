...
ms.search.form: 9171
---
# <a name="manage-user-profiles" />Administrere brugerprofiler
...
## <a name="to-create-a-profile" />Sådan oprettes en profil
...
## <a name="to-copy-a-profile" />Sådan kopieres en profil
...
## <a name="to-edit-a-profile" />Sådan redigeres en profil
...
## <a name="to-assign-a-profile-to-a-user" />Sådan tildeles en profil til en bruger
...
## <a name="to-define-user-settings-for-a-profile" />Sådan defineres brugerindstillinger for en profil
...
## <a name="to-activate-a-profile" />Sådan aktiveres en profil
...
## <a name="to-export-profiles" />Sådan eksporterer du profiler
...
## <a name="to-import-profiles" />Sådan importerer du profiler
...
## <a name="to-delete-a-profile" />Sådan slettes en profil
...
## <a name="to-delete-all-personalizations-made-by-a-user" />Sådan slettes alle tilpasninger, der er foretaget af en bruger
...
## <a name="to-delete-personalizations-for-specific-pages" />Sådan slettes tilpasninger for bestemte sider
...
## <a name="managing-user-sessions" />Administrere brugersessioner
...
## <a name="see-related-microsoft-training" />Se relateret [Microsoft-træning](/training/modules/users-security-dynamics-365-business-central/)
