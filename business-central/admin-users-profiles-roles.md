...
## <a name="assign-a-profile-to-a-user"></a>Tildele en profil til en bruger
...
## <a name="define-user-settings-for-a-profile"></a>Definere brugerindstillinger for en profil
...
## <a name="activate-a-profile"></a>Aktivér en profil
...
## <a name="import-profiles"></a>Importér profiler
...
## <a name="delete-personalizations"></a>Slet tilpasninger

### <a name="delete-all-personalizations-made-by-a-specific-user"></a>Slet alle tilpasninger, der er foretaget af en bestemt bruger
...
### <a name="delete-personalizations-for-specific-pages"></a>Slet tilpasninger for bestemte sider
