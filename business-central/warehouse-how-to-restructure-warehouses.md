...
## <a name="to-restructure-a-basic-warehouse-that-uses-bins-only" />Sådan omstruktureres et grundlæggende lager, der kun bruger placeringer
...
## <a name="to-restructure-an-advanced-warehouse-that-uses-directed-put-away-and-pick" />Sådan omstruktureres et avanceret lager, hvor der bruges styret læg-på-lager og pluk
...
## <a name="to-delete-a-bin" />Sådan slettes en placering
...
## <a name="to-rename-a-bin-and-change-the-bin-code-in-all-records" />Sådan omdøbes en placering, og sådan ændres placeringskoden i alle poster
