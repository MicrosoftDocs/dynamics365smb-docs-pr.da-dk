...
ms.author: bholtorf
---
# <a name="register-new-vendors"></a><a name="register-new-vendors"></a>Registrere nye kreditorer
...
## <a name="adding-new-vendors"></a><a name="adding-new-vendors"></a>Tilføjelse af nye kreditorer
...
### <a name="to-create-a-new-vendor"></a><a name="to-create-a-new-vendor"></a>Sådan oprettes en ny kreditor
...
### <a name="deleting-and-editing-vendor-information"></a><a name="deleting-and-editing-vendor-information"></a>Slette og redigere kreditoroplysninger
...
## <a name="to-save-the-vendor-card-as-a-template"></a><a name="to-save-the-vendor-card-as-a-template"></a>Sådan gemmes kreditorkortet som en skabelon
