...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Administrere brugerindstillinger og præferencer
...
## <a name="types-of-user-settings" />Typer af brugerindstillinger
...
## <a name="overview-of-all-user-specific-changes" />Oversigt over alle brugerspecifikke ændringer
...
## <a name="to-review-or-delete-user-personalizations" />Sådan gennemser eller sletter du brugertilpasninger
