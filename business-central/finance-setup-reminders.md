...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels" />Konfiguration af rykkerbetingelser og -niveauer

Du kan bruge rykkere til at minde debitorer om forfaldne beløb. [!INCLUDE [reminder-terms](includes/reminder-terms.md)]

## <a name="reminder-terms" />Rykkerbetingelser
...
### <a name="to-set-up-reminder-terms" />Sådan defineres rykkerbetingelser
...
## <a name="reminder-levels" />Rykkerniveauer
...
### <a name="to-set-up-reminder-levels" />Sådan angives rykkerniveauer
...
## <a name="see-related-microsoft-training" />Se relateret [Microsoft-træning](/training/modules/send-reminders-dynamics-365-business-central/)
