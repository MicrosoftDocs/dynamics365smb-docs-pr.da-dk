...
# <a name="troubleshooting-and-correcting-dimensions" />Fejlfinding og korrigering af dimensioner
...
## <a name="troubleshooting-dimensions-errors" />Fejlfinding af dimensioner
...
## <a name="changing-dimension-assignments-after-posting" />Ændring af dimensionstildelinger efter bogføring
...
### <a name="setting-up-dimension-corrections" />Opsætning af dimensionsrettelser
...
### <a name="correcting-a-dimension" />Rettelse af en dimension
...
### <a name="validating-dimension-corrections" />Validering af dimensionsrettelser
...
### <a name="undoing-a-correction" />Annullering af en rettelse
...
### <a name="dimension-corrections-on-large-data-sets" />Dimensionsrettelser i store datasæt
...
### <a name="use-analysis-views-with-dimension-corrections" />Brug af analysevisninger med dimensionsrettelser
...
### <a name="viewing-historical-dimension-corrections" />Visning af historiske dimensionsrettelser

Hvis en finanspost er blevet rettet, kan du undersøge ændringen ved at bruge handlingen **Oversigt over dimensionsrettelser**.

### <a name="handling-incomplete-corrections" />Håndtering af ufuldstændige rettelser
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Brug af omkostningsregnskab med rettede finansposter
...
## <a name="see-related-microsoft-training" />Se relateret [Microsoft-træning](/training/modules/dimensions-dynamics-365-business-central/)
