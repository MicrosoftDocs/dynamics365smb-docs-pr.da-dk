...
# <a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a>Fejlfinding og korrigering af dimensioner
...
## <a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a>Fejlfinding af dimensioner
...
## <a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a>Ændring af dimensionstildelinger efter bogføring
...
### <a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a>Opsætning af dimensionsrettelser
...
### <a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a>Rettelse af en dimension
...
### <a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a>Validering af dimensionsrettelser
...
### <a name="undoing-a-correction"></a><a name="undoing-a-correction"></a><a name="undoing-a-correction"></a>Annullering af en rettelse
...
### <a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a>Dimensionsrettelser i store datasæt
...
### <a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a>Brug af analysevisninger med dimensionsrettelser
...
### <a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a>Visning af historiske dimensionsrettelser

Hvis en finanspost er blevet rettet, kan du undersøge ændringen ved at bruge handlingen **Oversigt over dimensionsrettelser**.

### <a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a>Håndtering af ufuldstændige rettelser
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a>Brug af omkostningsregnskab med rettede finansposter
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/dimensions-dynamics-365-business-central/)
