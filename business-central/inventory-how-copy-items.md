...
ms.author: edupont
---
# <a name="copy-existing-items-to-create-new-items" />Kopiere eksisterende varer for at oprette nye varer
...
## <a name="to-copy-an-existing-item-to-a-new-item" />Sådan kopieres en eksisterende vare til en ny vare
