...
ms.author: bholtorf
---
# <a name="set-up-items-and-locations-for-directed-put-away-and-pick" />Konfigurere varer og lokationer til styret læg-på-lager og pluk
...
## <a name="to-set-up-an-item-for-directed-put-away-and-pick" />Sådan opsættes varer til styret læg-på-lager og pluk
...
## <a name="to-start-using-directed-put-away-and-pick" />Begynd at bruge styret læg-på-lager og pluk
...
## <a name="to-set-up-a-zone-in-your-warehouse" />Sådan oprettes en zone på lagerstedet
