...
### <a name="vendors" />Leverandører (Kreditorer)
...
## <a name="file-size-requirements" />Krav til størrelsen af filer
...
## <a name="to-migrate-data" />Sådan overføres data
...
## <a name="viewing-the-status-of-the-migration" />Få vist status for overførslen
...
## <a name="how-to-avoid-double-posting" />Sådan undgås dobbeltbogføring
...
## <a name="correcting-errors" />Rette fejl
...
## <a name="verifying-data-after-migrating" />Kontrol af data efter overførsel
...
## <a name="stopping-data-migration" />Stoppe dataoverførslen
