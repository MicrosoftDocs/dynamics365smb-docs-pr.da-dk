...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>Udvidelsen C5-dataoverførsel
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>Hvilke data overføres?
...
### <a name="vendors"></a><a name="vendors"></a>Leverandører (Kreditorer)
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a>Krav til størrelsen af filer
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a>Sådan overføres data
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Få vist status for overførslen
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>Sådan undgås dobbeltbogføring
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a>Rette fejl
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Kontrol af data efter overførsel
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Stoppe dataoverførslen
