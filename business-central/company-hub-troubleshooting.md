...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub"></a><a name="troubleshooting-your-company-hub"></a>Fejlfinding i virksomhedens hub
...
## <a name="check-errors"></a><a name="check-errors"></a>Kontrollér fejl
...
## <a name="connection-failed"></a><a name="connection-failed"></a>Der kunne ikke oprettes forbindelse
...
## <a name="data-does-not-refresh"></a><a name="data-does-not-refresh"></a>Data opdateres ikke
