...
# <a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a>Arbejde med kalenderdatoer og klokkeslæt
...
## <a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a>Kontrollere internationale og sproglige indstillinger
...
### <a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a>Vælge datoer i kalenderen
...
### <a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a>Mønsteret dag\-uge\-år
...
### <a name="digit-patterns"></a><a name="digit-patterns"></a>Talmønstre
...
### <a name="closing-date"></a><a name="closing-date"></a>Ultimodato
...
## <a name="setting-ranges"></a><a name="setting-ranges"></a><a name="BKMK_SettingDateRanges"></a> Angive intervaller
...
## <a name="use-date-formulas"></a><a name="use-date-formulas"></a>Bruge dataformularer
...
## <a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a>Indtastning af kombineret dato/klokkeslæt
