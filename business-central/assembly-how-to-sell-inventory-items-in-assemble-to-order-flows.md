...
---
# <a name="selling-inventory-items-in-assemble-to-order-flows" />Sådan sælges lagervarer i montage efter ordre-forløb
...
## <a name="to-sell-inventory-items-in-assemble-to-order-flows" />Sådan sælges lagervarer i montage efter ordre-forløb
...
## <a name="see-related-microsoft-trainingtrainingmodulesassemble-to-order-dynamics--business-central" />Se relateret [Microsoft-træning](/training/modules/assemble-to-order-dynamics-365-business-central/)
