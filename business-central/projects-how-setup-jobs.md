...
---
# <a name="set-up-projects-prices-and-project-posting-groups"></a>Oprette projekter, priser og projektbogføringsgrupper
...
### <a name="synchronize-the-cost-of-used-items"></a>Synkronisere prisen på brugte varer
