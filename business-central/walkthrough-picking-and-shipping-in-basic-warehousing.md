...
---
# <a name="walkthrough-picking-and-shipping-in-basic-warehouse-configurations" />Gennemgang: Pluk og forsendelse i grundlæggende lageropsætninger
...
### <a name="setting-up-the-bin-codes" />Indstilling af placeringskoder

Når du har oprettet lokationen, skal du tilføje to placeringer.

#### <a name="to-setup-the-bin-codes" />Indstilling af placeringskoder

1. Vælg handlingen **Placeringer**.
2. Opret to placeringer med koderne *S-01-0001* og *S-01-0002*.

### <a name="making-yourself-a-warehouse-employee-at-location-south" />Selv oprette en lagermedarbejder på lokationen SYD

Hvis du vil bruge denne funktion, skal du føje dig selv til lokationen som en lagermedarbejder. 

#### <a name="to-make-yourself-a-warehouse-employee" />Sådan oprettes en lagermedarbejder som en lagermedarbejder
...
## <a name="creating-the-sales-order" />Oprettelse af salgsordren
...
## <a name="picking-and-shipping-items" />Sådan plukkes og leveres varer
...
### <a name="to-pick-and-ship-items" />Sådan foretages pluk og levering af varer
