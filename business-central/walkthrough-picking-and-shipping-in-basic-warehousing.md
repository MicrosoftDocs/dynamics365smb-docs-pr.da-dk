...
---
# <a name="walkthrough-picking-and-shipping-in-basic-warehouse-configurations"></a><a name="walkthrough-picking-and-shipping-in-basic-warehouse-configurations"></a><a name="walkthrough-picking-and-shipping-in-basic-warehouse-configurations"></a>Gennemgang: Pluk og forsendelse i grundlæggende lageropsætninger
...
### <a name="setting-up-the-bin-codes"></a><a name="setting-up-the-bin-codes"></a><a name="setting-up-the-bin-codes"></a>Indstilling af placeringskoder

Når du har oprettet lokationen, skal du tilføje to placeringer.

#### <a name="to-setup-the-bin-codes"></a><a name="to-setup-the-bin-codes"></a><a name="to-setup-the-bin-codes"></a>Indstilling af placeringskoder

1. Vælg handlingen **Placeringer**.
2. Opret to placeringer med koderne *S-01-0001* og *S-01-0002*.

### <a name="making-yourself-a-warehouse-employee-at-location-south"></a><a name="making-yourself-a-warehouse-employee-at-location-south"></a><a name="making-yourself-a-warehouse-employee-at-location-south"></a>Selv oprette en lagermedarbejder på lokationen SYD

Hvis du vil bruge denne funktion, skal du føje dig selv til lokationen som en lagermedarbejder. 

#### <a name="to-make-yourself-a-warehouse-employee"></a><a name="to-make-yourself-a-warehouse-employee"></a><a name="to-make-yourself-a-warehouse-employee"></a>Sådan oprettes en lagermedarbejder som en lagermedarbejder
...
### <a name="making-item-1928-s-available"></a><a name="making-item-1928-s-available"></a><a name="making-item-1928-s-available"></a>Gør vare 1928-S tilgængelig
...
## <a name="creating-the-sales-order"></a><a name="creating-the-sales-order"></a><a name="creating-the-sales-order"></a>Oprettelse af salgsordren
...
## <a name="picking-and-shipping-items"></a><a name="picking-and-shipping-items"></a><a name="picking-and-shipping-items"></a>Sådan plukkes og leveres varer
...
### <a name="to-pick-and-ship-items"></a><a name="to-pick-and-ship-items"></a><a name="to-pick-and-ship-items"></a>Sådan foretages pluk og levering af varer
