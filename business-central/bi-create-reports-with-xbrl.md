...
ms.author: edupont
---
# <a name="create-reports-with-xbrl" />Oprette rapporter med XBRL
...
## <a name="xbrl-comprises-the-following-components" />XBRL består af følgende komponenter
...
## <a name="layered-taxonomies" />Niveaudelte taksonomier
...
## <a name="set-up-xbrl-lines" />Konfigurere XBRL-linjer
...
## <a name="import-an-xbrl-taxonomy" />Indlæse en XBRL-taksonomi
...
## <a name="update-an-xbrl-taxonomy" />Opdatere en XBRL-taksonomi
...
## <a name="see-related-training-at-microsoft-learn" />Se relateret træning på [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
