...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Oprette rapporter med XBRL
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>XBRL består af følgende komponenter
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Niveaudelte taksonomier
...
## <a name="linkbases"></a><a name="linkbases"></a>Linkbaser
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>Konfigurere XBRL-linjer
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Indlæse en XBRL-taksonomi
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Opdatere en XBRL-taksonomi
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Se relateret træning på [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
