...
# <a name="responding-to-requests-about-users-personal-data" />Svare på anmodninger om brugerens personlige oplysninger
...
## <a name="types-of-requests" />Typer af anmodninger
...
## <a name="restrict-data-processing-for-a-data-subject" />Begrænse databehandling for et dataemne
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Håndtering af dataemneanmodninger i prøveversion
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Eksportere data fra tabeller, der ikke er klassificeret af dataemnet
...
## <a name="handling-data-about-minors" />Håndtering af data om mindreårige
