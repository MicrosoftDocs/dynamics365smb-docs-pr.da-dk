...
# <a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a>Dataarkivudvidelsen
...
## <a name="start-archiving-data"></a><a name="start-archiving-data"></a>Start arkivering af data
...
## <a name="storage-considerations"></a><a name="storage-considerations"></a>Lagerovervejelser
