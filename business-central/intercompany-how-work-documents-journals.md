...
---
# <a name="work-with-intercompany-documents-and-journals" />Arbejde med koncerninterne dokumenter og kladder
...
## <a name="fill-in-and-send-an-intercompany-sales-order" />Udfylde og indsende en IC-salgsordre
...
## <a name="fill-in-and-post-an-intercompany-journal" />Udfylde og bogføre en IC-kladde
