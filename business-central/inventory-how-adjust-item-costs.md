...
ms.author: edupont
---
# <a name="adjust-item-costs" />Regulere varepriser
...
## <a name="to-adjust-item-costs-manually" />Sådan reguleres varekostpriser manuelt
...
## <a name="to-make-general-changes-in-the-direct-unit-cost" />Sådan foretages generelle rettelser af købspris
...
## <a name="understanding-unit-cost-calculation" />Om kostværdi pr. enhed
...
### <a name="costing-method-fifo-lifo-specific-or-average" />Kostmetoden FIFO, LIFO, Serienummer eller Gennemsnit
...
### <a name="costing-method-standard" />Kostmetoden Standard
