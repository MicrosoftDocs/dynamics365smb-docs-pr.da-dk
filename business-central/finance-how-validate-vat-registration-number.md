...
# <a name="validate-vat-registration-numbers" />Valider et SE/CVR-nr.
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically" />Konfigurere servicen til at kontrollere momsregistreringsnummeret automatisk
...
## <a name="validation-templates" />Valideringsskabeloner
