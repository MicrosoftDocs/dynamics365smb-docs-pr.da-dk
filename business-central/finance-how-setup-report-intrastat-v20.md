...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat"></a><a name="set-up-and-report-intrastat"></a><a name="set-up-and-report-intrastat"></a>Konfigurere og rapportere Intrastat
...
## <a name="required-and-optional-setups"></a><a name="required-and-optional-setups"></a><a name="required-and-optional-setups"></a>Krævede og valgfrie opsætninger
...
### <a name="to-set-up-intrastat-templates-and-batches"></a><a name="to-set-up-intrastat-templates-and-batches"></a><a name="to-set-up-intrastat-templates-and-batches"></a>Sådan oprettes Intrastatkladdetyper og -kladdenavne
...
### <a name="to-set-up-transport-methods"></a><a name="to-set-up-transport-methods"></a><a name="to-set-up-transport-methods"></a>Sådan defineres transportmåder
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a><a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a><a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a>Sådan angiver du, hvilke Intrastatrapportfelter der skal udfyldes
...
### <a name="czechia"></a><a name="czechia"></a><a name="czechia"></a>Tjekkiet

Specielt til tjekkiske virksomheder skal du også definere koder for varekoder og transaktioner.  

#### <a name="to-set-up-commodity-codes"></a><a name="to-set-up-commodity-codes"></a><a name="to-set-up-commodity-codes"></a>Sådan angives varekoder
...
#### <a name="to-set-up-transaction-nature-codes"></a><a name="to-set-up-transaction-nature-codes"></a><a name="to-set-up-transaction-nature-codes"></a>Sådan konfigurerer du koder for transaktionsarter
...
## <a name="to-report-intrastat"></a><a name="to-report-intrastat"></a><a name="to-report-intrastat"></a>Sådan rapporteres Intrastat
...
### <a name="to-fill-in-intrastat-journals"></a><a name="to-fill-in-intrastat-journals"></a><a name="to-fill-in-intrastat-journals"></a>Sådan udfyldes Intrastatkladder
...
### <a name="to-modify-intrastat-journals-lines"></a><a name="to-modify-intrastat-journals-lines"></a><a name="to-modify-intrastat-journals-lines"></a>Sådan ændres kladdelinjer i Intrastat-kladden
...
### <a name="report-intrastat-on-a-form-or-a-file"></a><a name="report-intrastat-on-a-form-or-a-file"></a><a name="report-intrastat-on-a-form-or-a-file"></a>Rapportere Intrastat i en formular eller en fil
...
### <a name="report-intrastat-in-a-file"></a><a name="report-intrastat-in-a-file"></a><a name="report-intrastat-in-a-file"></a>Rapportere Intrastat i en fil
...
## <a name="reorganize-intrastat-journals"></a><a name="reorganize-intrastat-journals"></a><a name="reorganize-intrastat-journals"></a>Reorganisere Intrastatkladder
...
## <a name="tariff-numbers"></a><a name="tariff-numbers"></a><a name="tariff-numbers"></a>Varekoder
