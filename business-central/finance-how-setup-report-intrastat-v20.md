...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat" />Konfigurere og rapportere Intrastat
...
## <a name="required-and-optional-setups" />Krævede og valgfrie opsætninger
...
### <a name="to-set-up-intrastat-templates-and-batches" />Sådan oprettes Intrastatkladdetyper og -kladdenavne
...
### <a name="to-set-up-transport-methods" />Sådan defineres transportmåder
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory" />Sådan angiver du, hvilke Intrastatrapportfelter der skal udfyldes
...
#### <a name="to-set-up-transaction-nature-codes" />Sådan konfigurerer du koder for transaktionsarter
...
## <a name="to-report-intrastat" />Sådan rapporteres Intrastat
...
### <a name="to-fill-in-intrastat-journals" />Sådan udfyldes Intrastatkladder
...
### <a name="to-modify-intrastat-journals-lines" />Sådan ændres kladdelinjer i Intrastat-kladden
...
### <a name="report-intrastat-on-a-form-or-a-file" />Rapportere Intrastat i en formular eller en fil
...
## <a name="reorganize-intrastat-journals" />Reorganisere Intrastatkladder
...
## <a name="tariff-numbers" />Varekoder
