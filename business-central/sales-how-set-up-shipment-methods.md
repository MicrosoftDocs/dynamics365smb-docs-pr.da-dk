...
ms.author: edupont
---
# <a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a>Oprette leveringsformer
...
## <a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a>Sådan defineres en leveringsform
