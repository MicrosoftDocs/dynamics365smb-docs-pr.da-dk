...
# <a name="ai-powered-item-marketing-text-preview-with-copilot-faq" />AI-styret marketingtekst med element (forhåndsversion) med Copilot Ofte stillede spørgsmål
...
### <a name="what-is-copilot" />Hvad er Copilot?
...
### <a name="why-isnt-copilot-available-for-marketing-text-on-my-items-in-business-central" />Hvorfor er Copilot ikke tilgængelig for marketingtekst på mine varer i Business central?
...
### <a name="is-copilot-available-for-preview-in-business-central-on-premises" />Er Copilot tilgængelig til forhåndsversion i Business Central lokalt?

Nej, det understøttes aktuelt ikke i Business Central lokalt.

### <a name="how-does-copilot-work-where-does-the-suggested-text-come-from" />Hvordan fungerer Copilot, hvor den foreslåede tekst kommer fra?
...
### <a name="whats-the-quality-of-the-text-suggested-by-copilot" />Hvad er kvaliteten af teksten, der foreslås af Copilot?
...
### <a name="how-can-i-improve-the-suggestions-i-get-from-copilot" />Hvordan kan jeg forbedre de forslag, jeg får fra Copilot?
...
### <a name="what-if-im-not-satisfied-with-the-generated-text" />Hvad gør jeg, hvis jeg ikke er tilfreds med den genererede tekst?
...
### <a name="can-admins-disable-copilot-if-so-how" />Kan administratorer deaktivere Copilot? Hvis ja, hvordan?
...
### <a name="does-copilot-work-with-languages-other-than-english" />Fungerer Copilot med andre sprog end engelsk?
...
### <a name="whats-done-about-abusive-and-harmful-text-suggestions" />Hvad sker der med stødende og skadelige tekstforslag?
...
### <a name="can-i-opt-out-of-the-logging-and-human-review-process" />Kan jeg framelde mig og +udføre menneskeligt gennemsyn?
...
### <a name="what-data-does-the-capability-collect-how-is-the-data-used" />Hvilke data indsamler funktionen? Hvordan bruges dataene?
