...
- Du skal bruge Business Central online som prøveversion eller i sandkassetilstand.
- Din version af Business central skal være **22.0.54157.54311 (forhåndsversion - CoPilot-udgave)**.

   Hvis du vil kontrollere versionen, skal du vælge spørgsmålstegnet i øverste højre hjørne og derefter **Hjælp og support**. Kig efter programversionen under **Fejlfinding**. Du kan finde flere oplysninger om, hvordan du får den korrekte prøveversion, ved at gå til [Introduktionen til Business Central, forhåndsversion - CoPilot-udgave](ai-preview-getstarted.md).
