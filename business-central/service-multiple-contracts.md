...
ms.author: edupont
---
# <a name="multiple-contracts" />Flere kontrakter
...
## <a name="creating-multiple-contracts-per-service-item" />Oprette flere kontrakter pr. serviceartikel
...
## <a name="copying-documents" />Kopiere linjer
...
## <a name="creating-service-orders-for-multiple-contracts" />Oprette serviceordrer for flere kontrakter
