...
## [Blive forhandler af Dynamics 365 Business Central](product-sell.md)
...
### [Microsoft Business Central-udvidelser fra andre leverandører](ui-extensions-other.md)
...
## [Om søgning og filtrering i Business Central](ui-search-filter-faq.md)
## [Angivelse af data](ui-enter-data.md)
## [Smarte notifikationer](ui-smart-notifications.md)
...
## [Tilføje og se noter i poster](ui-work-with-notes.md)
...
#### [Oprette bedste fremgangsmåder: Genbestillingspolitikker](reports-saving-reusing-settings.md)
#### [Oprette bedste fremgangsmåder: Planlægningsparametre](setup-best-practices-planning-parameters.md)
#### [Oprette bedste fremgangsmåder: Global planlægningsopsætning](setup-best-practices-global-planning-setup.md)
...
### [Vise A-skat](LocalFunctionality/Australia/how-to-view-withholding-tax-entries.md)
...
### [Udvidelsen Tax File Formats (DK)](ui-extensions-tax-file-formats-dk.md)
