...
ms.author: bholtorf
---
# <a name="create-service-invoices-or-credit-memos" />Oprette servicefakturaer eller -kreditnotaer
...
## <a name="to-invoice-several-service-contracts" />Sådan fakturerer du flere servicekontrakter
...
## <a name="to-invoice-a-service-contract-from-the-service-contract-page" />Sådan faktureres en servicekontrakt fra siden Servicekontrakt
...
## <a name="to-post-an-invoice-from-a-service-order" />Sådan bogføres fakturaer fra serviceordrer
...
## <a name="to-create-a-service-invoice-manually" />Sådan oprettes en servicefaktura manuelt
...
## <a name="to-create-an-invoice-that-combines-posted-shipment-lines-from-one-or-more-service-orders" />Sådan opretter du en faktura, der kombinerer bogførte leverancelinjer fra en eller flere serviceordrer
...
## <a name="to-create-a-service-credit-memo" />Sådan oprettes servicekreditnotaer
