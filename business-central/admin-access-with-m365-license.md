...
# <a name="business-central-access-with-microsoft-365-licenses" />Business Central-adgang med Microsoft 365-licenser
...
## <a name="why-enable-access-with-microsoft-365-licenses" />Hvorfor aktivere adgang med Microsoft 365-licenser
...
## <a name="use-rights" />Bruge rettigheder
...
 
### <a name="client-access" />Klientadgang
...
### <a name="use-of-objects" />Bruge objekter
...
## <a name="simplified-user-interface" />Forenklet brugergrænseflade
...
### <a name="requirements-to-enable-access" />Krav til at aktivere adgang

- [!INCLUDE [prod_short](includes/prod_short.md)] online (SaaS).

- Miljøer skal være af platformversion 21,1 eller nyere.

### <a name="requirements-for-individual-users-to-access-data-in-teams" />Krav til individuelle brugere med henblik på at få adgang til data i Teams
