...
ms.author: edupont
---
# <a name="set-up-time-sheets"></a><a name="set-up-time-sheets"></a><a name="set-up-time-sheets"></a>Konfigurere timesedler
...
## <a name="set-up-time-sheets-with-the-assisted-setup-guide"></a><a name="set-up-time-sheets-with-the-assisted-setup-guide"></a><a name="set-up-time-sheets-with-the-assisted-setup-guide"></a>Oprette timesedler med assisterende opsætningsvejledning
...
## <a name="set-up-time-sheets-manually"></a><a name="set-up-time-sheets-manually"></a><a name="set-up-time-sheets-manually"></a>Konfigurere timesedler manuelt
...
### <a name="to-set-up-general-information-for-time-sheets-manually"></a><a name="to-set-up-general-information-for-time-sheets-manually"></a><a name="to-set-up-general-information-for-time-sheets-manually"></a>Sådan angives generelle oplysninger for timesedler manuelt
...
### <a name="to-assign-a-time-sheet-administrator-manually"></a><a name="to-assign-a-time-sheet-administrator-manually"></a><a name="to-assign-a-time-sheet-administrator-manually"></a>Sådan tildeles en timeseddeladministrator manuelt
...
### <a name="to-assign-a-time-sheets-owner-and-approver-manually"></a><a name="to-assign-a-time-sheets-owner-and-approver-manually"></a><a name="to-assign-a-time-sheets-owner-and-approver-manually"></a>Sådan tildeles en timeseddelejer og -godkender manuelt
