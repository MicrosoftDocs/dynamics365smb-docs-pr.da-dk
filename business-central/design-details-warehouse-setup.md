...
ms.author: edupont
---
# <a name="design-details-warehouse-setup"></a><a name="design-details-warehouse-setup"></a><a name="design-details-warehouse-setup"></a>Designoplysninger: Opsætning af lager
...
## <a name="bin-and-bin-content"></a><a name="bin-and-bin-content"></a><a name="bin-and-bin-content"></a>Placering og placeringsindhold
...
[Designdetaljer: Tilgængelighed i lager](design-details-availability-in-the-warehouse.md)
