...
ms.author: edupont
---
# <a name="set-up-bank-accounts"></a><a name="set-up-bank-accounts"></a>Sådan oprettes bankkonti
...
## <a name="to-set-up-bank-accounts"></a><a name="to-set-up-bank-accounts"></a>Sådan oprettes bankkonti
...
## <a name="to-enter-an-opening-balance"></a><a name="to-enter-an-opening-balance"></a>Sådan angiver du en primosaldo
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a><a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a>Sådan oprettes bankkontoen for import eller eksport af bankfiler
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a><a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a>Sådan konfigureres kreditorbankkonti til eksport af bankfiler
...
## <a name="changing-your-bank-account"></a><a name="changing-your-bank-account"></a>Ændre din bankkonto
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/cash-management-dynamics-365-business-central/)
