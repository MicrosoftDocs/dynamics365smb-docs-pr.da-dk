...
ms.author: edupont
---
# <a name="set-up-bank-accounts" />Sådan oprettes bankkonti
...
## <a name="to-set-up-bank-accounts" />Sådan oprettes bankkonti
...
## <a name="to-enter-an-opening-balance" />Sådan angiver du en primosaldo
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files" />Sådan oprettes bankkontoen for import eller eksport af bankfiler
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files" />Sådan konfigureres kreditorbankkonti til eksport af bankfiler
...
## <a name="changing-your-bank-account" />Ændre din bankkonto
