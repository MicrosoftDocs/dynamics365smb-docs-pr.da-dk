...
### <a name="create-an-admin-role-group"></a><a name="create-an-admin-role-group"></a>Opret en administratorrollegruppe
...
### <a name="create-a-new-public-folder-mailbox"></a><a name="create-a-new-public-folder-mailbox"></a>Opret en ny postkasse til offentlige mapper
...
### <a name="create-new-public-folders"></a><a name="create-new-public-folders"></a>Oprette nye offentlige mapper
...
### <a name="set-public-folder-ownership"></a><a name="set-public-folder-ownership"></a>Angiv ejerskabet af mappen Delte
...
### <a name="mail-enable-the-queue-public-folder"></a><a name="mail-enable-the-queue-public-folder"></a>Aktiver den offentlige mappe *Kø* til mail
...
### <a name="mail-enable-sending-emails-to-the-queue-public-folder"></a><a name="mail-enable-sending-emails-to-the-queue-public-folder"></a>E-mail-Aktivér afsendelse af e-mails til den offentlige mappe *Kø*
