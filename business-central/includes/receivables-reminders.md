...
### <a name="to-create-a-reminder-automatically" />Sådan oprettes en rykker automatisk
...
### <a name="to-create-a-reminder-manually" />Sådan oprettes rykkere manuelt
...
### <a name="to-replace-reminder-texts" />Sådan erstattes rykkertekst
...
### <a name="to-issue-a-reminder" />Sådan udstedes en rykker
...
### <a name="to-cancel-an-issued-reminder" />Sådan annulleres en udstedt rykker
