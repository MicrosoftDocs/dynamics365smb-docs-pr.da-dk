...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>Sådan oprettes en rykker automatisk
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>Sådan oprettes rykkere manuelt
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>Sådan erstattes rykkertekst
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>Sådan udstedes en rykker
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>Sådan annulleres en udstedt rykker
