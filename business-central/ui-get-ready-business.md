...
Når du har udført en assisteret opsætningsvejledning, markeres den som **Afsluttet**. Når du vil udføre den assisterede opsætningsvejledning, skal du vælge de tre punktummer, den såkaldte genvejsmenu, og derefter kan du vælge **Start opsætning**.
