...
ms.author: jswymer
---
# <a name="create-interactions-on-contacts-and-segments"></a><a name="create-interactions-on-contacts-and-segments"></a><a name="create-interactions-on-contacts-and-segments"></a>Oprette interaktioner for kontakter og målgrupper
...
## <a name="to-create-an-interaction"></a><a name="to-create-an-interaction"></a><a name="to-create-an-interaction"></a>Sådan oprettes en interaktion
...
## <a name="to-finish-and-delete-postponed-interactions"></a><a name="to-finish-and-delete-postponed-interactions"></a><a name="to-finish-and-delete-postponed-interactions"></a>Sådan afsluttes og slettes udsatte interaktioner
1. Åbn kontakt-, sælger- eller interaktionslogposten.
2. Vælg **Udsatte interaktioner**.
3. Marker den interaktion, som du vil afslutte, og klik derefter på handlingen **Fortsæt**.

## <a name="to-create-an-interaction-on-a-segment"></a><a name="to-create-an-interaction-on-a-segment"></a><a name="to-create-an-interaction-on-a-segment"></a>Sådan oprettes en interaktion for en målgruppe
