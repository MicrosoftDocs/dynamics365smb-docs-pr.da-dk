...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations" />Designoplysninger: Søgning efter dimensionskombinationer
...
### <a name="finding-dimension-set-id" />Søgning efter dimensionsgruppe-id
