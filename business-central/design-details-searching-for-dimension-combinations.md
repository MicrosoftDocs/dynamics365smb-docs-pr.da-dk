...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a>Designoplysninger: Søgning efter dimensionskombinationer
...
## <a name="building-search-tree"></a><a name="building-search-tree"></a>Oprettelse af søgetræ
...
### <a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a>Søgning efter dimensionsgruppe-id
