...
# <a name="scheduling-a-synchronization-between-business-central-and-dataverse" />Planlægning af synkronisering mellem Business Central og Dataverse
...
## <a name="default-synchronization-job-queue-entries" />Poster i standardsynkroniseringsjobkø
...
## <a name="synchronization-process" />Synkroniseringsproces
...
## <a name="about-inactivity-timeouts" />Vedrørende inaktive timeoutperioder
...
## <a name="to-view-the-synchronization-job-log" />Sådan får du vist synkroniseringsjobloggen
...
## <a name="to-view-the-synchronization-job-log-from-the-table-mappings" />Sådan får du vist loggen over synkroniseringsjobbet fra tabeltilknytninger
...
## <a name="to-view-the-synchronization-error-log" />Sådan får du vist synkroniseringsfejlloggen
