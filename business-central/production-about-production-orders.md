...
ms.author: edupont
---
# <a name="about-production-orders" />Om produktionsordrer
...
## <a name="production-order-creation" />Oprette produktionsordrer
...
## <a name="limitations-on-production-order-creation" />Begrænsninger ved oprettelse af produktionsordrer
...
## <a name="production-order-status" />Produktionsordrestatus
...
### <a name="simulated-production-order" />Simuleret produktionsordre
...
### <a name="planned-production-order" />Planlagt produktionsordre
...
### <a name="firm-planned-production-order" />Fastlagt produktionsordre
...
### <a name="released-production-order" />Frigivet produktionsordre
...
### <a name="finished-production-order" />Færdig produktionsordre
...
## <a name="production-order-execution" />Udføre produktionsordrer
...
### <a name="material-consumption" />Materialeforbrug
...
### <a name="production-output" />Produktionsafgang
...
### <a name="posting-consumption-and-output" />Bogføre forbrug og afgang
...
### <a name="production-journal" />Produktionskladde
