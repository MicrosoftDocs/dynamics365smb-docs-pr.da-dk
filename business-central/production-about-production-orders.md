...
- De påvirker ikke ordreplanlægningen. Planlægning (hovedplanlægning og MRP) tager ikke højde for og påvirkes ikke af simulerede produktionsordrer. En simuleret produktionsordre kan heller ikke bruges som skabelon, fordi den forsvinder, når du ændrer dens status.  
