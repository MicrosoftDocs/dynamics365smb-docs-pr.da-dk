...
ms.author: edupont
---
# <a name="about-production-orders"></a><a name="about-production-orders"></a><a name="about-production-orders"></a>Om produktionsordrer
...
## <a name="production-order-creation"></a><a name="production-order-creation"></a><a name="production-order-creation"></a>Oprette produktionsordrer
...
## <a name="limitations-on-production-order-creation"></a><a name="limitations-on-production-order-creation"></a><a name="limitations-on-production-order-creation"></a>Begrænsninger ved oprettelse af produktionsordrer
...
## <a name="production-order-status"></a><a name="production-order-status"></a><a name="production-order-status"></a>Produktionsordrestatus
...
### <a name="simulated-production-order"></a><a name="simulated-production-order"></a><a name="simulated-production-order"></a>Simuleret produktionsordre
...
### <a name="planned-production-order"></a><a name="planned-production-order"></a><a name="planned-production-order"></a>Planlagt produktionsordre
...
### <a name="firm-planned-production-order"></a><a name="firm-planned-production-order"></a><a name="firm-planned-production-order"></a>Fastlagt produktionsordre
...
### <a name="released-production-order"></a><a name="released-production-order"></a><a name="released-production-order"></a>Frigivet produktionsordre
...
### <a name="finished-production-order"></a><a name="finished-production-order"></a><a name="finished-production-order"></a>Færdig produktionsordre
...
## <a name="production-order-execution"></a><a name="production-order-execution"></a><a name="production-order-execution"></a>Udføre produktionsordrer
...
### <a name="material-consumption"></a><a name="material-consumption"></a><a name="material-consumption"></a>Materialeforbrug
...
### <a name="production-output"></a><a name="production-output"></a><a name="production-output"></a>Produktionsafgang
...
### <a name="posting-consumption-and-output"></a><a name="posting-consumption-and-output"></a><a name="posting-consumption-and-output"></a>Bogføre forbrug og afgang
...
### <a name="production-journal"></a><a name="production-journal"></a><a name="production-journal"></a>Produktionskladde
