...
ms.author: bholtorf
---
# <a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a><a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a>Foretage betalinger med AMC Banking 365 Fundamentals-udvidelsen eller SEPA-kreditoverførsel
...
## <a name="setting-up-the-amc-banking-365-fundamentals-extension"></a><a name="setting-up-the-amc-banking-365-fundamentals-extension"></a>Konfigurere AMC Banking 365 Fundamentals-udvidelsen
...
## <a name="setting-up-sepa-credit-transfer"></a><a name="setting-up-sepa-credit-transfer"></a>Konfigurere SEPA-kreditoverførsel
...
### <a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a><a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a>Sådan opsættes en konto til SEPA-kreditoverførsler
...
### <a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a><a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a>Sådan opsættes et kreditorkort til SEPA-kreditoverførsler
...
### <a name="to-set-the-payment-journal-up-to-export-payment-files"></a><a name="to-set-the-payment-journal-up-to-export-payment-files"></a>Sådan opsættes betalingskladden til eksport af betalingsfiler
...
## <a name="preparing-the-payment-journal"></a><a name="preparing-the-payment-journal"></a>Forberede udbetalingskladden
...
## <a name="exporting-payments-to-a-bank-file"></a><a name="exporting-payments-to-a-bank-file"></a>Eksportere betalinger til en bankfil
...
### <a name="to-export-payments-to-a-bank-file"></a><a name="to-export-payments-to-a-bank-file"></a>Sådan eksporterer du betalinger til en bankfil
...
### <a name="to-plan-when-to-post-exported-payments"></a><a name="to-plan-when-to-post-exported-payments"></a>Sådan planlægger du, hvornår eksporterede betalinger skal bogføres
...
### <a name="to-re-export-payments-to-a-bank-file"></a><a name="to-re-export-payments-to-a-bank-file"></a>Sådan reeksporter du betalinger til en bankfil
...
## <a name="posting-the-payments"></a><a name="posting-the-payments"></a>Bogføre betalingerne
