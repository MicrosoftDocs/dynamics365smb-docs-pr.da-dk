...
ms.author: jswymer
---
# <a name="get-started-creating-report-layouts"></a><a name="get-started-creating-report-layouts"></a>Introduktion til oprettelse af rapportlayout
...
## <a name="decide-what-type-of-layout-you-want"></a><a name="decide-what-type-of-layout-you-want"></a><a name="decide"></a>Bestemme, hvilken type layout du vil bruge
...
## <a name="create-a-new-layout"></a><a name="create-a-new-layout"></a><a name="create"></a>Oprette et nyt layout
...
## <a name="modify-a-layout"></a><a name="modify-a-layout"></a><a name="modify"></a>Redigere et layout
...
## <a name="replace-a-layout"></a><a name="replace-a-layout"></a><a name="replace"></a>Erstat et layout
...
## <a name="rename-a-layout"></a><a name="rename-a-layout"></a><a name="rename"></a>Omdøbe et layout
