...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Designoplysninger: Bogføring af forventet kostpris
...
## <a name="prerequisites-for-posting-expected-costs" />Forudsætninger for bogføring af forventet kostpris
