...
ms.author: bholtorf
---
# <a name="tell-me-faq" />Ofte stillede spørgsmål om Fortæl mig
I denne artikel besvares spørgsmål, som erfarne brugere ofte stiller om funktionen Fortæl mig.

### <a name="are-all-actions-from-my-current-page-discoverable-in-tell-me" />Kan alle handlinger fra min aktuelle side registreres i Fortæl mig?

Nej. Handlinger i dele, f.eks. en salgslinjedelen eller faktabokse, vises ikke i Fortæl mig.

### <a name="are-the-results-in-tell-me-filtered-by-permissions" />Filtreres resultaterne i Fortæl mig efter rettigheder?
...
### <a name="does-tell-me-display-content-from-my-customizations-or-installed-third-party-extensions" />Viser Fortæl mig indhold fra mine tilpasninger eller installerede udvidelser fra tredjepart?
...
### <a name="what-makes-this-different-from-what-was-previously-known-as-page-search" />Hvordan adskiller denne funktion sig fra det, der tidligere blev kaldt sidesøgning?
...
### <a name="is-tell-me-available-for-all-form-factors" />Er Fortæl mig tilgængelig for alle formfaktorer?
...
### <a name="does-tell-me-give-me-help-on-how-to-use-pages-reports-and-other-things" />Vil jeg give mig hjælp til at bruge sider, rapporter og andre ting?
...
### <a name="why-dont-i-see-a-bookmark-icon-for-my-search-results" />Hvorfor vises der ikke et bogmærkeikon for mine søgeresultater?
