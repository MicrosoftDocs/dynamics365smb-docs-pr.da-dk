...
Nej, men du kan nemt få disse oplysninger fra Hjælp-ruden. Du skal blot vælge menupunktet **Hjælp** (spørgsmålstegnet i øverste højre hjørne) eller trykke på CTRL + F1 på tastaturet. Du kan finde flere oplysninger på [Ruden hjælp](product-help-and-support.md#help-pane).
