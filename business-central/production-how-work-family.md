...
ms.author: edupont
---
# <a name="work-with-production-families" />Arbejde med produktionsfamilier
...
## <a name="to-set-up-a-production-family" />Sådan oprettes en produktionsfamilie
...
## <a name="to-produce-based-on-a-production-family" />Sådan produceres på basis af en produktionsfamilie
