...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts" />Forstå Finans og Kontoplan
...
## <a name="general-ledger-setup-and-general-posting-setup" />Finansopsætning og bogføringsopsætning
...
## <a name="get-a-quick-overview" />Få et hurtigt overblik
...
## <a name="access-to-create-and-edit-accounts-and-account-categories" />Adgang til at oprette og redigere konti og kontokategorier
...
## <a name="see-related-microsoft-trainingtrainingmodulesbusiness-central-configure-general-ledger-setup" />Se relateret [Microsoft-træning](/training/modules/business-central-configure-general-ledger-setup/)
