...
I denne artikel får du nogle grundlæggende oplysninger om visning af Power BI-rapporter, inkl. scorecards; i [!INCLUDE [prod_short](includes/prod_short.md)].
...
#### Fra [!INCLUDE [prod_short](includes/prod_short.md)] on-premises

Oprettelse af forbindelse til Power BI fra [!INCLUDE [prod_short](includes/prod_short.md)] ligner online. Du kan også på siden **MICROSOFT ENTRA-TJENESTETILLADELSER** blive bedt om at give adgang til Power BI-tjenester. Hvis du vil tildele adgang, skal du vælge **Godkend Azure-tjenester** og derefter **Acceptér**.
