...
ms.author: edupont
---
# <a name="auditing-changes-in-business-central"></a><a name="auditing-changes-in-business-central"></a>Ændringer af revision i Business Central
...
## <a name="about-the-change-log"></a><a name="about-the-change-log"></a>Om ændringslog
...
### <a name="work-with-the-change-log"></a><a name="work-with-the-change-log"></a>Arbejde med ændringsloggen
...
## <a name="about-activity-logs"></a><a name="about-activity-logs"></a>Om aktivitetslogfiler
...
### <a name="work-with-activity-logs"></a><a name="work-with-activity-logs"></a>Arbejde med aktivitetslogge
...
## <a name="monitoring-sensitive-fields"></a><a name="monitoring-sensitive-fields"></a>Overvåge følsomme felter
...
### <a name="setting-up-field-monitoring"></a><a name="setting-up-field-monitoring"></a>Klargøring af Feltovervågning
...
### <a name="work-with-field-monitoring"></a><a name="work-with-field-monitoring"></a>Arbejde med feltovervågning
...
### <a name="viewing-field-monitoring-telemetry"></a><a name="viewing-field-monitoring-telemetry"></a>Få vist feltovervågningstelemetri
...
## <a name="defining-retention-policies"></a><a name="defining-retention-policies"></a>Definere opbevaringspolitikker
