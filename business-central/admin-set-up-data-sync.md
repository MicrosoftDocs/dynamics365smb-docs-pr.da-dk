...
# <a name="get-ready-to-synchronize-master-data" />Gør dig klar til at synkronisere stamdata
...
## <a name="uni-directional-synchronization-only" />Kun etvejs-synkronisering af debitorer
...
## <a name="specify-the-source-company" />Angive kilderegnskabet
...
## <a name="enable-or-disable-tables-and-fields" />Aktivere eller deaktivere tabeller og felter
...
### <a name="use-match-based-coupling" />Brug matchbaseret sammenkædning
...
## <a name="synchronize-for-the-first-time" />Synkronisere første gang
...
## <a name="add-or-delete-tables-from-the-synchronization-tables-list" />Tilføje eller slette tabeller på listen over synkroniseringstabeller

### <a name="add-a-table" />Tilføje en tabel
...
### <a name="delete-a-table" />Slet en tabel
...
## <a name="use-export-and-import-to-share-a-synchronization-setup" />Bruge Eksporter og Importer til at dele en synkroniseringsopsætning
