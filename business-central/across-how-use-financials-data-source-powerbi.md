...
## <a name="creating-accessible-reports" />Oprette tilgængelige rapporter
...
## <a name="creating-reports-to-display-data-associated-with-a-list" />Oprette rapporter for at vise data, der er knyttet til en liste
...
### <a name="download-the-theme" />Downloade temaet
...
### <a name="import-the-theme-on-a-report" />Indlæse temaet i en rapport
...
## <a name="publish-reports" />Udgive rapporter
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page" />"Kan ikke indsætte en post. Den aktuelle forbindelsesmåde er skrivebeskyttet." Fejl ved oprettelse af forbindelse til brugerdefineret API-side
