...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-outlook" />Få Business Central-tilføjelsesprogram til Outlook
...
## <a name="about-the-business-central-add-in-for-outlook" />Om Business Central-tilføjelsesprogram til Outlook
...
## <a name="deploy-the-add-in-by-using-centralized-deployment-as-an-admin" />Installere tilføjelsesprogrammet ved hjælp af centraliseret installation som administrator
...
### <a name="deploy-the-add-in" />Anvende tilføjelsesprogrammet
