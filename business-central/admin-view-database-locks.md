...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Sådan ser du databaselåse
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>Sådan ser du databaselåse
