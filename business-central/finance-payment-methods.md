...
ms.author: bholtorf
---
# <a name="set-up-payment-methods"></a><a name="set-up-payment-methods"></a>Konfigurere betalingsmetoder
...
## <a name="to-set-up-a-payment-method"></a><a name="to-set-up-a-payment-method"></a>Sådan defineres en betalingsform
...
## <a name="to-assign-a-payment-method-to-a-customer-or-vendor"></a><a name="to-assign-a-payment-method-to-a-customer-or-vendor"></a>Sådan tildeles en betalingsmetode til en debitor eller kreditor
