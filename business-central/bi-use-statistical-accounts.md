...
---
# <a name="analyze-data-with-statistical-accounts"></a><a name="analyze-data-with-statistical-accounts"></a>Analysere data med statistiske konti
...
## <a name="set-up-a-statistical-account"></a><a name="set-up-a-statistical-account"></a>Sådan oprettes en statistisk konto
...
## <a name="post-amounts-to-a-statistical-account"></a><a name="post-amounts-to-a-statistical-account"></a>Bogføre beløb på en statistisk konto
...
## <a name="verify-statistical-account-amounts"></a><a name="verify-statistical-account-amounts"></a>Kontrollere statistiske kontobeløb
...
## <a name="include-the-statistical-account-in-a-financial-report"></a><a name="include-the-statistical-account-in-a-financial-report"></a>Medtage den statistiske konto i en finansiel rapport
