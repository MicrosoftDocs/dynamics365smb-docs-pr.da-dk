...
ms.author: edupont
---
# <a name="set-up-item-tracking-with-serial-lot-and-package-numbers" />Konfigurere varesporing med serie-, lot- og pakkenumre
...
## <a name="numbers-and-item-tracking" />Numre og varesporing
...
## <a name="to-set-up-item-tracking-codes" />Sådan oprettes varesporingskoder
...
## <a name="to-set-up-expiration-rules-for-serial-or-lot-numbers" />Sådan oprettes udløbsregler for serienumre eller lotnumre
...
## <a name="to-set-up-warranties-for-serial-or-lot-numbers" />Sådan oprettes garantier for serie- eller lotnumre
...
## <a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes" />Sådan defineres varer til sporing med de korrekte varesporingskoder
...
## <a name="to-specify-opening-balances-for-the-items-you-track" />Sådan angives startsaldoer for de varer, du sporer
...
### <a name="item-journals" />Varekladder
...
### <a name="warehouse-physical-inventory-journal-for-locations-where-directed-pick-and-put-away-is-turned-on" />Lagerplaceringsopgørelseskladde til lokationer, hvor styret pluk og læg-på-lager er aktiveret
