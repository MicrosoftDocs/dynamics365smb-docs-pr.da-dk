---
title: 'Opsætte varesporing med serie-, lot- og pakkenumre'
...
---
# <a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a>Opsætte varesporing med serie-, lot- og pakkenumre
...
4. I oversigtspanelerne **Serienr.**, **Lotnr.** og **Pakkesporing** kan du definere politikker for varesporing efter henholdsvis serienummer, lot og pakkenummer.  

> [!NOTE]  
> Hvis du vil spore bestemte varer eller bestemte partier i hele deres levetid, skal du vælge henholdsvis feltet **Serienr.specifik sporing**, feltet **Lotspecifik sporing** og feltet **Pakkespecifik sporing**. Det betyder, at når du håndterer en udgående enhed for en vare med denne varesporingskode, skal du altid angive, hvilket eksisterende serienummer eller hvilket eksisterende lotnummer der skal håndteres. Det betyder, at når du sælger en vareenhed, skal den holdes op mod et specifikt serienummer eller et specifikt lotnummer på lageret. Med andre ord følger et serie-, lot- eller pakkenummer, der knyttes til varen, når den indføres på lageret, også den pågældende varetype ud af lageret.

Da dette opsætningsfelt dækker alle mulige transaktioner med varen, markeres de individuelle indgående og udgående felter også. De individuelle ind- og udgående felter har imidlertid intet at gøre med udligning på lageret. De angiver blot virksomhedens arbejdsgange med hensyn til, hvornår der skal tilknyttes varesporingsnumre.  
...
3. Markér følgende afkrydsningsfelter i oversigtspanelet **Diverse**:  
    ...
    |**Kræv post for udløbsdato**|Angiver, at du skal angive en udløbsdato manuelt på varesporingslinjen.|  
...
## <a name="to-specify-opening-balances-for-the-items-you-track"></a>Hvis du skal angive primosaldi for de varer, du sporer
