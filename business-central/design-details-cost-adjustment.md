---
title: Designoplysninger - Omkostningsregulering
description: Kostregulering er at flytte kostprisændringer fremad fra omkostningskilder til modtagerne på basis af en vares kostmetode for at give korrekt lagerværdi.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Designoplysninger: Omkostningsregulering
...
## <a name="detecting-the-adjustment" />Reguleringsregistrering
...
### <a name="item-application-entry" />Vareudligningspost
...
### <a name="average-cost-adjustment-entry-point" />Gennemsnitlige kostregulerede indførselssteder
...
### <a name="order-level" />Ordreniveau
...
## <a name="manual-versus-automatic-cost-adjustment" />Manuel vs. automatisk kostregulering
...
## <a name="adjust-cost---item-entries-batch-job" />Kørslen Juster kostpris - vareposter
...
## <a name="automatic-cost-adjustment" />Automatisk kostregulering
