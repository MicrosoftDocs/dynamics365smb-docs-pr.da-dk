...
## <a name="transaction-and-budget-tables" />Transaktion og budgettabeller
...
### <a name="tables-that-contain-the-dimension-set-id-field" />Tabeller, der indeholder feltet Dimensionsgruppe-id
