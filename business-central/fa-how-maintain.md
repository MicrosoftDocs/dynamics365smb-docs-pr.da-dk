...
ms.author: edupont
---
# <a name="maintain-fixed-assets" />Vedligeholde anlægsaktiver
...
## <a name="to-record-maintenance-work-on-a-fixed-asset" />Sådan registreres reparationsarbejde på et anlægsaktiv
...
## <a name="to-post-maintenance-costs-from-a-fixed-asset-gl-journal" />Sådan bogføres reparationsomkostninger fra en anlægskassekladde
...
## <a name="to-follow-up-on-fixed-assets-service-visits" />Sådan følger du op på servicebesøg på anlæg
...
## <a name="to-monitor-maintenance-costs" />Sådan overvåges reparationsomkostningerne
...
## <a name="to-view-or-print-maintenance-costs-for-multiple-fixed-assets" />Sådan får du vist eller udskriver reparationsomkostninger for flere anlægsaktiver
...
## <a name="to-view-maintenance-ledger-entries" />Sådan får du vist reparationsposter
...
## <a name="to-view-or-print-maintenance-ledger-entries-for-multiple-fixed-assets" />Sådan får du vist eller udskriver reparationsposter for flere anlægsaktiver
