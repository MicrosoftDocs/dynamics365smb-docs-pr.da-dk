...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Tildele standardplaceringer til varer
...
## <a name="to-assign-a-default-bin-to-an-item" />Sådan tildeles en standardplacering til en vare
...
## <a name="to-change-the-default-bin-for-an-item" />Sådan ændres standardplaceringen for en vare
