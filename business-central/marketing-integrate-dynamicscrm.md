...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Brug Dynamics 365 Sales fra Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a>Sammenkæde poster
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Fuld synkronisering af poster
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Håndtering af salgsordredata
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Håndtering af data i salgstilbud
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Håndtere bogførte salgsfakturaer, debitorbetalinger og statistik
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Håndtering af salgspriser
> [!NOTE]
