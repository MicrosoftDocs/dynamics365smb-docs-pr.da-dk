...
## <a name="coupling-records" />Sammenkæde poster
...
## <a name="fully-synchronizing-records" />Fuld synkronisering af poster
...
## <a name="handling-sales-order-data" />Håndtering af salgsordredata
...
## <a name="handling-sales-quotes-data" />Håndtering af data i salgstilbud
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics" />Håndtere bogførte salgsfakturaer, debitorbetalinger og statistik
...
## <a name="handling-sales-prices" />Håndtering af salgspriser
> [!NOTE]
