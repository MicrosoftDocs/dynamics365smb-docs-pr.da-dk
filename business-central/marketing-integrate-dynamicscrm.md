...
## <a name="couple-records"></a>Sammenkæde poster
...
## <a name="fully-synchronize-records"></a>Fuld synkronisering af poster
...
## <a name="handle-sales-order-data"></a>Håndtering af salgsordredata
...
## <a name="handle-sales-quotes-data"></a>Håndtering af data i salgstilbud
...
## <a name="handle-posted-sales-invoices-customer-payments-and-statistics"></a>Håndtere bogførte salgsfakturaer, debitorbetalinger og statistik
...
## <a name="handle-sales-prices"></a>Håndtering af salgspriser
> [!NOTE]
