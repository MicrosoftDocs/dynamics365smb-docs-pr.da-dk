...
ms.author: edupont
---
# <a name="restrict-and-allow-usage-of-a-record" />Begrænse og tillade brugen af en record
...
## <a name="create-a-workflow-step-that-restricts-posting-of-unapproved-purchase-orders" />Oprette et trin i et workflow, som begrænser bogføring af ikke-godkendte købsordrer
