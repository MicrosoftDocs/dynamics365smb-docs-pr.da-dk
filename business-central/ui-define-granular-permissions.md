...
# <a name="assign-permissions-to-users-and-groups"></a>Tildele tilladelser til brugere og grupper
...
## <a name="create-a-permission-set"></a>Oprette et rettighedssæt
...
## <a name="copy-a-permission-set"></a>Kopiere et rettighedssæt
...
## <a name="create-or-modify-permissions-by-recording-your-actions"></a>Oprette eller redigere rettigheder ved at registrere dine handlinger
...
## <a name="remove-obsolete-permissions-from-all-permission-sets"></a>Fjerne forældede rettigheder fra alle rettighedssæt

På siden **Rettighedssæt** skal du vælge handlingen **Fjern forældede rettigheder**.

## <a name="set-up-time-constraints-for-users"></a>Opsætte tidsbegrænsninger for brugere
...
## <a name="control-access-to-specific-companies"></a>Kontrollere adgangen til bestemte virksomheder
...
## <a name="manage-permissions-through-user-groups"></a>Administrere rettigheder via brugergrupper
...
## <a name="assign-permission-sets-to-users"></a>Tildele rettighedssæt til brugere
...
## <a name="get-an-overview-of-a-users-permissions"></a>Hent en oversigt over en brugers rettigheder
...
## <a name="view-permission-changes-telemetry"></a>Vise tilladelsesændringer af telemetri
