...
# <a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a>Tildele rettigheder til brugere og grupper
...
## <a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a>Oprette et rettighedssæt
...
### <a name="example---indirect-permission"></a><a name="example---indirect-permission"></a><a name="example---indirect-permission"></a>Eksempel - indirekte rettighed
...
### <a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a>Sådan tilføjes andre tilladelsessæt
...
## <a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a>Sådan kopieres et rettighedssæt
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a>Sådan opretter eller redigerer du rettigheder ved at registrere dine handlinger
...
### <a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a>Sådan eksporteres og importeres et tilladelsessæt
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a>Sådan fjernes forældede rettigheder fra alle rettighedssæt

På siden **Rettighedssæt** skal du vælge handlingen **Fjern forældede rettigheder**.

## <a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a>Sådan opsættes tidsbegrænsninger for brugere
...
## <a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a>Sådan administreres rettigheder via brugergrupper
...
### <a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a>Sådan føjes brugere til en brugergruppe
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a>Sådan kopierer du en brugergruppe og alle dens rettighedssæt
...
### <a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a>Sådan tildeles rettighedssæt til brugergrupper
...
## <a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a>Sådan tildeles rettighedssæt til brugere
...
### <a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a>Sådan tildeles et rettighedssæt på et brugerkort
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a>Sådan tildeles et rettighedssæt på siden Rettighedssæt efter bruger
...
## <a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a>Sådan får du vist en oversigt over en brugers rettigheder
...
## <a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a>Få vist ændringer af telemetri
...
## <a name="delegated-admin-users"></a><a name="delegated-admin-users"></a><a name="delegated-admin-users"></a>Opsætning af administratorbrugere
