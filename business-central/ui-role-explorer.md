...
# <a name="finding-pages-with-the-role-explorer" />Søge efter sider med Rollestifinder
...
## <a name="open-the-role-explorer" />Åbne rollestifinder
...
## <a name="navigate-features" />Navigeringsfunktioner
...
## <a name="search-for-features" />Søge efter funktioner
...
## <a name="explore-other-roles" />Udforsk andre roller
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer" />Udvide/skjule noder i Rollestifinder
