...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Oprette en farvet indikator på køindikatorer for firmaet eller individuelle brugere
...
### <a name="to-set-up-colored-indicators-on-cues" />Sådan opretter farveindikatorer på køindikatorer
