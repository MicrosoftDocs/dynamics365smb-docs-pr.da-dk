...
ms.author: bholtorf
---
# <a name="manage-notifications"></a><a name="manage-notifications"></a><a name="manage-notifications"></a>Administrere notifikationer
...
## <a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a><a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a><a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent"></a>Sådan aktiverer eller deaktiverer du notifikationer og styrer, hvornår de sendes
