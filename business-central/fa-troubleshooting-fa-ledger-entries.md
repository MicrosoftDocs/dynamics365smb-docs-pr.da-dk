...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension" />Fejlfinding af udvidelsen til Anlægsposter
...
## <a name="troubleshooting-fixed-asset-ledger-entries" />Foretage fejlfinding af anlægsposter
