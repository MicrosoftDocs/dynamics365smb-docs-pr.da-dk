...
---
# Opsætte servicen Envestnet Yodlee Bank Feeds
...
> [!NOTE]
> Tjenesten Envestnet Yodlee Bank Feeds understøttes kun i Business Central online. Denne funktionalitet understøttes ikke for lokale versioner af [!INCLUDE [prod_short](includes/prod_short.md)] eller for [!INCLUDE [prod_short](includes/prod_short.md)] miljøer, der hostes på Embed ISV-programtjenester. Hvis du vil bruge denne funktion i det lokale miljø, skal du anskaffe en cobrand-konto fra Envestnet, og du skal tilføje kode for at integrere med Yodlee-API'en.
>
...
3. På siden **Bankkontokort** skal du i feltet **Format til import af bankkontoudtog** , vælge YODLEEBANKFEED.  
...
## Sådan knyttes en bankkonto til en onlinebankkonto
...
## Sådan redigeres legitimationsoplysningerne for en online bankkonto
...
## Sådan fjernes tilknytningen til en bankkonto
