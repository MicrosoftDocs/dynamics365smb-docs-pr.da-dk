...
ms.author: edupont
---
# <a name="set-up-the-envestnet-yodlee-bank-feeds-service" />Konfigurere tjenesten Envestnet Yodlee Bank Feeds
...
## <a name="to-enable-the-bank-feed-service" />Sådan aktiveres bankfeedtjenesten
...
## <a name="to-create-a-new-linked-bank-account" />Sådan oprettes en ny tilknyttet bankkonto
1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Bankkonti**, og vælg derefter det relaterede link.
...
## <a name="to-link-a-bank-account-to-an-online-bank-account" />Sådan knyttes en bankkonto til en onlinebankkonto
1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Bankkonti**, og vælg derefter det relaterede link.
...
## <a name="to-edit-the-credentials-for-an-online-bank-account" />Sådan redigeres legitimationsoplysningerne for en online bankkonto
...
## <a name="to-unlink-a-bank-account" />Sådan fjernes tilknytningen til en bankkonto
...
## <a name="to-update-bank-account-linking" />Sådan opdateres tilknytning af bankkonto
1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Bankkonti**, og vælg derefter det relaterede link.
...
## <a name="to-enable-automatic-import-of-bank-statements" />Sådan aktiveres automatisk import af kontoudtog fra banken
1. Vælg ![Lightbulb, der åbner funktionen Fortæl mig.](media/ui-search/search_small.png "Fortæl mig, hvad du vil foretage dig") ikon, skriv **Bankkonti**, og vælg derefter det relaterede link.
