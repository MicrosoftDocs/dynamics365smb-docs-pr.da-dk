...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours" />Konfigurere arbejdstimer og serviceåbningstider
...
## <a name="to-set-up-default-service-hours" />Sådan angives standardserviceåbningstider
...
## <a name="to-set-up-work-hour-templates" />Sådan oprettes arbejdstidsskabeloner
...
## <a name="to-set-up-contract-specific-service-hours" />Sådan angives kontraktspecifikke serviceåbningstider
