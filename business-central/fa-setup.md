...
* Sådan kan du afskrive anlægsaktiver.  
* Hvordan du registrerer anskaffelser, afskrivninger og andre værdier i finansregnskabet.  
* Eventuelt hvordan du registrerer forsikring og vedligeholdelse af anlægsaktiver.

Afsnittene i denne artikel indeholder hyperlinks til flere oplysninger om, hvordan du konfigurerer anlægsaktiver. Når du er færdig med opsætningen, kan du begynde at arbejde med anlægsaktiver. Du kan finde flere oplysninger i [Brug anlægsaktiver](fa-manage.md).  

> [!NOTE]  
> Du kan registrere anlægstransaktioner på siden **Anlægskassekladde** eller på siden **Anlægskladde**, afhængigt af, om transaktionerne, der er til finansiel rapportering eller intern administration. Artikler med hjælp til anlægsaktiver beskriver kun, hvordan du bruger siden **Anlægskassekladde**.  
