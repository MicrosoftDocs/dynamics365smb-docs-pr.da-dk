...
ms.author: jswymer
---
# <a name="entering-data" />Angivelse af data
...
## <a name="work-with-editable-fields" />Arbejde med redigerbare felter
...
### <a name="modifying-a-field-value" />Ændring af en feltværdi
...
### <a name="how-quick-entry-works" />Sådan fungerer genvej
...
### <a name="to-change-quick-entry-fields" />Sådan ændres genvejsfelter
...
## <a name="mandatory-fields" />Obligatoriske felter
...
## <a name="finding-data-as-you-type" />Søge efter data mens du skriver
...
## <a name="copying-and-pasting-faq-fields-and-lines" />Ofte stillede spørgsmål om kopiering og indsætning af felter og linjer
...
## <a name="filtering-line-items" />Filtrere linjevarer
...
### <a name="switching-the-focus-on-and-off" />Slå fokus til og fra
...
## <a name="multitasking-across-multiple-pages" />Multitasking på tværs af flere sider
...
## <a name="entering-quantities-by-calculation" />Angive mængder ved beregning
...
## <a name="entering-negative-numbers" />Angivelse af negative tal
...
## <a name="entering-dates-and-times" />Indtaste datoer og tidspunkter
...
## <a name="entering-combined-datetimes" />Indtaste kombineret dato/klokkeslæt
