...
ms.author: jswymer
---
# <a name="entering-data"></a><a name="entering-data"></a>Angivelse af data
...
## <a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a>Arbejde med redigerbare felter
...
### <a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a>Ændring af en feltværdi
...
## <a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a>Tastaturgenveje
...
## <a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="QuickEntry"></a>Fremskynde dataindtastning ved hjælp af genveje
...
### <a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a>Sådan fungerer genvej
...
#### <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a>Tip
...
### <a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a>Sådan ændres genvejsfelter
...
## <a name="mandatory-fields"></a><a name="mandatory-fields"></a>Obligatoriske felter
...
## <a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a>Søge efter data mens du skriver
...
## <a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a>Ofte stillede spørgsmål om kopiering og indsætning af felter og linjer
...
## <a name="filtering-line-items"></a><a name="filtering-line-items"></a>Filtrere linjevarer
...
## <a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="Focus"></a>Fokusere på linjevarer
...
### <a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a>Slå fokus til og fra
...
## <a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a>Multitasking på tværs af flere sider
...
## <a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a>Angive mængder ved beregning
...
## <a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a>Angivelse af negative tal
...
## <a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a>Indtaste datoer og tidspunkter
...
### <a name="entering-dates"></a><a name="entering-dates"></a>Angive datoer
...
## <a name="entering-times"></a><a name="entering-times"></a>Angive klokkeslæt
...
## <a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a>Indtaste kombineret dato/klokkeslæt

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration"></a><a name="entering-duration"></a>Angivelse af varighed
...
## <a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="decimal"></a>Angive den decimalseparator, der bruges af numeriske tastaturer
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relateret [Microsoft-træning](/training/modules/explore-modify-info-dynamics-365-business-central/)
