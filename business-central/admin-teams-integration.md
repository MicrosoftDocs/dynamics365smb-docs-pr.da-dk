...
# <a name="managing-microsoft-teams-integration-with-include-prodshortincludesprodshortmd" />Styring af Microsoft Teams-integration med [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="managing-the-include-prodshortincludesprodshortmd-app-optional" />Administrerer [!INCLUDE [prod_short](includes/prod_short.md)]-appen (valgfri)
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment" />Installere Business central-appen ved hjælp af centraliseret installation
...
## <a name="managing-privacy-and-compliance" />Administrere beskyttelse af personlige oplysninger og overholdelse
...
### <a name="understanding-where-include-prodshortincludesprodshortmd-cards-are-stored" />Om, hvor [!INCLUDE [prod_short](includes/prod_short.md)]-kort gemmes
...
### <a name="restricting-sharing-of-cards" />Begrænse deling af kort
...
### <a name="responding-to-data-requests" />Reagere på anmodninger om data
...
## <a name="show-or-hide-record-data-on-cards" />Vise eller skjule postdata på kort
