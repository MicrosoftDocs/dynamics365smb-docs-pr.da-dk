...
# <a name="company-information-overview" />Oversigt over virksomhedsoplysninger
...
## <a name="working-with-multiple-companies" />Arbejde med flere virksomheder
...
## <a name="change-company-display-name" />Ændre virksomheds viste navn
...
## <a name="see-related-microsoft-trainingtrainingmodulescreate-new-companies-dynamics--business-central" />Se relateret [Microsoft-træning](/training/modules/create-new-companies-dynamics-365-business-central/)
