...
---
# <a name="how-to-convert-existing-locations-to-warehouse-locations"></a>Fremgangsmåde: Konvertere eksisterende lokationer til lagerlokationer
...
5.  Når kørslen af **Opret lagerlokation** er afsluttet, skal du udføre og bogføre en lagerplaceringsopgørelseskladde. Du kan finde flere oplysninger i [Fremgangsmåde: Tælle, justere og ompostere inventar](inventory-how-count-adjust-reclassify.md).  
