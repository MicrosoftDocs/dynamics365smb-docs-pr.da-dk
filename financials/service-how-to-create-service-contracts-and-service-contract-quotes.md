...
4. I feltet **Debitornr.** skal du angive nummeret på debitoren i servicekontrakten.  
    ...
    > [!NOTE]  
    >  Du kan sammenligne kreditnotaen med det oprindelige bogførte dokument i vinduet **Bogførte servicefakturaer**. Vælg ikonet ![Søg efter side eller rapport](media/ui-search/search_small.png "Ikonet Søg efter side eller rapport"), angiv **Posterede servicefakturaer**, og vælg derefter det relaterede link.  
...
1. Vælg ikonet ![Søg efter side eller rapport](media/ui-search/search_small.png "Ikonet Søg efter side eller rapport"), angiv **Servicekontrakter**, og vælg derefter det relaterede link. Åbn den relevante servicekontrakt, hvis ejer, du vil ændre.  
...
1. Vælg ikonet ![Søg efter side eller rapport](media/ui-search/search_small.png "Ikonet Søg efter side eller rapport"), angiv **Opdater servicekontraktsalgsbeløb**, og vælg derefter det relaterede link. 
...
1. Vælg ikonet ![Søg efter side eller rapport](media/ui-search/search_small.png "Ikonet Søg efter side eller rapport"), angiv **Bogfør forudbet. kontraktposter**, og vælg derefter det relaterede link.  
