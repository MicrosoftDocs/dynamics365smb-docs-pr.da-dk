---
title: "Fremgangsmåde: Ændre, hvilket layout der aktuelt bruges i en rapport | Microsoft Docs"
description: "Få mere at vide om, hvordan du kan bestemme udseendet af en rapport."
...
3. Hvis du vil ændre layoutet for en rapport, skal du i rækken for rapporten på listen angive feltet **Valgt layout** til en af følgende indstillinger:
   ...
   * Brugerdefineret, bruger et brugerdefineret layout i rapporten.  
     ...
     **Bemærk**: Hvis du vælger **RDLC (indbygget)** eller **Word (indbygget)**, og du får en fejlmeddelelse om, at rapporten ikke har et layout med den angivne type, skal du vælge en anden layoutindstilling eller oprette en brugerdefineret rapport af den type, du vil bruge.
