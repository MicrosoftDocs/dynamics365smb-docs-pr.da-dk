...
description: "Få mere at vide om de almindeligste årsager til, hvorfor du muligvis ikke kan fuldføre tilmeldingen til Finance and Operations, Business edition, og hvordan du løser problemet."
...
## <a name="what-email-address-can-i-use-with-finance-and-operations-business-edition"></a>Hvilken mailadresse kan jeg bruge sammen med Finance and Operations, Business edition?
...
| --- | --- |
| Ved Office 365-mailadresser, der ikke er registreret i USA, modtager du en meddelelse som den følgende under tilmeldingen:<br /><br />**Det virkede ikke, vi understøtter ikke dit land eller område endnu.** |[!INCLUDE[d365fin](includes/d365fin_md.md)] Programmet understøtter aktuelt kun Office 365-mailkonti, der er registreret i USA. |
