---
title: "Opsætning af Relationsstyring | Microsoft Docs"
description: Beskriver, hvordan du konfigurerer marketing og administration af kontakter i Financials
...
Du kan konfigurere marketing og administration af kontakter fra vinduet **Marketingopsætning**. For at åbne vinduet **Marketingopsætning** skal du i øverste højre hjørne vælge ikonet **Søg efter side eller rapport** ![Søg efter side eller rapport](media/ui-search/search_small.png "Ikonet Søg efter side eller rapport,"), angive **Marketingopsætning** og derefter vælge det relaterede link.

## <a name="automatically-copy-specific-information-from-the-contact-companies-to-the-contact-persons"></a>Kopiere bestemte oplysninger automatisk fra kontaktvirksomheder til kontaktpersonerne
...
## <a name="automatically-record-interactions"></a>Automatisk registrere interaktioner
...
## <a name="synchronize-contacts-with-customers-and-more"></a>Synkronisere kontakter med debitorer m.m.
...
## <a name="assign-a-number-series-to-contacts-and-opportunities"></a>Tildele en nummerserie til kontakter og leads
...
## <a name="search-for-duplicate-contacts-when-contacts-are-created"></a>Søge efter dublerede kontakter, når der oprettes kontakter
...
## <a name="set-up-email-logging"></a>Konfigurere maillogføring
