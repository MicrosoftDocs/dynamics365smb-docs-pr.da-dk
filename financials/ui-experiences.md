...
[!INCLUDE[d365fin](includes/d365fin_md.md)] kan hjælpe dig med at køre din virksomhed, uanset hvilken branche du arbejder i. Kernen i [!INCLUDE[d365fin](includes/d365fin_md.md)] er finansiel rapportering og salgs- og købsprocesser. Du tilføjer oplevelser i henhold til dine forretningsmæssige behov ved at tilføje udvidelser fra AppSource. Du kan også op- og nedtone brugeroplevelsen og vælge, hvad der passer til din virksomhed. Du kan finde flere oplysninger i [Tilpasse [!INCLUDE[d365fin](includes/d365fin_md.md)] ved hjælp af udvidelser](ui-extensions.md).

## <a name="choosing-a-user-experience"></a>Vælge en brugeroplevelse
...
> [!NOTE]  
>   Denne indstilling gælder for alle brugere i virksomheden.
