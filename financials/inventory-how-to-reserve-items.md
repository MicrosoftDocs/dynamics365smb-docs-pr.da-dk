...
4. Vælg en af følgende handlinger.  
    ...
    |------------------|---------------------|  
    |**Reserver automatisk**|Hvis du automatisk vil reservere varer i vinduet **Reservation**.|  
...
5. Vælg linjen **Salgslinje, ordre** i vinduet **Reservation**, og vælg derefter handlingen **Reserver fra aktuel linje**.  
...
7. Vælg en linje i vinduet **Reservation**, og vælg derefter handlingen **Reserver fra aktuel linje**.  
...
2. I vinduet **Reservation** skal du vælge handlingen **Reservationsposter**.
3. I vinduet **Reservationsposter** skal du opdatere feltet **Antal** på den linje, du vil ændre.
...
2. I vinduet **Reservation** skal du vælge handlingen **Reservationsposter**.  
3.  I vinduet **Reservationsposter** skal du vælge handlingen **Annuller reservation**.  
4.  Bekræft den efterfølgende meddelelse ved at vælge knappen **OK**.  
...
7. Klik på **OK** for at åbne vinduet **Reservation**, hvor der kun vises forsyning med det angivne varesporingsnummer. Hvis der findes ikke-specifikke reservationer på nogle af de varesporingsnumre, du har angivet for linjen, vises der en meddelelse om det antal, der allerede er reserveret.  
