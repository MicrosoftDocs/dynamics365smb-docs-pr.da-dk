...
Hvis du har spørgsmål om [!INCLUDE[d365fin](includes/d365fin_md.md)], som du ikke kan finde et svar på i denne dokumentation, kan du spørge Finance and Operations, Business edition-community. Du kan finde flere oplysninger under [Dynamics 365 for Finance and Operations, Business edition-community](https://community.dynamics.com/business). Desuden laver vores supportteam opslag med tip og trick. Du kan finde flere oplysninger under [Dynamics 365 for Finance and Operations, Business edition-supportblog](https://blogs.msdn.microsoft.com/dyn365finsupport).  
