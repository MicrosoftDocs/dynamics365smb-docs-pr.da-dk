...
---
# <a name="design-details-codeunit-408-dimension-management"></a><span data-ttu-id="49b7f-103">Designoplysninger: Kodeenhed 408 Dimensionsstyring</span><span class="sxs-lookup"><span data-stu-id="49b7f-103">Design Details: Codeunit 408 Dimension Management</span></span>
<span data-ttu-id="49b7f-104">Kodeenhed 408-dimensionsstyring er et funktionsbibliotek, der håndterer almindelige opgaver, der er relateret til dimensioner, som f.eks. kopiering fra én tabel til en anden eller fra et dokument til en andet.</span><span class="sxs-lookup"><span data-stu-id="49b7f-104">Codeunit 408 Dimension Management is a function library that handles common tasks that are related to dimensions, such as copying from one table to another or from one document to another.</span></span> <span data-ttu-id="49b7f-105">I dette emne beskrives de funktioner, der er ændret i Microsoft Dynamics NAV 2013 R2, og hvad der skal gøres ved funktionerne.</span><span class="sxs-lookup"><span data-stu-id="49b7f-105">This topic lists the functions that are modified in Microsoft Dynamics NAV 2013 R2 and specifies what has to be done to the functions.</span></span> <span data-ttu-id="49b7f-106">Mange funktioner er slettet, fordi der er ingen grund til at kopiere mellem dimensionstabeller.</span><span class="sxs-lookup"><span data-stu-id="49b7f-106">Many functions are deleted because there is no need for copying between dimension tables.</span></span>  

## <a name="modified-functions"></a><span data-ttu-id="49b7f-107">Ændrede funktioner</span><span class="sxs-lookup"><span data-stu-id="49b7f-107">Modified Functions</span></span>  

|<span data-ttu-id="49b7f-108">Funktionsnavn</span><span class="sxs-lookup"><span data-stu-id="49b7f-108">Function Name</span></span>|<span data-ttu-id="49b7f-109">Beskrivelse af ændring</span><span class="sxs-lookup"><span data-stu-id="49b7f-109">Modification Description</span></span>|  
|-------------------|------------------------------|  
|<span data-ttu-id="49b7f-110">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="49b7f-110">CheckDimSetIDComb</span></span>|<span data-ttu-id="49b7f-111">Ny funktion, der erstatter de andre kontrolfunktioner og tager et dimensionsgruppe-id som argument i stedet for en dimensionstabel.</span><span class="sxs-lookup"><span data-stu-id="49b7f-111">New function that substitutes the other check functions and takes a Dimension Set ID as an argument instead of a dimension table.</span></span>|  
|<span data-ttu-id="49b7f-112">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="49b7f-112">CheckDimSetIDComb</span></span><br /><br /> <span data-ttu-id="49b7f-113">CheckDocDimComb</span><span class="sxs-lookup"><span data-stu-id="49b7f-113">CheckDocDimComb</span></span><br /><br /> <span data-ttu-id="49b7f-114">CheckServContractDimComb</span><span class="sxs-lookup"><span data-stu-id="49b7f-114">CheckServContractDimComb</span></span><br /><br /> <span data-ttu-id="49b7f-115">CheckDimBuffer</span><span class="sxs-lookup"><span data-stu-id="49b7f-115">CheckDimBuffer</span></span><br /><br /> <span data-ttu-id="49b7f-116">CheckDimComb</span><span class="sxs-lookup"><span data-stu-id="49b7f-116">CheckDimComb</span></span><br /><br /> <span data-ttu-id="49b7f-117">CheckDimValueComb</span><span class="sxs-lookup"><span data-stu-id="49b7f-117">CheckDimValueComb</span></span>|<span data-ttu-id="49b7f-118">Slet.</span><span class="sxs-lookup"><span data-stu-id="49b7f-118">Delete.</span></span> <span data-ttu-id="49b7f-119">Alt forbrug skal ændres til CheckDimSetIDComb.</span><span class="sxs-lookup"><span data-stu-id="49b7f-119">All usage should be changed to CheckDimSetIDComb.</span></span>|  
|<span data-ttu-id="49b7f-120">GetDefaultDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-120">GetDefaultDim</span></span>|<span data-ttu-id="49b7f-121">Rediger for at returnere et heltal som dimensionsgruppe-id i stedet for et sæt poster.</span><span class="sxs-lookup"><span data-stu-id="49b7f-121">Modify to return an integer Dimension Set ID instead of a set of records.</span></span>|  
|<span data-ttu-id="49b7f-122">CopyJnlLineDimToICJnlDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-122">CopyJnlLineDimToICJnlDim</span></span><br /><br /> <span data-ttu-id="49b7f-123">CopyICJnlDimToJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-123">CopyICJnlDimToJnlLineDim</span></span><br /><br /> <span data-ttu-id="49b7f-124">CopyDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-124">CopyDocDimtoICDocDim</span></span><br /><br /> <span data-ttu-id="49b7f-125">CopyICDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-125">CopyICDocDimtoICDocDim</span></span>|<span data-ttu-id="49b7f-126">Rediger for at arbejde med DimSetID -> ICJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-126">Modify to work with DimSetID -> ICJnlLineDim</span></span>|  

## <a name="deleted-functions"></a><span data-ttu-id="49b7f-127">Slettede funktioner</span><span class="sxs-lookup"><span data-stu-id="49b7f-127">Deleted Functions</span></span>  
...
>  <span data-ttu-id="49b7f-129">Under opgradering af programkode fra Microsoft Dynamics NAV 2009 eller tidligere versioner til Microsoft Dynamics NAV 2016, er følgende funktioner ikke tilgængelige i Microsoft Dynamics NAV 2016.</span><span class="sxs-lookup"><span data-stu-id="49b7f-129">During the upgrade of application code from Microsoft Dynamics NAV 2009 or earlier versions to Microsoft Dynamics NAV 2016, the following functions are not available in Microsoft Dynamics NAV 2016.</span></span> <span data-ttu-id="49b7f-130">Hvis du har tilpasninger, der bruger en eller flere af funktionerne, skal du opgraderer denne kode i overensstemmelse hermed.</span><span class="sxs-lookup"><span data-stu-id="49b7f-130">If you have customizations that use one or more of the functions, you must upgrade that code accordingly.</span></span>
 ...
 <span data-ttu-id="49b7f-144">GetDocDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-144">GetDocDim</span></span>  
 ...
 <span data-ttu-id="49b7f-164">ShowTempDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-164">ShowTempDim</span></span>  
 ...
 <span data-ttu-id="49b7f-184">CopySCDimToDocDim</span><span class="sxs-lookup"><span data-stu-id="49b7f-184">CopySCDimToDocDim</span></span>  
 ...
 <span data-ttu-id="49b7f-205">CopyJnlLineDimToBuffer</span><span class="sxs-lookup"><span data-stu-id="49b7f-205">CopyJnlLineDimToBuffer</span></span>  
